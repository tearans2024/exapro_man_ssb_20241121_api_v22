...
#End Region
    ...
    '                '    & "FROM " _
    '                '    & "  public.pt_mstr " _
    '                '    & "  LEFT OUTER JOIN public.pid_det ON (public.pt_mstr.pt_id = public.pid_det.pid_pt_id) " _
    '                '    & "  LEFT OUTER JOIN public.pi_mstr ON (public.pid_det.pid_pi_oid = public.pi_mstr.pi_oid) " _
    '                '    & "  LEFT OUTER JOIN public.invc_mstr ON (public.pid_det.pid_pt_id = public.invc_mstr.invc_pt_id) " _
    '                '    & "  LEFT OUTER JOIN public.loc_mstr ON (public.invc_mstr.invc_loc_id = public.loc_mstr.loc_id) " _
    '                '    & "  LEFT OUTER JOIN public.code_mstr um_mstr ON (public.pt_mstr.pt_um = um_mstr.code_id) " _
    '                '    & "  LEFT OUTER JOIN public.en_mstr ON (public.invc_mstr.invc_en_id = public.en_mstr.en_id) " _
    '                '    & "  LEFT OUTER JOIN public.si_mstr ON (public.pt_mstr.pt_si_id = public.si_mstr.si_id) " _
    ...
    '& "FROM " _
    '& "  public.pt_mstr " _
    '& "  INNER JOIN public.en_mstr ON (public.pt_mstr.pt_en_id = public.en_mstr.en_id) " _
    ...
    '& "  INNER JOIN public.code_mstr tax_class_mstr ON (public.pt_mstr.pt_tax_class = tax_class_mstr.code_id) " _
    '& "  INNER JOIN public.code_mstr um_mstr ON (public.pt_mstr.pt_um = um_mstr.code_id) " _
    '& " where pt_code ='" & dr("pt_code") & "' "
    ...
    '                    gv_edit.SetRowCellValue(_row, "prjd_pt_id", dr_temp("pt_id"))
    '                    gv_edit.SetRowCellValue(_row, "pt_code", dr_temp("pt_code"))
    '                    gv_edit.SetRowCellValue(_row, "prjd_pt_desc1", dr_temp("pt_desc1"))
    '                    gv_edit.SetRowCellValue(_row, "prjd_pt_desc2", dr_temp("pt_desc2"))
    '                    'gv_edit.SetRowCellValue(_row, "pt_type", dr_temp("pt_type"))
    '                    gv_edit.SetRowCellValue(_row, "pt_ls", dr_temp("pt_ls"))
    '                    gv_edit.SetRowCellValue(_row, "prjd_loc_id", dr_temp("loc_id"))
    ...
    '                    gv_edit.SetRowCellValue(_row, "unit_measure", dr_temp("um_name"))
    ...
    Private Sub prjd_file_excel_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles prjd_file_excel.ButtonClick
        Try
            Dim dt_temp As New DataTable
            Dim _row As Integer = 0
            ...
            prjd_file_excel.EditValue = _file
            ds = master_new.excelconn.ImportExcel(_file)
            ...
            For Each dr As DataRow In ds.Tables(0).Rows
                ...
                For Each dr_temp As DataRow In dt_temp.Rows
                    ...
                    gv_edit.SetRowCellValue(_row, "prjd_um", dr_temp("pt_um"))
                    gv_edit.SetRowCellValue(_row, "unit_measure", dr_temp("um_name"))
                    'gv_edit.SetRowCellValue(_row, "unit_measure", dr("um"))
                    gv_edit.SetRowCellValue(_row, "prjd_cost", dr_temp("invct_cost"))
                    'gv_edit.SetRowCellValue(_row, "ptsfrd_remarks", dr_temp("remarks"))
        ...
        Try
            ...
            If _col = "loc_desc" Then
                For i As Integer = 0 To ds_edit.Tables(0).Rows.Count - 1
                    ...
                    ds_edit.Tables(0).Rows(i).Item("prjd_loc_id") = gv_edit.GetRowCellValue(_row, "prjd_loc_id")
                Next
            End If
