...
#Region "SettingAwal"
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail1, "Qty Shipment", "soshipd_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail1, "Prog.Pay (%)", "soshipd_progress_pay", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail1, "Qty Invoice", "soshipd_qty_inv", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail1, "UM", "unit_measure", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail1, "UM Conversion", "soshipd_um_conv", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail1, "Qty Real", "soshipd_qty_real", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_email1, "Qty Shipment", "soshipd_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_email1, "Prog.Pay (%)", "soshipd_progress_pay", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_email1, "UM", "unit_measure", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_email1, "UM Conversion", "soshipd_um_conv", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_email1, "Qty Real", "soshipd_qty_real", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_edit, "Prog.Pay Open (%)", "progress_pay_open", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_edit(gv_edit, "Prog.Pay (%)", "soshipd_progress_pay", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_edit, "UM Conversion", "soshipd_um_conv", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Public Overrides Sub load_data_grid_detail()
        ...
        sql = "SELECT  " _
            ...
            & "  soshipd_prjd_oid, " _
            & "  pt_type,pt_id,pt_code,prjd_pt_desc1,prjd_pt_desc2, " _
            ...
            Using objcb As New master_new.CustomCommand
                With objcb
                    .SQL = "SELECT  " _
                        ...
                        & "  soshipd_close_line, " _
                        & "  soshipd_prjd_oid, " _
                        & "  pt_id,pt_code,prjd_pt_desc1,prjd_pt_desc2, " _
                        & "  pt_ls,pt_type, " _
                        & "  soshipd_progress_pay, " _
                        & "  0 as progress_pay_open, " _
                        & "  soshipd_progress_pay_inv, " _
                ...
                Using objcb As New master_new.CustomCommand
                    With objcb
                        .SQL = "SELECT  " _
                            ...
                            & "  soshipd_close_line, " _
                            & "  soshipd_prjd_oid, " _
                            & "  pt_id,pt_type,pt_code,prjd_pt_desc1,prjd_pt_desc2, " _
                            & "  soshipd_progress_pay, " _
                            & "  soshipd_progress_pay_inv, " _
                            & "  soship_en_id " _
                            & "FROM  " _
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            If ds_edit.Tables(0).Rows(i).Item("pt_type") = "I" Then
                                If ds_edit.Tables(0).Rows(i).Item("soshipd_qty") > 0 Then
                                    ...
                                    If update_invc_mstr_minus_local(ssqls, objinsert, _en_id, _si_id, _loc_id, _pt_id, _pt_code, _serial, _qty) = False Then
                                        'sqlTran.Rollback()
                                        insert = False
                                        Exit Function
                                    End If
