...
Public Class FMarketingOrderReport
    Public func_coll As New function_collection
    Dim _now As DateTime
    Private Sub FMarketingOrderReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        form_first_load()
