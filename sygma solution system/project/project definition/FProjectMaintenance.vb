...
#Region "SettingAwal"
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail, "Prepayment Amount", "prjd_prepay_amount", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail, "Prepayment Amount Invoice", "prjd_prepay_amount_inv", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column_copy(gv_detail, "Is Use", "prjd_is_use", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_browse(gv_edit, "Entity", "en_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit, "prjd_prj_oid", False)
        add_column(gv_edit, "prjd_si_id", False)
        add_column_browse(gv_edit, "Site", "si_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit, "Seq", "prjd_seq", DevExpress.Utils.HorzAlignment.Default)
        add_column_browse(gv_edit, "Type", "code_code", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_browse(gv_edit, "Tax Class", "tax_class", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column(gv_edit, "prjd_is_use", False)
        ...
        add_column_browse(gv_edit_cust, "Entity", "en_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_cust, "prjc_prj_oid", False)
        add_column(gv_edit_cust, "prjc_seq", False)
        add_column(gv_edit_cust, "prjc_si_id", False)
        add_column_browse(gv_edit_cust, "Site", "si_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_cust, "prjc_cp_id", False)
        add_column_browse(gv_edit_cust, "Part Number", "cp_code", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_browse(gv_edit_cust, "Location Plan", "loc_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_cust, "prjc_loc_imp_id", False)
        add_column_browse(gv_edit_cust, "Location Implementation", "loc_desc_imp", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_browse(gv_edit_cust, "Tax Class", "tax_class", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Sub load_data_grid_detail()
        ...
        sql = "SELECT  " _
            ...
            & "  prjd_ref.prjd_seq as prjd_ref_line, prjd_det.prjd_is_use, " _
            & "  coalesce(prjd_det.prjd_prepay_amount,0) as prjd_prepay_amount, coalesce(prjd_det.prjd_prepay_amount_inv,0) as prjd_prepay_amount_inv " _
            & "FROM  " _
            & "  public.prjd_det " _
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        .SQL = "SELECT  " _
                            ...
                            & "  prjd_det.prjd_type,type.code_code as code_code, " _
                            & "  prjd_ref.prjd_seq as prjd_ref_line, coalesce(prjd_det.prjd_is_use,'N') as prjd_is_use " _
                            & "FROM  " _
                            & "  public.prjd_det " _
                            & "  inner join prj_mstr on prj_oid = prjd_det.prjd_prj_oid " _
                            & "  inner join en_mstr on en_id = prjd_det.prjd_en_id " _
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "DELETE FROM prjd_det " _
                                            ...
                                            & " and coalesce(prjd_is_use,'N') <> 'Y' " _
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  prj_code = " & SetSetring(prj_code.Text.ToUpper) & ",  " _
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            If IsDBNull(ds_edit.Tables(0).Rows(i).Item("prjd_is_use")) = True Then
                                _prjd_is_use = "N"
                            Else
                                _prjd_is_use = ds_edit.Tables(0).Rows(i).Item("prjd_is_use")
                            End If
                            '_prjd_is_use = IIf(IsDBNull(ds_edit.Tables(0).Rows(i).Item("prjd_is_use") = True), "N", ds_edit.Tables(0).Rows(i).Item("prjd_is_use"))
                            If _prjd_is_use = "N" And _
                               (SetDbl(ds_edit.Tables(0).Rows(i).Item("prjd_qty_pao")) + SetDbl(ds_edit.Tables(0).Rows(i).Item("prjd_qty_shipment")) _
                        ...
                        .Command.CommandText = "UPDATE  " _
                                                ...
                                                & "  pjc_code = " & SetSetring(prj_code.Text.ToUpper) & ",  " _
                                                & "  pjc_desc = " & SetSetring(prj_code.Text.ToUpper) & ",  " _
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & " current_timestamp " & ", " _
                                            & " current_timestamp " & ", " _
                                            & SetSetring(_prj_code.ToUpper) & ",  " _
                        ...
                        'insert pjc_mstr
                        If project_code_cek(_prj_code.ToUpper) = True Then
...
#Region "gv_edit"
    ...
    Private Sub browse_data()
        ...
        Dim _prjd_is_use As String = gv_edit.GetRowCellValue(_row, "prjd_is_use")
        ...
        ElseIf _col = "pt_code" Then
            If _prjd_is_use = "Y" Then
                MessageBox.Show("This Item Can't Be Changed...", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
    ...
    Private Sub gv_edit_InitNewRow(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles gv_edit.InitNewRow
        With gv_edit
            If ce_copy_detail.Checked = False Then
                ...
                .SetRowCellValue(e.RowHandle, "prjd_is_use", "N")
...
#End Region
    ...
    Private Sub gv_edit_FocusedRowChanged(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles gv_edit.FocusedRowChanged
        Try
            ...
            If ds_edit.Tables(0).Rows(_row_focus).Item("prjd_qty_mo") > 0 Or ds_edit.Tables(0).Rows(_row_focus).Item("prjd_qty_shipment") > 0 Then
            ...
            If ds_import.Tables(0).Rows.Count > 0 Then
                ...
                For Each _dr As DataRow In ds_import.Tables(0).Rows
                    ...
                    Try
                        Using objcb As New master_new.WDABasepgsql("", "")
                            With objcb
                                .SQL = "SELECT  pt_id, pt_code, pt_desc1, pt_desc2, pt_type, pt_um, pt_ls, code_id, code_name " _
                                    & " FROM pt_mstr " _
                    ...
                    If ds_pt.Tables(0).Rows.Count > 0 Then
                        ...
                        dr_list("prjd_pt_desc1") = ds_pt.Tables(0).Rows(0).Item("pt_desc1")
                        dr_list("prjd_pt_desc2") = ds_pt.Tables(0).Rows(0).Item("pt_desc2")
                    ...
                    Else
                        MsgBox("Unknown Location " & ds_import.Tables(0).Rows(i).Item(10) & " At Line " & i + 1 & "....", MsgBoxStyle.Critical, "Location Not Found")
