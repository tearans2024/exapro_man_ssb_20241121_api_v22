...
Public Class rptProjectShipment
    Dim flag2 As String
    Dim wod_num As Integer

    Private Sub rptProjectShipment_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
