Public Class FProjectReturnPrintSign
    Public dt_bantu As DataTable
    Public func_data As New function_data
    Public func_coll As New function_collection

    Private Sub FProjectReturnPrintSign_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Public Overrides Sub preview()
        ...
        Try
            Using objcek As New master_new.WDABasepgsql("", "")
                With objcek
                    ...
                    .Command.CommandText = "select code_id from code_mstr where code_field ~~* 'type_document' and code_code ~~* 'PT'"
                    .InitializeCommand()
        ...
        If _conf_document_sign = 1 Then
            ...
            Dim rpt As New rptProjectReturn
            Try
                With rpt
                    Try
