...
Public Class FProjectLayoutMaintenance
    ...
    Public Function load_layout_detail(ByVal par_code_field As String, ByVal par_code_id As Integer) As DataTable
                ...
                Using objcb As New master_new.CustomCommand
                    With objcb
                        .SQL = "select code_id, code_name from code_mstr where code_field ~~* '" + par_code_field + "' and code_active ~~* 'Y'" _
                             & " AND code_parent = " & SetInteger(par_code_id) _
    ...
    Public Overrides Sub load_cb()
        ...
        dt_bantu = New DataTable
        dt_bantu = (func_data.load_code_mstr("project_layout_detail"))
        prjl_user_value_lookup.Properties.DataSource = dt_bantu
        prjl_user_value_lookup.Properties.DisplayMember = dt_bantu.Columns("code_name").ToString
        prjl_user_value_lookup.Properties.ValueMember = dt_bantu.Columns("code_name").ToString
        prjl_user_value_lookup.ItemIndex = 0
    End Sub

    Public Sub load_cb_edit(ByVal par_code_id As Integer)
        dt_bantu = New DataTable
        dt_bantu = load_layout_detail("project_layout_detail", par_code_id)
        prjl_user_value_lookup.Properties.DataSource = dt_bantu
        prjl_user_value_lookup.Properties.DisplayMember = dt_bantu.Columns("code_name").ToString
        prjl_user_value_lookup.Properties.ValueMember = dt_bantu.Columns("code_name").ToString
        prjl_user_value_lookup.ItemIndex = 0
    ...
    Private Function CekDetailColumnDescription(ByVal par_code_id As Integer) As Boolean
        CekDetailColumnDescription = False
        Try
            Using objcb As New master_new.CustomCommand
                With objcb
                    '.Connection.Open()
                    ...
                    .Command.CommandText = "SELECT  " _
                                        ...
                                        & " FROM  " _
                                        & " public.code_mstr " _
                                        & " where code_parent = " + SetInteger(par_code_id) _
                                        & " and code_field = 'project_layout_detail' "
                    .InitializeCommand()
                    .DataReader = .ExecuteReader

                    While .DataReader.Read
                        CekDetailColumnDescription = True
                        Return CekDetailColumnDescription
                    End While
                End With
            End Using
        Catch ex As Exception
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        'If CekDetailColumnDescription(prjl_desc_id.EditValue) = True Then   'textbox
        '    load_cb_edit(prjl_desc_id.EditValue)
        'End If
        ...
        With _ds_layout.Tables("layout").Rows(row)
            ...
            'cek type data
            If _data_type = "Character" Then
                If CekDetailColumnDescription(prjl_desc_id.EditValue) = False Then   'textbox
                    _value = 1 'texbox
                    prjl_user_value.Focus()
                    prjl_user_value.Text = SetString(.Item("prjl_user_value"))
                    'prjl_user_value_lookup.Text = ""
                    'prjl_user_value_date.Text = ""

                    prjl_user_value.Enabled = True
                    prjl_user_value_lookup.Enabled = False
                    prjl_user_value_date.Enabled = False

                    lci_text.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
                    lci_lookup.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                    lci_date.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                Else
                    _value = 2 'lookup
                    load_cb_edit(prjl_desc_id.EditValue)
                    prjl_user_value_lookup.Focus()
                    prjl_user_value_lookup.EditValue = SetString(.Item("prjl_user_value"))
                    'prjl_user_value.Text = ""
                    'prjl_user_value_date.Text = ""

                    prjl_user_value.Enabled = False
                    prjl_user_value_lookup.Enabled = True
                    prjl_user_value_date.Enabled = False

                    lci_text.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                    lci_lookup.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
                    lci_date.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                End If
            ElseIf _data_type = "Numeric" Then
                _value = 3 'numeric
                prjl_user_value.Focus()
                prjl_user_value.EditValue = .Item("prjl_user_value")
                'prjl_user_value_lookup.Text = ""
                'prjl_user_value_date.Text = ""
            ...
            ElseIf _data_type = "Date" Then
                _value = 4 'date
                prjl_user_value_date.Focus()
                prjl_user_value_date.EditValue = .Item("prjl_user_value")
                'prjl_user_value.Text = ""
                'prjl_user_value_lookup.Text = ""

                prjl_user_value.Enabled = False
                prjl_user_value_lookup.Enabled = False
                prjl_user_value_date.Enabled = True

                lci_text.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                lci_lookup.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
                lci_date.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
            End If
...
.Command.Open()
                    ...
                    Try
                        ...
                        ElseIf _value = 2 Then      'lookup
                            '.Command.CommandType = CommandType.Text
                            .Command.CommandText = "UPDATE  " _
                                            & "  public.prjl_layout   " _
                                            & "SET   " _
                                            & "  prjl_user_value = " & SetSetring(prjl_user_value_lookup.Text) & ",  " _
                                            & "  prjl_upd_by = " & SetSetring(master_new.ClsVar.sNama) & ",  " _
                                            & "  prjl_upd_date = current_timestamp, " _
                                            & "  prjl_dt = current_timestamp " _
                                            & "WHERE  " _
                        ...
                        ElseIf _value = 3 Then      'numeric
                            ...
                            .Command.ExecuteNonQuery()
                            '.Command.Parameters.Clear()
                        ElseIf _value = 4 Then      'date
                            '.Command.CommandType = CommandType.Text
                            .Command.CommandText = "UPDATE  " _
                                            & "  public.prjl_layout   " _
                                            & "SET   " _
                                            & "  prjl_user_value = " & SetSetring(prjl_user_value_date.Text) & ",  " _
                                            & "  prjl_upd_by = " & SetSetring(master_new.ClsVar.sNama) & ",  " _
                                            & "  prjl_upd_date = current_timestamp, " _
                                            & "  prjl_dt = current_timestamp " _
                                            & "WHERE  " _
