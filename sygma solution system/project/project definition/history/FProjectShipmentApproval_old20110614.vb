...
Public Class FProjectShipmentApproval
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail, "Prog.Pay (%)", "soshipd_progress_pay", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column(gv_email, "Prog.Pay (%)", "soshipd_progress_pay", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
