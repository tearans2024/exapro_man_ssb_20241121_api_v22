...
Public Class FSOARFPReportNoCost
    ...
    Public Overrides Sub format_grid()
        ...
        'add_column_copy(gv_view1, "Total Cost", "total_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        'add_column_copy(gv_view1, "Gross Profit", "gross_profit", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
...
& "  ptnrg_grp.ptnrg_code, " _
& "  ptnrg_grp.ptnrg_desc, " _
& "  ptnrc_cat.ptnrc_code, " _
& "  ptnrc_cat.ptnrc_name, " _
& "  ptnr_mstr.ptnr_remarks, " _
                               & "  soship_code, " _
                               & "  soship_date, " _
                               & "  si_desc, " _
                               ...
                               & "  inner join ptnrg_grp on ptnrg_id = ptnr_ptnrg_id " _
