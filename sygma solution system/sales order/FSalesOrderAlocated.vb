...
Public Class FSalesOrderAlocated
    ...
    Public Overrides Sub load_cb_en()
        ...
        dt_bantu = New DataTable
        dt_bantu = (func_data.load_loc_mstr_default(so_en_id.EditValue))
        so_ptsfr_loc_id.Properties.DataSource = dt_bantu
        so_ptsfr_loc_id.Properties.DisplayMember = dt_bantu.Columns("loc_desc").ToString
        so_ptsfr_loc_id.Properties.ValueMember = dt_bantu.Columns("loc_id").ToString
        so_ptsfr_loc_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_loc_mstr_booked(so_en_id.EditValue))
        so_ptsfr_loc_to_id.Properties.DataSource = dt_bantu
        so_ptsfr_loc_to_id.Properties.DisplayMember = dt_bantu.Columns("loc_desc").ToString
        so_ptsfr_loc_to_id.Properties.ValueMember = dt_bantu.Columns("loc_id").ToString
        so_ptsfr_loc_to_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_loc_mstr_git(so_en_id.EditValue))
        so_ptsfr_loc_git.Properties.DataSource = dt_bantu
        so_ptsfr_loc_git.Properties.DisplayMember = dt_bantu.Columns("loc_desc").ToString
        so_ptsfr_loc_git.Properties.ValueMember = dt_bantu.Columns("loc_id").ToString
        so_ptsfr_loc_git.ItemIndex = 0
        ...
        dt_bantu = New DataTable
        dt_bantu = (func_data.load_sq_area_mstr(so_en_id.EditValue))
        so_pidd_area_id.Properties.DataSource = dt_bantu
        so_pidd_area_id.Properties.DisplayMember = dt_bantu.Columns("area_name").ToString
        so_pidd_area_id.Properties.ValueMember = dt_bantu.Columns("area_id").ToString
        so_pidd_area_id.ItemIndex = 0
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Booking", "so_booking", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Pre Order", "so_alocated", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Referensi SQ No.", "so_sq_ref_code", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_master, "Is Return", "so_return", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_master, "Shipping Charges", "so_shipping_charges", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_master, "Total Final", "so_total_final", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_master, "Print Date", "so_print_dt", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        ...
        add_column(gv_detail, "sod_invc_oid", False)
        'add_column_copy(gv_detail, "sod_invc_oid", "sod_invc_oid", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "Partial", "sod_part", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_detail, "Qty SQ", "sqd_sqd_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail, "Qty Open", "sod_qty_open", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail, "Qty Proses", "sod_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")

        'add_column_copy(gv_detail, "Outstanding", "(sod_qty_open - sod_qty)", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        'add_column_copy(gv_detail, "Qty Outstanding", "outstanding", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_detail, "Sales Unit Total", "sod_sales_unit_total", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")

        add_column_copy(gv_detail, "Commision", "sod_commision", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail, "Commision Total", "sod_commision_total", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        'add_column(gv_edit, "sod_invc_oid", "sod_invc_oid", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column(gv_edit, "Qty Open", "sod_qty_open", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_edit, "Price Net", "sod_price_net", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "Ext Total Before Tax", "sod_price_ori_aft_disc_before_tax_ext", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "Ext Total After Tax", "sod_price_ori_aft_disc_aft_tax_ext", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_edit, "Sales Unit", "sod_sales_unit", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_edit, "Commision", "sod_commision", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_edit, "Commision Total", "sod_commision_total", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_edit_assembly, "Qty", "sodas_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit_assembly, "Qty Sold", "sodas_qty_sold", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_detail_assembly, "Qty", "sodas_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_detail_assembly, "Qty Sold", "sodas_qty_sold", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_email, "Sales Unit Total", "sod_sales_unit_total", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    & "  so_oid, " _
                    & "  so_dom_id, " _
                    & "  so_en_id,coalesce(so_project,'N') as so_project, " _
                    & "  so_add_by, " _
                    & "  so_add_date, " _
                    & "  so_upd_by, " _
                    & "  so_upd_date, " _
                    ...
                    & "  so_payment_date, " _
                    & "  tran_name, " _
                    & "  coalesce(so_cons,'N') as so_cons, " _
                    & "  coalesce(so_booking,'N') as so_booking, " _
                    & "  coalesce(so_alocated,'N') as so_alocated, " _
                    & "  so_ptsfr_loc_id, " _
                    & "  so_ptsfr_loc_git, " _
                    & "  so_ptsfr_loc_to_id, " _
                    ...
                    & "  so_payment, " _
                    & "  so_exc_rate, " _
                    & "  so_tax_inc, so_price, so_shipping_charges, so_total_final," _
                    ...
                    & "  end as so_ppn_type, case when ptnr_mstr_sold.ptnr_is_ps='Y' then 'PS' else 'NON PS' end as ps_status,ptnrg_name,  " _
    ...
    Public Overrides Sub insert_data_awal()
        ...
        so_booking.EditValue = False
        so_alocated.EditValue = False

        so_ptsfr_loc_id.Text = ""
        so_ptsfr_loc_to_id.Text = ""
        so_ptsfr_loc_git.Text = ""
        ...
        so_sq_ref_code.Text = ""
        _so_sq_ref_oid = ""
        so_sq_ref_code.Enabled = True

        so_pidd_area_id.Text = ""
        so_pidd_area_id.Tag = ""
        so_pidd_area_id.Enabled = True
        '_so_ptsfr_loc_id = ""
        '_so_ptsfr_loc_git = ""
        '_so_ptsfr_loc_to_id = ""
        ...
        'so_ptsfr_loc_id.tag = ""
        'so_ptsfr_loc_id.EditValue = ""

        so_project.EditValue = False
        so_booking.EditValue = False
        so_booking.Enabled = False
        so_alocated.EditValue = False
        so_alocated.Enabled = False
        ...
        so_shipping_charges.EditValue = 0.0
        so_total_final.EditValue = 0.0
    End Sub
            ...
            Using objcb As New master_new.CustomCommand
                With objcb
                    .SQL = "SELECT  " _
                        ...
                        & "  sod_qty_picked, " _
                        & "  sod_qty_shipment, " _
                        & "  coalesce (sod_qty,0) - coalesce (sod_qty_shipment,0) as outstanding,  " _
                        & "  sod_qty_pending_inv, " _
                        & "  sod_qty_invoice, " _
                        & "  sod_um, " _
                        & "  sod_cost, " _
    ...
    Public Overrides Function before_save() As Boolean
        ...
        Dim _sod_invc_oid, _ptname As String

        _sod_invc_oid = SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid"))
        ...
        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
            ...
            ElseIf SetNumber(ds_edit.Tables(0).Rows(i).Item("sod_qty_open")) <> "0" Then
                If SetNumber(ds_edit.Tables(0).Rows(i).Item("sod_qty")) > SetNumber(ds_edit.Tables(0).Rows(i).Item("sod_qty_open")) Then
        ...
        'If so_pay_type.GetColumnValue("code_usr_1") = 1 Then
        '    For i = 0 To ds_edit.Tables(0).Rows.Count - 1
        ...
        'cek inventory sudah siap atau belum untuk proses alocated
        If so_alocated.Checked = True Then
            For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                If func_coll.cek_inventory_allocation(ds_edit.Tables(0).Rows(i).Item("sod_en_id"), ds_edit.Tables(0).Rows(i).Item("sod_si_id"), _
                                                    ds_edit.Tables(0).Rows(i).Item("sod_loc_id"), ds_edit.Tables(0).Rows(i).Item("sod_pt_id"), _
                                                    ds_edit.Tables(0).Rows(i).Item("pt_code"), ds_edit.Tables(0).Rows(i).Item("sod_qty"), "''") = False Then
        ...
        'Dim ssql As String = ""
        'ssql = "select count(*) as jml from so_mstr "
        'If master_new.PGSqlConn.GetRowInfo(ssql)(0) > 20 Then
        '    Box("Max Limit")
        '    Return False
        'End If
...
#Region "GridView"
    Private Sub gv_edit_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles gv_edit.CellValueChanged
        ...
        If e.Column.Name = "sod_qty" Then
            ...
            Try
                _sod_invc_oid = (gv_edit.GetRowCellValue(e.RowHandle, "sod_invc_oid"))
            Catch ex As Exception
            End Try
            '********* Cek Qty Processed
            Try
            ...
            Else
                dt_bantu = (load_price_list(so_pi_id.EditValue, so_pidd_area_id.EditValue, _sod_pt_id, so_pay_type.EditValue, e.Value))
                ', so_pidd_area_id.EditValue
            End If
        ...
        ElseIf e.Column.Name = "sod_pt_id" Then
            ...
            dt_bantu = New DataTable
            dt_bantu = (load_price_list(so_pi_id.EditValue, so_pidd_area_id.EditValue, e.Value, so_pay_type.EditValue, _sod_qty))
        ...
        ElseIf e.Column.Name = "sod_qty_real" Then
            ...
            dt_bantu = New DataTable
            dt_bantu = (load_price_list(so_pi_id.EditValue, so_pidd_area_id.EditValue, _pt_id, so_pay_type.EditValue, _sod_qty))
    ...
    Private Function load_price_list(ByVal par_pi_id As Integer, ByVal par_pidd_area_id As Integer, ByVal par_pt_id As Integer, ByVal par_payment_type As Integer, ByVal par_min_qty As Double) As DataTable
                ...
                Using objcb As New master_new.CustomCommand
                    With objcb
                        .SQL = "SELECT  " _
                            ...
                            & "  and pidd_area_id = " + par_pidd_area_id.ToString _
                            & "  and pidd_payment_type = " + par_payment_type.ToString _
                            & "  and pid_pt_id = " + par_pt_id.ToString _
                            & "  and pidd_min_qty <= " + SetDecDB(par_min_qty.ToString) _
    ...
    Private Sub browse_data()
        ...
        Dim _sod_en_id As Integer = SetNumber(gv_edit.GetRowCellValue(_row, "sod_en_id"))
        Dim _sod_si_id As Integer = SetNumber(gv_edit.GetRowCellValue(_row, "sod_si_id"))
        Dim _so_ptnr_id_sold As Integer = SetNumber(gv_edit.GetRowCellValue(_row, "so_ptnr_id_sold"))
        Dim _so_pi_id As Integer = SetInteger(so_pi_id.EditValue)
        Dim _so_pi_area_id As Integer = SetInteger(so_pidd_area_id.EditValue)
        Dim _so_ptsfr_loc_id As Integer = SetInteger(so_ptsfr_loc_id.EditValue)
        ...
        ElseIf _col = "pt_code" Then
            ...
            If so_booking.Checked = True Then
                MessageBox.Show("Invetory based Booking cannot be changed", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            ElseIf so_cons.Checked = True Then
                Dim frm As New FSearchPartNumberSearchAlocatedCons
                ...
                frm._pi_id = _so_pi_id
                frm._loc_id = _so_ptsfr_loc_id
                'frm._so_ptnr_id_sold = _so_ptnr_id_sold
            ...
            Else
                ...
                Dim frm As New FSearchPartNumberSearchAlocated
                'Dim frm As New FInventorySearch
                'Dim frm As New FSearchPartNumberSearchAloc
                frm.set_win(Me)
                frm._row = _row
                ...
                frm._si_id = _sod_si_id
                frm._pi_id = _so_pi_id
                frm._pi_area_id = _so_pi_area_id
                frm._loc_id = _so_ptsfr_loc_id
                frm._so_type = so_type.EditValue
                frm._tran_oid = _so_ref_po_oid
                frm.type_form = True
...
#End Region
    ...
    Public Overrides Function insert() As Boolean
        ...
        Dim _so_total, _so_total_ppn, _so_total_pph, _sod_qty, _sod_price, _sod_disc, _so_total_temp, _tax_rate, _sod_qty_open, _sod_qty_booked, _sod_qty_allocated, _sq_total_jml As Double
        Dim i As Integer
        ...
        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
            ...
            If ds_edit.Tables(0).Rows(i).Item("sod_tax_inc").ToString.ToUpper = "Y" Then
                ...
                _sod_price = ds_edit.Tables(0).Rows(i).Item("sod_price") - (_tax_rate * (ds_edit.Tables(0).Rows(i).Item("sod_price") / (1.0 + _tax_rate)))
            Else
        ...
        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
            ...
            If dt_pt.Rows.Count = 0 Then
                ...
                _dtrow("sodas_pt_id") = ds_edit.Tables(0).Rows(i).Item("sod_pt_id")
                ...
                _dtrow("sodas_qty") = ds_edit.Tables(0).Rows(i).Item("sod_qty")
                _dtrow("sodas_qty_sold") = SetNumber(ds_edit.Tables(0).Rows(i).Item("sod_qty"))
                ...
                _row_sodas("sodas_pt_id_sod") = ds_edit.Tables(0).Rows(i).Item("sod_pt_id")
                _row_sodas("sodas_pt_id") = ds_edit.Tables(0).Rows(i).Item("sod_pt_id")
                _row_sodas("pt_code") = ds_edit.Tables(0).Rows(i).Item("pt_code")
                _row_sodas("sodas_qty") = ds_edit.Tables(0).Rows(i).Item("sod_qty")
                _row_sodas("sodas_sod_oid") = ds_edit.Tables(0).Rows(i).Item("sod_oid")
                _row_sodas("sodas_qty_sold") = ds_edit.Tables(0).Rows(i).Item("sod_qty")
            ...
            Else
                ...
                For Each dr As DataRow In dt_pt.Rows
                    ...
                    _row_sodas("sodas_sod_oid") = ds_edit.Tables(0).Rows(i).Item("sod_oid")
                    _row_sodas("sodas_qty_sold") = dr("psd_qty") * SetNumber(ds_edit.Tables(0).Rows(i).Item("sod_qty"))
...
.Command.Open()
                    ...
                    Try
                        ...
                        If _so_ptnr_id_sold_mstr = -1 Then
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                                ...
                                                & "  ptnr_limit_credit, " _
                                                & "  ptnr_active, " _
                                                & "  ptnr_transaction_code_id,so_sales_program, " _
                                                & "  ptnr_dt " _
                                                & ")  " _
                                                & "VALUES ( " _
                        ...
                        If _so_sq_ref_oid = "" Then
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                                ...
                                                & "  so_interval,so_is_package,so_pt_id,so_price,so_shipping_charges,so_total_final, " _
                                                & "  so_terbilang " _
                                                & ")  " _
                                                & "VALUES ( " _
                                                ...
                                                & SetBitYN(so_booking.EditValue) & ",  " _
                                                & SetBitYN(so_alocated.EditValue) & ",  " _
                                                ...
                                                & SetDec(so_shipping_charges.EditValue) & ",  " _
                                                & SetDec(so_total_final.EditValue) & ",  " _
                        ...
                        Else
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                                ...
                                                & SetSetring(so_ref_po_code.Text) & ",  " _
                                                & SetSetring(_so_ref_po_oid) & ",  " _
                                                & SetSetring(so_sq_ref_code.Text) & ",  " _
                                                & SetSetring(_so_sq_ref_oid) & ",  " _
                                                & SetDate(so_date.DateTime) & ",  " _
                                                & SetInteger(so_credit_term.EditValue) & ",  " _
                                                & SetBitYN(so_taxable.EditValue) & ",  " _
                                                & SetInteger(so_tax_class.EditValue) & ",  " _
                                                ...
                                                & SetBitYN(so_cons.EditValue) & ",  " _
                                                & SetBitYN(so_project.EditValue) & ",  " _
                                                & SetInteger(so_ptsfr_loc_id.EditValue) & ",  " _
                                                & SetInteger(so_ptsfr_loc_to_id.EditValue) & ",  " _
                                                & SetInteger(so_ptsfr_loc_git.EditValue) & ",  " _
                                                & SetInteger(so_ar_ac_id.EditValue) & ",  " _
                                                & SetInteger(so_ar_sb_id.EditValue) & ",  " _
                                                & SetInteger(so_ar_cc_id.EditValue) & ",  " _
                                                & SetDbl(_total_dp) & ",  " _
                        ...
                        'If func_coll.get_conf_file("wf_sales_quotation") = "1" Then
                        'If SetString(_so_sq_ref_oid) <> "" Then

                        '    ''.Command.CommandType = CommandType.Text
                        '    '.Command.CommandText = "update so_mstr set so_ptsfr_loc_id = " & ds.Tables(0).Rows(i).Item("sq_ptsfr_loc_id") & " " + _
                        '    '                       " where so_oid = " & SetSetring(_so_oid) & " "
                        '    'ssqls.Add(.Command.CommandText)
                        '    '.Command.ExecuteNonQuery()
                        '    ''.Command.Parameters.Clear()
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            If _so_sq_ref_oid = "" Then
                                ...
                                .Command.CommandText = "INSERT INTO  " _
                                                    ...
                                                    & SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_loc_id")) & ",  " _
                                                    & SetDblDB(ds_edit.Tables(0).Rows(i).Item("sod_sales_unit")) & ",  " _
                                                    & SetDbl(_so_ppn) & "," _
                                                    & SetDbl(_so_pph) & "," _
                                                    & SetDblDB(ds_edit.Tables(0).Rows(_row_gv).Item("sod_commision")) & ",  " _
                                                    & SetDblDB(ds_edit.Tables(0).Rows(_row_gv).Item("sod_commision_total")) & ",  " _
                                                    & SetSetring(_so_sq_ref_oid) & ",  " _
                                                    & SetSetring(ds_edit.Tables(0).Rows(_row_gv).Item("sod_invc_oid").ToString) & ",  " _
                                                    & SetSetring(ds_edit.Tables(0).Rows(_row_gv).Item("sod_pod_oid").ToString) & "  " _
                                                    & ")"
                                ssqls.Add(.Command.CommandText)
                                .Command.ExecuteNonQuery()
                                '.Command.Parameters.Clear()
                            ...
                            Else
                                ...
                                .Command.CommandText = "INSERT INTO  " _
                                                    ...
                                                    & SetSetringDB(ds_edit.Tables(0).Rows(i).Item("sod_rmks")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty_open")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty_allocated")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty_booked")) & ",  " _
                                                    & SetInteger(ds_edit.Tables(0).Rows(i).Item("sod_um")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_cost")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_price")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_disc")) & ",  " _
                                                    ...
                                                    & SetDblDB(ds_edit.Tables(0).Rows(i).Item("sod_dp")) & ",  " _
                                                    & SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_loc_id")) & ",  " _
                                                    & SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid")) & ",  " _
                                                    & SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid")) & ",  " _
                                                    & SetDblDB(ds_edit.Tables(0).Rows(i).Item("sod_sales_unit")) & ",  " _
                                                    & SetDbl(_so_ppn) & "," _
                                                    & SetDbl(_so_pph) & "," _
                                                    & SetDblDB(ds_edit.Tables(0).Rows(_row_gv).Item("sod_commision")) & ",  " _
                                                    & SetDblDB(ds_edit.Tables(0).Rows(_row_gv).Item("sod_commision_total")) & ",  " _
                                                    & SetSetring(_so_sq_ref_oid) & ",  " _
                                                    & SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_pod_oid")) & "  " _
                                                    & ")"
                            ...
                            _sod_qty_open = IIf(IsDBNull(ds_edit.Tables(0).Rows(i).Item("sod_qty_open")) = True, 0, ds_edit.Tables(0).Rows(i).Item("sod_qty_open"))
                            _sod_qty_booked = IIf(IsDBNull(ds_edit.Tables(0).Rows(i).Item("sod_qty_booked")) = True, 0, ds_edit.Tables(0).Rows(i).Item("sod_qty_booked"))
                            _sod_qty_allocated = IIf(IsDBNull(ds_edit.Tables(0).Rows(i).Item("sod_qty_allocated")) = True, 0, ds_edit.Tables(0).Rows(i).Item("sod_qty_allocated"))

                            If _sod_qty_open > SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) Then
                                ...
                                If so_booking.Checked = True Then
                                    If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                                        '.Command.CommandType = CommandType.Text
                                        .Command.CommandText = "update sod_det set sod_qty_booked = coalesce(sod_qty_booked,0) - " + SetDbl(_sq_total_jml) _
                                                             & " where sod_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_oid"))
                                        ssqls.Add(.Command.CommandText)
                                        .Command.ExecuteNonQuery()
                                        '.Command.Parameters.Clear()
                                    End If
                                    ...
                                    If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                                        '.Command.CommandType = CommandType.Text
                                        .Command.CommandText = "update sqd_det set sqd_qty_outs = coalesce(sqd_qty_booking,0) - " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                                    ...
                                    If SetString(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid").ToString) <> "" Then
                                        '.Command.CommandType = CommandType.Text
                                    ...
                                    'If SetString(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid").ToString) <> "" Then
                                    '    '.Command.CommandType = CommandType.Text
                                    '    .Command.CommandText = "update invc_mstr set invc_qty = coalesce(invc_qty,0) + " + SetDbl(_sq_total_jml) _
                                    '                         & " where invc_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid"))
                                    '    ssqls.Add(.Command.CommandText)
                                    '    .Command.ExecuteNonQuery()
                                    '    '.Command.Parameters.Clear()
                                ...
                                'If _sod_qty_allocated <> "" Then
                                If so_alocated.Checked = True Then
                                    '1. lakukan proses pengurangan qty yang di alokasikan thd sq nya
                                    If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                                        '.Command.CommandType = CommandType.Text
                                        .Command.CommandText = "update sod_det set sod_qty_allocated = coalesce(sod_qty_allocated,0) - " + SetDbl(_sq_total_jml) _
                                                             & " where sod_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_oid"))
                                        ssqls.Add(.Command.CommandText)
                                        .Command.ExecuteNonQuery()
                                        '.Command.Parameters.Clear()
                                    ...
                                    '2. lakukan proses pengurangan qty outstanding sebagai indikator proses yang dilakukan dan berapa banyak permintaan tlh terpenuhi
                                    If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                                        '.Command.CommandType = CommandType.Text
                                        .Command.CommandText = "update sqd_det set sqd_qty_outs = coalesce(sqd_qty_allocated,0) - " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                                                             & " where sqd_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid"))
                                        ssqls.Add(.Command.CommandText)
                                        .Command.ExecuteNonQuery()
                                        '.Command.Parameters.Clear()
                                    ...
                                    If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                                        '.Command.CommandType = CommandType.Text
                                        .Command.CommandText = "update sqd_det set sqd_qty_allocated = coalesce(sqd_qty_allocated,0) - " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                                                             & " where sqd_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid"))
                                        ssqls.Add(.Command.CommandText)
                                        .Command.ExecuteNonQuery()
                                        '.Command.Parameters.Clear()
                                    ...
                                    '3. lakukan proses pengurangan qty yang dialokasikan di lokasi gudang dengann qty yang di proses di SO
                                    'If SetString(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid").ToString) <> "" Then
                                    '    '.Command.CommandType = CommandType.Text
                                    '    .Command.CommandText = "update invc_mstr set invc_qty_alloc = coalesce(invc_qty_alloc,0) - " + SetDbl(_sq_total_jml) _
                                    '                         & " where invc_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid"))
                                    '    ssqls.Add(.Command.CommandText)
                                    '    .Command.ExecuteNonQuery()
                                    '    '.Command.Parameters.Clear()
                                    ...
                                    ''.Command.CommandType = CommandType.Text
                                    '.Command.CommandText = "update invc_mstr set invc_qty_available = coalesce(invc_qty_alloc,0) + " + SetDbl(_sq_total_jml) _
                                    '                     & " where invc_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid"))
                                    'ssqls.Add(.Command.CommandText)
                                    '.Command.ExecuteNonQuery()
                                    ''.Command.Parameters.Clear()
                                    ...
                                    '4. Update sqd so untuk menerangkan berapa banyak sq yg sudah di proses di SO karena multi proses maka ini akan bertambah sesuai proses so nya
                                    If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                                        '.Command.CommandType = CommandType.Text
                                        .Command.CommandText = "update sqd_det set sqd_qty_so = coalesce(sqd_qty_so,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                                                             & " where sqd_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid"))
                            ...
                            Else
                                ...
                                If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                                    '.Command.CommandType = CommandType.Text
                                    .Command.CommandText = "update sqd_det set sqd_qty_outs = coalesce(sqd_qty,0) - " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                                                         & " where sqd_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid"))
                                    ssqls.Add(.Command.CommandText)
                                    .Command.ExecuteNonQuery()
                                    '.Command.Parameters.Clear()
                                ...
                                End If
                                'kurangi alokasi seteleh so sebagai qty open so berikutnya
                                If SetString(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid").ToString) <> "" Then
                                    '.Command.CommandType = CommandType.Text
                                    .Command.CommandText = "update invc_mstr set invc_qty_available = coalesce(invc_qty_available,0) + " + SetDbl(_sq_total_jml) _
                                                         & " where invc_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid"))
                            ...
                            'close sq walau outstanding masih bukan nol
                            ''.Command.CommandType = CommandType.Text
                        ...
                        For i = 0 To ds_edit.Tables(1).Rows.Count - 1
                            If so_is_package.Checked = True Then
                                '.Command.CommandType = CommandType.Text
                                .Command.CommandText = "INSERT INTO  " _
                        ...
                        'If so_alocated.EditValue = True Then
    ...
    Private Function insert_return(ByVal par_obj As Object, ByVal par_so_oid As String, ByVal par_so_code As String) As Boolean

        'Dim _so_total, _sod_qty, _sod_price, _sod_disc, _so_total_ppn, _so_total_pph, _so_total_temp, _tax_rate, _sod_qty_open, _sq_total_jml As Double
        'Dim _sod_qty_open As String
        ...
        With ds.Tables(0).Rows(row)
            ...
            so_booking.EditValue = SetBitYNB(.Item("so_booking"))
            so_alocated.EditValue = SetBitYNB(.Item("so_alocated"))

            so_ptsfr_loc_id.EditValue = .Item("so_ptsfr_loc_id")
            so_ptsfr_loc_to_id.EditValue = .Item("so_ptsfr_loc_to_id")
            so_ptsfr_loc_git.EditValue = .Item("so_ptsfr_loc_git")
            ...
            so_sq_ref_code.Text = SetString(.Item("so_sq_ref_code"))
            _so_sq_ref_oid = SetString(.Item("so_sq_ref_oid"))
            ...
            so_shipping_charges.EditValue = .Item("so_shipping_charges")
            so_total_final.EditValue = .Item("so_total_final")
            ...
            Using objcb As New master_new.CustomCommand
                With objcb
                    .SQL = "SELECT  " _
                        ...
                        & "  loc_desc, " _
                        & "  sod_so_sq_ref_oid, " _
                        & "  sod_pod_oid,sod_invc_oid,sod_sqd_oid " _
                        & "FROM  " _
                        & "  public.sod_det " _
                        & "  inner join so_mstr on so_oid = sod_so_oid " _
                        & "  inner join en_mstr on en_id = sod_en_id " _
        ...
        '_sod_qty_open = ds_edit.Tables(0).Rows(i).Item("sod_qty_open")

        With par_obj
            For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                'If ds_edit.Tables(0).Rows(i).Item("sod_qty") > 0 Then
                'If so_booking = True Then
                ...
                If SetString(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid").ToString) <> "" Then
                    'If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) = "" Then
                    'If _sod_qty_open = "" Then
                    If so_booking.Checked = True Then
                        '.Command.CommandType = CommandType.Text
                        .Command.CommandText = "update invc_mstr set invc_qty_booked = coalesce(invc_qty_booked,0) - " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                                             & " where invc_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid"))
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        '.Command.Parameters.Clear()
                        ...
                        'If SetString(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid").ToString) <> "" Then
                        '.Command.CommandType = CommandType.Text
                        .Command.CommandText = "update invc_mstr set invc_qty_available = coalesce(invc_qty_available,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                                             & " where invc_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid"))
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        '.Command.Parameters.Clear()
                ...
                'If SetString(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid").ToString) <> "" Then
                '    '.Command.CommandType = CommandType.Text
                '    .Command.CommandText = "update invc_mstr set invc_qty = coalesce(invc_qty,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                '                         & " where invc_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_invc_oid"))
                '    ssqls.Add(.Command.CommandText)
                '    .Command.ExecuteNonQuery()
                '    '.Command.Parameters.Clear()
                ...
                'If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                '    '.Command.CommandType = CommandType.Text
                '    .Command.CommandText = "update sqd_det set sqd_qty_outs = coalesce(sqd_qty_outs,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty_booked")) _
                '                         & " where sqd_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid"))
                '    ssqls.Add(.Command.CommandText)
                '    .Command.ExecuteNonQuery()
                '    '.Command.Parameters.Clear()
                ...
                'If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                '    '.Command.CommandType = CommandType.Text
                '    .Command.CommandText = "update sqd_det set sqd_qty_booking = coalesce(sqd_qty_booking,0) - " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty_booked")) _
                '                         & " where sqd_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid"))
                '    ssqls.Add(.Command.CommandText)
                '    .Command.ExecuteNonQuery()
                '    '.Command.Parameters.Clear()
        ...
        With par_obj
            ...
            For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                ...
                .Command.CommandText = "INSERT INTO  " _
                                    ...
                                    & SetInteger(i) & ",  " _
                                    & SetDbl((ds_edit.Tables(0).Rows(i).Item("sod_qty") * -1.0)) & ",  " _
                                    & SetInteger(ds_edit.Tables(0).Rows(i).Item("sod_um")) & ",  " _
                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_um_conv")) & ",  " _
                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty_real") * -1.0) & ",  " _
                                    & SetInteger(ds_edit.Tables(0).Rows(i).Item("sod_si_id")) & ",  " _
                ...
                'Update sod_det
                '.Command.CommandType = CommandType.Text
                .Command.CommandText = "update sod_det set sod_qty_shipment = coalesce(sod_qty_shipment,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty").ToString) _
                ...
                If ds_edit.Tables(0).Rows(i).Item("pt_type").ToString.ToUpper = "I" Then
                    If ds_edit.Tables(0).Rows(i).Item("sod_qty_real") > 0 Then
                        If ds_edit.Tables(0).Rows(i).Item("pt_ls").ToString.ToUpper = "N" Then
                            ...
                            If func_coll.get_conf_file("so_assembly") = "1" Then
                                For Each row_sodas As DataRow In dt_sodas.Rows
                                    If SetNumber(ds_edit.Tables(0).Rows(i).Item("sod_pt_id")) = SetNumber(row_sodas("sodas_pt_id_sod")) Then

                                        _pt_id = row_sodas("sodas_pt_id")
                                        _pt_code = row_sodas("pt_code")
                                        _serial = "''"
                                        _qty = row_sodas("sodas_qty_sold")
                                        'dinonaktifkan untuk akomodir invc_qty_available
                                        'If func_coll.update_invc_mstr_minus(ssqls, par_obj, _en_id, _si_id, _loc_id, _pt_id, _pt_code, _serial, _qty) = False Then
                                        '    Return False
                                        'End If

                                        If func_coll.update_invc_mstr_minus_cash(ssqls, par_obj, _en_id, _si_id, _loc_id, _pt_id, _pt_code, _serial, _qty) = False Then
                                            Return False
                                        End If
    ...
    Private Function insert_glt_det_ar(ByVal par_ssqls As ArrayList, ByVal par_obj As Object, ByVal par_ds As DataSet, _
        ...
        'insert ongkos kirim
        If SetNumber(so_shipping_charges.EditValue) > 0 Then
            ...
            With par_obj
                Try
                    ...
                    .Command.CommandText = "INSERT INTO  " _
                                        ...
                                        & SetDblDB(so_shipping_charges.EditValue) & ",  " _
                                        & SetDblDB(0) & ",  " _
                                        & SetSetring(par_oid) & ",  " _
                                        & SetSetring(par_trans_code) & ",  " _
                                        & SetSetring("N") & ",  " _
                    ...
                    If func_coll.update_unposted_glbal_balance(par_ssqls, par_obj, par_date, _
                                                ...
                                                par_cc_id, _
                                                par_en_id, par_cu_id, _
                                                par_exc_rate, so_shipping_charges.EditValue, "D") = False Then
                    ...
                    If func_coll.update_unposted_glbal_balance(par_ssqls, par_obj, par_date, _
                                            ...
                                            par_cc_id, _
                                            par_en_id, par_cu_id, _
                                            par_exc_rate, so_shipping_charges.EditValue, "C") = False Then
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        For i = 0 To ds.Tables("detail").Rows.Count - 1
            If Not IsDBNull(ds.Tables("detail").Rows(i).Item("sod_qty_booked")) = True Then
                If ds.Tables("detail").Rows(i).Item("sod_qty_booked") > 0 Then
                    MessageBox.Show("Quotation already Closed..", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Return False
                End If
            End If
        Next
        ...
        For i = 0 To ds.Tables("detail").Rows.Count - 1
            If Not IsDBNull(ds.Tables("detail").Rows(i).Item("sod_qty_allocated")) = True Then
                If ds.Tables("detail").Rows(i).Item("sod_qty_allocated") > 0 Then
                    MessageBox.Show("Quotation already Closed..", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Return False
                End If
            End If
                ...
                Using objcb As New master_new.CustomCommand
                    With objcb
                        .SQL = "SELECT DISTINCT  " _
                            ...
                            & "  sod_invc_oid, " _
                            & "  sod_so_sq_ref_oid, " _
                            & "  sod_sales_unit_total, sod_commision, sod_commision_total,  " _
                            & "  pt_ls, " _
                            & "  um_mstr.code_name as um_name, " _
                            & "  ac_mstr_sales.ac_code as ac_code_sales, " _
                            & "  ac_mstr_sales.ac_name as ac_name_sales, " _
    ...
    Public Overrides Function edit()
        edit = True
        Dim _so_total, _sod_qty, _sod_price, _sod_disc, _so_total_ppn, _so_total_pph, _so_total_temp, _tax_rate, _sod_qty_open, _sqd_qty_allocated, _sq_total_jml As Double
        Dim _sod_qty_shipment As Double = 0
        Dim i As Integer
        Dim _so_terbilang, _sod_sqd_oid As String
        Dim _row_gv As Integer
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  so_sq_ref_code = " & SetSetring(so_sq_ref_code.Text) & ",  " _
                                            & "  so_sq_ref_oid = " & SetSetring(_so_sq_ref_oid) & ",  " _
                                            ...
                                            & "  so_booking = " & SetBitYN(so_booking.EditValue) & ",  " _
                                            & "  so_alocated = " & SetBitYN(so_alocated.EditValue) & ",  " _
                                            ...
                                            & "  so_manufacture = " & SetBitYN(so_alocated.EditValue) & ",  " _
                                            & "  so_is_package = " & SetBitYN(so_is_package.EditValue) & ",  " _
                                            & "  so_pt_id = " & SetInteger(so_pt_id.Tag) & ",  " _
                                            & "  so_price = " & SetDec(so_price.EditValue) & ",  " _
                                            & "  so_shipping_charges = " & SetDec(so_shipping_charges.EditValue) & ",  " _
                                            & "  so_total_final = " & SetDec(so_total_final.EditValue) & ",  " _
                        ...
                        'If ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("so_manufacture") <> IIf(so_alocated.EditValue = True, "Y", "N") Then
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            _sod_qty_open = IIf(IsDBNull(ds_edit.Tables(0).Rows(i).Item("sod_qty_open")) = True, 0, ds_edit.Tables(0).Rows(i).Item("sod_qty_open"))
                            _sod_sqd_oid = IIf(IsDBNull(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid")) = True, 0, ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid"))
                            ...
                            If SetNumber(ds_edit.Tables(0).Rows(i).Item("status_shipment")) = 0 Then
                                ...
                                .Command.CommandText = "INSERT INTO  " _
                                                ...
                                                & "  sod_payment, " _
                                                & "  sod_dp, " _
                                                & "  sod_loc_id,sod_ppn,sod_pph, sod_commision, sod_commision_total,  " _
                                                & "  sod_so_sq_ref_oid, " _
                                                & "  sod_sales_unit " _
                                                & ")  " _
                                                & "VALUES ( " _
                                ...
                                Else
                                    _sq_total_jml = SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) - _sod_qty_open

                                    If SetString(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) <> "" Then
                                        'tambahkan nilai booking sqd
                                        If so_booking.Checked = True Then
                                            '.Command.CommandType = CommandType.Text
                                            .Command.CommandText = "update sqd_det set sqd_qty_booking = coalesce(sqd_qty_booking,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                                                                 & " where sqd_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid"))
                                            ssqls.Add(.Command.CommandText)
                                            .Command.ExecuteNonQuery()
                                            '.Command.Parameters.Clear()
...
.Command.Open()
                    ...
                    Try
                        ...
                        '.Command.CommandType = CommandType.Text
                        .Command.CommandText = "update so_mstr set so_print_dt = " & SetDateNTime(master_new.PGSqlConn.CekTanggal) & ", so_print = 'Y' " + _
                                              " where so_code = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("so_code") + "'"
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        '.Command.Parameters.Clear()
...
.Command.Open()
    ...
    Public Overrides Sub cancel_approve(ByVal par_colom As String, ByVal par_table As String, ByVal par_criteria As String, ByVal par_oid As String, ByVal par_code As String, _
        ...
        Dim _jml As Integer = 0
        Dim _add_on As Integer = 0
        Dim _sq_ref As String

        'Dim _sq_ref As String
        Dim ssqls As New ArrayList
        'Dim _sq_booking As String

        '_sq_ref = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("so_sq_ref_oid")
        ...
        ElseIf func_coll.get_conf_file("wf_sales_order") = "0" Then
            ...
            '            '.Command = .Connection.CreateCommand
            '            '.Command.CommandType = CommandType.Text
            '            .Command.CommandText = "select sqd_qty_open as add_on " _
            '                                 & " from sod_mstr " _
            '                                 & " inner join sod_det on sod_so_oid = so_oid " _
            '                                 & " where so_oid ~~* '" + par_oid + "' " _
            '                                 & " and sod_sqd_oid <> "" "

            '            .InitializeCommand()
            '            .DataReader = .ExecuteReader
            '            While .DataReader.Read
            '                _add_on = .DataReader("add_on").ToString
            '            End While
            '        End With
            '    End Using
            'Catch ex As Exception
            ...
            'If _add_on > 0 Then
            '    MessageBox.Show("Remove Addon Data First, ", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            '    Exit Sub
            'End If

            '****************** 260102021*************
            'memastikan nilai yang di dapat adalah selalu sq_oid dan bukan null tidak mengandalkan deklarasi _so_sq_ref_oid
            Try
                Using objcek As New master_new.CustomCommand
                    With objcek
                        '.Connection.Open()
                        '.Command = .Connection.CreateCommand
                        '.Command.CommandType = CommandType.Text
                        .Command.CommandText = "select so_sq_ref_oid as sq_ref" _
                                         & " from so_mstr " _
                                         & " where so_oid = '" + par_oid + "' "
                        .InitializeCommand()
                        .DataReader = .ExecuteReader
                        While .DataReader.Read
                            _sq_ref = .DataReader("sq_ref").ToString
                        End While
                    End With
                End Using
            Catch ex As Exception
            ...
            'If _sq_ref <> "" Then
            '    'MessageBox.Show("nyangkut mas broh...", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            '    Try
            '        Using objinsert As New master_new.CustomCommand
            '            With objinsert
            '.Command.Open()
            ...
            '                Try
            '                    '.Command = .Connection.CreateCommand
            '                    If insert_return(objinsert, par_oid, par_code) = False Then
            '                        'sqlTran.Rollback()
            '                        'insert = False
            '                        Exit Sub
            '                    End If
            ...
            '    End Try
            'End If
            'MessageBox.Show("Passing mas broh...", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
            'Exit Sub
...
.Command.Open()
                    ...
                    Try
                        ...
                        'If SetSetring(_so_sq_ref_oid) <> "" Then
                        '    '.Command.CommandType = CommandType.Text
    ...
    Private Sub load_data_to_detail()
        Try
            ...
            sql = "SELECT  " _
                ...
                & "  sod_rmks, " _
                & "  sod_qty, " _
                & "  coalesce (sod_qty_open,0) as sod_qty_open, " _
                & "  sod_qty_allocated, " _
                & "  sod_qty_booked, " _
                & "  sod_qty_picked, " _
                & "  sod_qty_shipment, " _
    ...
    Private Sub file_xml_pameran_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles file_xml_pameran.ButtonClick
        ...
        Try
            ...
            file_xml_pameran.EditValue = _file
            ...
            For Each dr As DataRow In ds.Tables(0).Rows
                ...
                For Each dr_temp As DataRow In dt_temp.Rows
                    ...
                    gv_edit.SetRowCellValue(_row, "sod_pt_id", dr_temp("invc_pt_id"))
                    gv_edit.SetRowCellValue(_row, "pt_code", dr_temp("pt_code"))
                    gv_edit.SetRowCellValue(_row, "pt_desc1", dr_temp("pt_desc1"))
                    gv_edit.SetRowCellValue(_row, "pt_desc2", dr_temp("pt_desc2"))
                    gv_edit.SetRowCellValue(_row, "pt_type", dr_temp("pt_type"))
                    gv_edit.SetRowCellValue(_row, "pt_ls", dr_temp("pt_ls"))
                    gv_edit.SetRowCellValue(_row, "sod_loc_id", dr_temp("invc_loc_id"))
                    gv_edit.SetRowCellValue(_row, "sod_invc_oid", dr_temp("invc_oid"))
                    gv_edit.SetRowCellValue(_row, "loc_desc", dr_temp("loc_desc"))
                    gv_edit.SetRowCellValue(_row, "sod_um", dr_temp("pt_um"))
                    gv_edit.SetRowCellValue(_row, "um_name", dr_temp("um_name"))
                    gv_edit.SetRowCellValue(_row, "sod_cost", dr_temp("invct_cost"))
                    ...
                    gv_edit.SetRowCellValue(_row, "sod_ppn_type", dr_temp("pt_ppn_type"))
                    gv_edit.SetRowCellValue(_row, "sod_qty", dr("qty"))
                    gv_edit.SetRowCellValue(_row, "sod_disc", dr("disc"))
    ...
    Private Sub sq_ext_data_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles sq_ext_data.ButtonClick
    ...
    Private Sub CloseSalesOrderStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CloseSalesOrderStripMenuItem.Click
        Try
            ssqls.Clear()

            If ask("Are you sure to close this transaction ?", "Confirm..", MessageBoxDefaultButton.Button1) = True Then
...
.Command.Open()
    ...
    '    Dim _trans_id As String = "so_trans_id"
    '    Dim _jml As Integer = 0
    '    Dim _add_on As Integer = 0
    '    Dim _sq_ref As String
    ...
    '        'End If
    '        If ask("Are you sure to Close this SO ?", "Confirm..", MessageBoxDefaultButton.Button1) = True Then
    '            Using objinsert As New master_new.CustomCommand
    '                With objinsert
    '.Command.Open()
    '                    'Dim sqlTran As PgSqlTransaction = .Connection.BeginTransaction
    ...
    Private Sub so_pt_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles so_pt_id.ButtonClick
        Try
            ...
            If so_cons.Checked = True Then
                Dim frm As New FSearchPartNumberSearchAlocated
                'Dim frm As New FSearchPartNumberSearchSo
                frm.set_win(Me)
    ...
    Private Sub te_total_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles te_total.EditValueChanged
        Try
            so_total_final.EditValue = te_total.EditValue + so_shipping_charges.EditValue
        Catch ex As Exception
    ...
    Private Sub so_shipping_charges_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles so_shipping_charges.EditValueChanged
        Try
            so_total_final.EditValue = te_total.EditValue + so_shipping_charges.EditValue
        Catch ex As Exception
