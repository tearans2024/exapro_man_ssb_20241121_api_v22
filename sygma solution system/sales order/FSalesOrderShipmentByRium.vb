...
Public Class FSalesOrderShipmentByRium
    ...
    'Private Sub FSalesOrderShipmentByRium_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    '    'TODO: This line of code loads data into the 'Ds_soship1.DataTable1' table. You can move, or remove it, as needed.
    '    Me.DataTable1TableAdapter1.Fill(Me.Ds_soship1.DataTable1)
