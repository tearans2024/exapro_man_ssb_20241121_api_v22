...
Public Class XRSOCashTemporaryByShipmentNonOngkir
    ...
    Dim total_detail As Double = 0.0
    Dim total_all As Double = 0.0
    ...
    Private Sub Detail_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.AfterPrint
        Try
            ...
            total_detail = total_detail + SetNumber(GetCurrentColumnValue("cf_invoice_price_ext"))
...
.Command.Open()
    ...
    Private Sub GroupFooter1_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles GroupFooter1.BeforePrint
        Try
            'total_all = total_detail + SetNumber(GetCurrentColumnValue("so_shipping_charges"))

            'XrLabelTotalFinal.Text = FormatNumber(total_all, 2, TriState.UseDefault, TriState.UseDefault, TriState.UseDefault)
        Catch ex As Exception
