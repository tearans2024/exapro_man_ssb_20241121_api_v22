...
Public Class FDisbursementRealizationSearch
    ...
    Private Sub FDisbursementRealizationSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = ""
        If fobject.name = "FDisbursementRealizationPrint" Then
            get_sequel = "SELECT  " _
                & "  cash_oid, " _
                & "  cash_dom_id, " _
