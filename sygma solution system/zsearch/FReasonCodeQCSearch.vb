...
Public Class FReasonCodeQCSearch
    Public _row, _en_id As Integer

    Private Sub FReasonCodeQCSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        Me.Width = 371
        Me.Height = 360
        te_search.Focus()
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "select code_oid, code_dom_id, code_en_id, en_desc, code_add_by, code_add_date, " + _
                     ...
                     " and code_field ~~* 'qc_reason_code_reject'"
        Return get_sequel
    End Function
    ...
    Private Sub fill_data()
        ...
        If fobject.name = "FQualityControl" Then
            fobject.gv_edit.SetRowCellValue(_row, "qcd_rea_code_id", ds.Tables(0).Rows(_row_gv).Item("code_id"))
            fobject.gv_edit.SetRowCellValue(_row, "rea_code_name", ds.Tables(0).Rows(_row_gv).Item("code_name"))
