...
Public Class FPartnerSearchNonEntity
    ...
    Private Sub FPartnerSearchNonEntity_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        load_cb()
        help_load_data(True)
    ...
    Public Overrides Function get_sequel() As String
        ...
        ElseIf fobject.name = FPartnerAll.Name Or  Then
