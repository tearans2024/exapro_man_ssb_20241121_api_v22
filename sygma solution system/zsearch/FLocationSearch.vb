...
Public Class FLocationSearch
    ...
    Private Sub fill_data()
        ...
        ElseIf fobject.name = "FInventoryReceipts" Then
            ...
            fobject.gv_edit.SetRowCellValue(_row, "loc_desc", ds.Tables(0).Rows(_row_gv).Item("loc_desc"))
            fobject.gv_edit.BestFitColumns()
        ElseIf fobject.name = "FInventoryIssues" Or fobject.name = FInventoryIssuesByWO.Name Then
            fobject.gv_edit.SetRowCellValue(_row, "riud_loc_id", ds.Tables(0).Rows(_row_gv).Item("loc_id"))
            fobject.gv_edit.SetRowCellValue(_row, "loc_desc", ds.Tables(0).Rows(_row_gv).Item("loc_desc"))
            fobject.gv_edit.BestFitColumns()
        ...
        ElseIf fobject.name = FInventoryIssuesHadiah.Name Then
            ...
            '    fobject.wo_asmb_loc_desc.tag = ds.Tables(0).Rows(_row_gv).Item("loc_id")
            '    fobject.wo_asmb_loc_desc.text = ds.Tables(0).Rows(_row_gv).Item("loc_desc")
            '    'fobject.wo_asmb_pt_code.tag = ds.Tables(0).Rows(_row_gv).Item("wo_pt_id")
            '    'fobject.wo_asmb_pt_code.text = ds.Tables(0).Rows(_row_gv).Item("pt_desc1")
        ...
        ElseIf fobject.name = "FInventoryDisAssembly" Or fobject.name = "FInventoryAssembly" Or fobject.name = "FWODisAssembly" Then
