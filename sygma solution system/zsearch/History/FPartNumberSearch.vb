...
Public Class FPartNumberSearch
    ...
    Public Overrides Sub format_grid()
        ...
        ElseIf fobject.name = "FInventoryReturns" Then
            ...
            add_column(gv_master, "Qty Shipment", "sod_qty_invoice", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
            'add_column(gv_master, "Qty Shipment", "invc_qty_available", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
            add_column_copy(gv_master, "Approval Status (Initial, Tax, Accounting)", "pt_approval_status", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "Taxable", "pt_taxable", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "Tax Class", "tax_class_name", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "PPN Type", "pt_ppn_type", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "Cost", "invct_cost", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
            add_column(gv_master, "Price", "sod_price", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
            add_column(gv_master, "Discount", "sod_disc", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
            add_column(gv_master, "Invoice Price", "after_disc", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        If fobject.name = "FSalesOrder" Then
            If _tran_oid.ToString <> "" Then
                get_sequel = "SELECT  " _
                    ...
                    & " and en_active ~~* 'Y'" _
                    & " and pt_en_id = " + _en_id.ToString _
