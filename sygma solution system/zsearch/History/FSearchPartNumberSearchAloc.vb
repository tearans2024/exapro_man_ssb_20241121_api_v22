...
Public Class FSearchPartNumberSearchAloc
    ...
    Public Overrides Function get_sequel() As String
        ...
        If fobject.name = "FSalesQuotation" Or fobject.name = FSalesQuotationConsigment.Name Then
            If grid_call = "header" Then
                get_sequel = "SELECT  distinct " _
                    ...
                    & " and pt_type='I' and pt_id in (select pack_pt_id from pack_mstr) "
            Else
                get_sequel = "SELECT  distinct " _
                    & "  en_id, " _
                    & "  en_desc, " _
                    ...
                    & " left outer join invc_mstr on invc_pt_id = pt_id " _
                    & " where en_active ~~* 'Y'" _
                    & " and pt_additional " + _en_id.ToString _
                    & " and pt_en_id " + _en_id.ToString _
                    & " and pt_type='I' " _
                    & " and loc_type='991306' or loc_default = 'Y' " _
        ...
        ElseIf fobject.name = "FSalesQuotationOri" Then
            'ant 17 maret 2011
