...
Public Class FSearchPartNumberSearchSo
    ...
    Private Sub FSearchPartNumberSearchSo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        te_search.Focus()
    End Sub
    ...
    Public Overrides Function get_sequel() As String
        ...
        If fobject.name = "FSalesOrder" Or fobject.name = FSalesQuotationConsigment.Name Or fobject.name = FSalesQuotationConsigmentAloc.Name Or fobject.name = FSalesQuotationConsigmentAlocated.Name Then
    ...
    Public Overrides Sub fill_data()
        ...
        Try
            ...
            '***********************************************************************************************************
            If fobject.name = "FSalesOrder" Or fobject.name = FSalesQuotationConsigmentAloc.Name Or fobject.name = FSalesQuotationConsigmentAlocated.Name Then
