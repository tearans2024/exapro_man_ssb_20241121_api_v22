...
Public Class FSearchPartNumberSearchPi
    ...
    Private Sub FSearchPartNumberSearchPi_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        te_search.Focus()
    End Sub
    ...
    Public Overrides Sub format_grid()
        If _tran_oid.ToString <> "" Then
            ...
            'add_column(gv_master, "oid", "invc_oid", DevExpress.Utils.HorzAlignment.Default)
        ...
        Else
            ...
            'add_column(gv_master, "Description2", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "Area", "area_name", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "Price", "pidd_price", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
            'add_column_copy(gv_master, "Approval Status (Initial, Tax, Accounting)", "pt_approval_status", DevExpress.Utils.HorzAlignment.Default)
            'add_column(gv_master, "Taxable", "pt_taxable", DevExpress.Utils.HorzAlignment.Default)
            ...
            'add_column(gv_master, "Qty", "invc_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
            add_column(gv_master, "Qty On Hand", "invc_qty_available", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
    ...
    Public Overrides Function get_sequel() As String
        ...
        If fobject.name = "FSalesQuotation" Or fobject.name = FSalesQuotationConsigment.Name Or fobject.name = FSalesQuotationConsigmentAloc.Name Or fobject.name = FSalesQuotationConsigmentAlocated.Name Or fobject.name = FSalesQuotationConsigmentPackagesAlocated.Name Then
            If grid_call = "header" Then
                ...
                If ce_loc.EditValue = True Then
                    get_sequel += " and loc_code = '" & bt_loc_code.EditValue & "'"
                End If
    ...
    Public Overrides Sub fill_data()
        ...
        Try
            ...
            '***********************************************************************************************************
            If fobject.name = FSalesQuotationConsigment.Name Or fobject.name = FSalesQuotationConsigmentAloc.Name Or fobject.name = FSalesQuotationConsigmentAlocated.Name Then
                ...
                If grid_call = "header" Then
                    ...
                    For Each dr As DataRow In dt_pt.Rows
                        ...
                        For Each dr_temp As DataRow In dt_temp.Rows
                            ...
                            fobject.gv_edit.SetRowCellValue(_row, "sqd_invc_oid", dr_temp("invc_oid"))
                            fobject.gv_edit.SetRowCellValue(_row, "sqd_invc_qty", dr_temp("invc_qty"))
                            fobject.gv_edit.SetRowCellValue(_row, "sqd_pt_id", dr_temp("invc_pt_id"))
                            ...
                            'fobject.gv_edit.SetRowCellValue(_row, "sqd_invc_oid", dr_temp("invc_oid"))
                            fobject.gv_edit.SetRowCellValue(_row, "sqd_loc_id", dr_temp("invc_loc_id"))
                            ...
                            fobject.gv_edit.SetRowCellValue(_row, "sqd_invc_oid", ds_bantu.Tables(0).Rows(0).Item("invc_oid"))
                            fobject.gv_edit.SetRowCellValue(_row, "sqd_invc_qty", ds_bantu.Tables(0).Rows(0).Item("invc_qty"))
                ...
                Else
                    ...
                    fobject.gv_edit.SetRowCellValue(_row, "sqd_invc_qty", ds.Tables(0).Rows(_row_gv).Item("invc_qty"))
                    ...
                    fobject.gv_edit.SetRowCellValue(_row, "sqd_pt_id", ds.Tables(0).Rows(_row_gv).Item("invc_pt_id"))
                    ...
                    fobject.gv_edit.SetRowCellValue(_row, "_sqd_invc_oid", ds.Tables(0).Rows(_row_gv).Item("invc_oid"))
    ...
    Private Sub bt_loc_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles bt_loc_code.ButtonClick
        Try

            Dim frm As New FSearchPartNumberLocation
            frm.set_win(Me)
            frm._object = bt_loc_code
            frm._en_id = _en_id
            frm.type_form = True
            frm.ShowDialog()
