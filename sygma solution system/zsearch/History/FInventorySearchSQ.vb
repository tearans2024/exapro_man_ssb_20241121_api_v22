...
Public Class FInventorySearchSQ
    ...
    Public Overrides Sub format_grid()
        ...
        add_column(gv_master, "Item Code", "pt_code", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        ...
        get_sequel = "SELECT DISTINCT  " _
            ...
            & "FROM " _
            & "  public.invc_mstr " _
            & "  INNER JOIN public.pid_det ON (public.invc_mstr.invc_pt_id = public.pid_det.pid_pt_id) " _
    ...
    Private Sub fill_data()
        ...
        If fobject.name = "FSalesQuotationConsigmentAloc" Then
            ...
            '            Else
            '                fobject.gv_edit.SetRowCellValue(_row, "sqd_qty_allocated", ds.Tables(0).Rows(_row_gv).Item("invc_qty_open"))
            '            End If
