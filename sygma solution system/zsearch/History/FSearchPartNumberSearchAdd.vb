...
Public Class FSearchPartNumberSearchAdd
    Public _row, _en_id, _pi_id, _si_id, _loc_id As Integer
    ...
    Private Sub FSearchPartNumberSearchAdd_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        te_search.Focus()
    End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        Else
            ...
            add_column(gv_master, "Qty Available", "invc_qty_open", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
    ...
    Public Overrides Function get_sequel() As String
        ...
        If fobject.name = FSalesQuotationConsigmentAloc.Name Or fobject.name = FSalesQuotationConsigmentAlocated.Name Then
            If grid_call = "header" Then
                get_sequel = "SELECT DISTINCT  " _
                    ...
                    & "  public.pt_mstr.pt_approval_status " _
                    & "FROM " _
                    & "  public.pt_mstr " _
        ...
        Try
            ...
            If fobject.name = FSalesQuotationConsigmentAloc.Name Or fobject.name = FSalesQuotationConsigmentAlocated.Name Then
                ...
                If grid_call = "header" Then
                    ...
                    fobject.sqd_invc_oid.tag = ds.Tables(0).Rows(_row_gv).Item("invc_oid")
                ...
                Else
                    ...
                    Catch ex As Exception
                        MessageBox.Show(ex.Message)
                    End Try
                    'fobject._sqd_invc_oid = ds.Tables(0).Rows(_row_gv).Item("sq_oid")
