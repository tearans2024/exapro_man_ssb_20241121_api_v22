...
Public Class FPartnerParenntSearch
    ...
    Private Sub FPartnerParenntSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        load_cb()
        help_load_data(True)
    ...
    Public Overrides Function get_sequel() As String
        ...
        get_sequel = "SELECT  " _
               ...
               & " and ptnr_active ~~* 'Y' " _
               & " and ptnr_parent = " + _par_ptnr_id.ToString + " " _
               & " order by ptnr_name"
    ...
    Private Sub fill_data()
        ...
        'If fobject.name = "FSalesQuotationConsigmentAlocated" Then
        fobject.sq_ds_ptnr_ids.tag = ds.Tables(0).Rows(_row_gv).Item("ptnr_id")
        fobject.sq_ds_ptnr_ids.text = SetString(ds.Tables(0).Rows(_row_gv).Item("ptnr_name"))
