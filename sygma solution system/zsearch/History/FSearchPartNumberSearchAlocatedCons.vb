...
Public Class FSearchPartNumberSearchAlocatedCons
    ...
    Private Sub FSearchPartNumberSearchAlocatedCons_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        te_search.Focus()
    End Sub
