...
Public Class FPartNumberSearchAdditional
        ...
        Try
            ...
            ElseIf fobject.name = "FSalesQuotationConsigmentAloc" Then
                If grid_call = "header" Then
                    ...
                    For Each dr As DataRow In dt_pt.Rows
                        ...
                        For Each dr_temp As DataRow In dt_temp.Rows
                            ...
                            'dt_bantu = (load_price_list(so_pi_id.EditValue, _sqd_pt_id, fobject.so_pay_type.EditValue, e.Value))
                            ...
                            If dt_bantu_new.Rows.Count > 0 Then
                                ...
                                fobject.gv_edit.SetRowCellValue(_row, "sqd_commision", dt_bantu_new.Rows(0).Item("pidd_commision"))
                            Else
                                ...
                                fobject.gv_edit.SetRowCellValue(_row, "sqd_commision", 0)
                            End If
                ...
                Else
                    ...
                    fobject.gv_edit.SetRowCellValue(_row, "sqd_is_additional_charge", ds.Tables(0).Rows(_row_gv).Item("pt_additional"))
                    ...
                    If _tran_oid.ToString <> "" Then
                        fobject.gv_edit.SetRowCellValue(_row, "sqd_qty", ds.Tables(0).Rows(_row_gv).Item("qty_open"))
                        fobject.gv_edit.SetRowCellValue(_row, "sqd_pod_oid", ds.Tables(0).Rows(_row_gv).Item("pod_oid"))
                    End If
                    ...
                    '    _dtrow("sqdas_pt_id_sqd") = ds.Tables(0).Rows(_row_gv).Item("pt_id")
                    ...
                    '    _dtrow("sqdas_pt_id") = dr("psd_pt_bom_id")
                    '    _dtrow("pt_code") = dr("pt_code")
                    '    _dtrow("pt_desc1") = dr("pt_desc1")
                    '    _dtrow("pt_desc2") = dr("pt_desc2")
                    '    _dtrow("sqdas_qty") = dr("psd_qty")
                    '    _dtrow("sqdas_qty_sold") = dr("psd_qty")
