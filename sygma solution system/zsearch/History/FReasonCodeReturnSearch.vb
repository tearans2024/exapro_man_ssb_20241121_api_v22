...
Public Class FReasonCodeReturnSearch
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "select code_oid, code_dom_id, code_en_id, en_desc, code_add_by, code_add_date, " + _
                     ...
                     " and code_field ~~* 'po_ret_rea_code'"
        Return get_sequel
    End Function
    ...
    Private Sub fill_data()
        ...
        If fobject.name = "FPurchaseReturn" Then
            fobject.gv_edit.SetRowCellValue(_row, "rcvd_rea_code_id", ds.Tables(0).Rows(_row_gv).Item("code_id"))
