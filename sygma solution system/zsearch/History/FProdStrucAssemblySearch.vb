...
Public Class FProdStrucAssemblySearch
    ...
    Private Sub FProdStrucAssemblySearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        te_search.Focus()
    End Sub
        ...
        If fobject.name = FWorkOrder.Name Then
            ...
            Else
                ...
                If _obj.name = "wo_ps_id" Then
                    ...
                    '        & " and ps_pt_bom_id in (select psd_pt_bom_id from public.get_ps_first(" & _pt_id & ",1) where variable_4>0) "
