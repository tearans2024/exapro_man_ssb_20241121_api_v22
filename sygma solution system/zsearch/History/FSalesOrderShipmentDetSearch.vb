...
Public Class FSalesOrderShipmentDetSearch
    ...
    Public Overrides Sub format_grid()
        ...
        'add_column(gv_master, "Qty Open", "pcss_open", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column(gv_master, "Qty Shipment", "qty_shipment", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        'add_column(gv_master, "Qty Packing", "pcss_packing", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
