...
Public Class FPartnerSearch
    ...
    Public Overrides Function get_sequel() As String
        ...
        ElseIf fobject.name = "FSalesQuotationConsigmentAlocated" Or fobject.name = FSalesOrderAlocated.Name Or fobject.name = FSalesQuotationConsigmentPackagesAlocated.Name Then
    ...
    Private Sub fill_data()
        ...
        ElseIf fobject.name = "FSalesQuotation" Or fobject.name = FSalesQuotationConsigment.Name Or fobject.name = FSalesQuotationConsigmentAloc.Name Or fobject.name = FSalesQuotationConsigmentAlocated.Name Or fobject.name = FSalesQuotationConsigmentPackagesAlocated.Name Then
            fobject.sq_ptnr_id_sold.tag = ds.Tables(0).Rows(_row_gv).Item("ptnr_id")
            fobject.sq_ptnr_id_sold.text = SetString(ds.Tables(0).Rows(_row_gv).Item("ptnr_name"))
            ...
            '    fobject._ap_ptnr_id_mstr = ds.Tables(0).Rows(_row_gv).Item("ptnr_id")
            '    fobject.ap_ptnr_id.text = ds.Tables(0).Rows(_row_gv).Item("ptnr_name")
            '    fobject.ap_ptnr_bk.text = ds.Tables(0).Rows(_row_gv).Item("ptnr_bank")
            '    fobject.ap_ptnr_bk_acc.text = ds.Tables(0).Rows(_row_gv).Item("ptnr_no_rek")
            '    fobject.ap_ptnr_bk_fee.text = ds.Tables(0).Rows(_row_gv).Item("ptnr_rek_name")
        ...
        ElseIf fobject.name = FVoucher.Name Then
            ...
            fobject.ap_ptnr_bk.text = ds.Tables(0).Rows(_row_gv).Item("ptnr_bank")
            fobject.ap_ptnr_bk_acc.text = ds.Tables(0).Rows(_row_gv).Item("ptnr_no_rek")
            fobject.ap_ptnr_acc_name.text = ds.Tables(0).Rows(_row_gv).Item("ptnr_rek_name")
