...
Public Class FCOutSearch
    ...
    Private Sub FCOutSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Function get_sequel() As String
        ...
        get_sequel = "SELECT  " _
                        ...
                        & "FROM  " _
                        & "  public.casho_out " _
                        & "  where casho_en_id = " & _en_id.ToString _
                        & " and casho_date >= " + SetDate(pr_txttglawal.DateTime.Date) _
                        & " and casho_date <= " + SetDate(pr_txttglakhir.DateTime.Date) _
                        & "  order by casho_code "
        Return get_sequel
    End Function
    ...
    Private Sub fill_data()
        If fobject.name = "FCOutPrint" Then
