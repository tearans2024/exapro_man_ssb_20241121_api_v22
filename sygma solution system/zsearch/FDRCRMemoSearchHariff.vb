    ...
    Private Sub sb_fill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sb_fill.Click
        Try
            ...
            For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                _exr_cu_rate_1 = func_data.get_exchange_rate(ds.Tables(0).Rows(i).Item("arinv_cu_id").ToString)
                If ds.Tables(0).Rows(i).Item("is_checked") = True Then
                    If jml = 0 Then

                        fobject.gv_edit.SetRowCellValue(_row, "arpayd_ar_ref", ds.Tables(0).Rows(i).Item("arinv_code"))
                        fobject.gv_edit.SetRowCellValue(_row, "arpayd_ar_oid", ds.Tables(0).Rows(i).Item("arinv_oid"))
                        fobject.gv_edit.SetRowCellValue(_row, "arpayd_ac_id", ds.Tables(0).Rows(i).Item("arinv_ac_ar_id"))
                        fobject.gv_edit.SetRowCellValue(_row, "ac_code", ds.Tables(0).Rows(i).Item("ac_code"))
                        fobject.gv_edit.SetRowCellValue(_row, "ac_name", ds.Tables(0).Rows(i).Item("ac_name"))
                        fobject.gv_edit.SetRowCellValue(_row, "arpayd_sb_id", ds.Tables(0).Rows(i).Item("arinv_sb_ar_id"))
                        fobject.gv_edit.SetRowCellValue(_row, "sb_desc", ds.Tables(0).Rows(i).Item("sb_desc"))
                        fobject.gv_edit.SetRowCellValue(_row, "arpayd_cc_id", ds.Tables(0).Rows(i).Item("arinv_cc_ar_id"))
                        fobject.gv_edit.SetRowCellValue(_row, "cc_desc", ds.Tables(0).Rows(i).Item("cc_desc"))

                        If ds.Tables(0).Rows(i).Item("arinv_cu_id") = _cu_id Then
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_exc_rate", _exr_cu_rate_1)
                            fobject.gv_edit.SetRowCellValue(_row, "arinv_exc_rate", ds.Tables(0).Rows(i).Item("arinv_exc_rate"))
                        ElseIf ds.Tables(0).Rows(i).Item("arinv_cu_id") <> master_new.ClsVar.ibase_cur_id And _
                           _cu_id <> master_new.ClsVar.ibase_cur_id Then
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_exc_rate", _exr_cu_rate_1)
                            fobject.gv_edit.SetRowCellValue(_row, "arinv_exc_rate", ds.Tables(0).Rows(i).Item("arinv_exc_rate"))
                        ElseIf ds.Tables(0).Rows(i).Item("arinv_cu_id") <> master_new.ClsVar.ibase_cur_id Then
                            'fobject.gv_edit.SetRowCellValue(_row, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding") * _exr_cu_rate_1)
                            'fobject.gv_edit.SetRowCellValue(_row, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding") * _exr_cu_rate_1)
                            'tidak usah dikalikan kurs 20101127 by sys
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            'fobject.gv_edit.SetRowCellValue(_row, "arpayd_cur_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_exc_rate", _exr_cu_rate_1)
                            fobject.gv_edit.SetRowCellValue(_row, "arinv_exc_rate", ds.Tables(0).Rows(i).Item("arinv_exc_rate"))
                        Else
                            fobject.gv_edit.SetRowCellValue(_row, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                        ...
                        fobject.gv_edit.SetRowCellValue(_row, "arinv_cu_id", ds.Tables(0).Rows(i).Item("arinv_cu_id"))
                        fobject.gv_edit.SetRowCellValue(_row, "arpayd_disc_amount", 0)
                        fobject.gv_edit.SetRowCellValue(_row, "arpayd_other_amount", 0)
                        fobject.gv_edit.SetRowCellValue(_row, "arpayd_cur_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                    ...
                    Else
                        ...
                        fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_ar_ref", ds.Tables(0).Rows(i).Item("arinv_code"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_ar_oid", ds.Tables(0).Rows(i).Item("arinv_oid"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_ac_id", ds.Tables(0).Rows(i).Item("arinv_ac_ar_id"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "ac_code", ds.Tables(0).Rows(i).Item("ac_code"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "ac_name", ds.Tables(0).Rows(i).Item("ac_name"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_sb_id", ds.Tables(0).Rows(i).Item("arinv_sb_ar_id"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "sb_desc", ds.Tables(0).Rows(i).Item("sb_desc"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_cc_id", ds.Tables(0).Rows(i).Item("arinv_cc_ar_id"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "cc_desc", ds.Tables(0).Rows(i).Item("cc_desc"))

                        If ds.Tables(0).Rows(i).Item("arinv_cu_id") = _cu_id Then
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_exc_rate", _exr_cu_rate_1)
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arinv_exc_rate", ds.Tables(0).Rows(i).Item("arinv_exc_rate"))
                        ElseIf ds.Tables(0).Rows(i).Item("arinv_cu_id") <> master_new.ClsVar.ibase_cur_id And _
                           _cu_id <> master_new.ClsVar.ibase_cur_id Then
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            ...
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arinv_exc_rate", ds.Tables(0).Rows(i).Item("arinv_exc_rate"))
                        ElseIf ds.Tables(0).Rows(i).Item("arinv_cu_id") <> master_new.ClsVar.ibase_cur_id Then
                            'fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding") * _exr_cu_rate_1)
                            'fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding") * _exr_cu_rate_1)
                            'tidak usah dikalikan kurs 20101127 by sys
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            'fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_cur_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_exc_rate", _exr_cu_rate_1)
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arinv_exc_rate", ds.Tables(0).Rows(i).Item("arinv_exc_rate"))
                        Else
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_cash_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_exc_rate", 1)
                            fobject.gv_edit.SetRowCellValue(_row_pos, "arinv_exc_rate", ds.Tables(0).Rows(i).Item("arinv_exc_rate"))
                        End If

                        fobject.gv_edit.SetRowCellValue(_row_pos, "arinv_cu_id", ds.Tables(0).Rows(i).Item("arinv_cu_id"))
                        fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_disc_amount", 0)
                        fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_other_amount", 0)
                        fobject.gv_edit.SetRowCellValue(_row_pos, "arpayd_cur_amount", ds.Tables(0).Rows(i).Item("arinv_outstanding"))
                    End If
                End If
            Next
