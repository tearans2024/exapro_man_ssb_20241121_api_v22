...
Public Class FInventoryRequestSearch
    ...
    Public Overrides Sub format_grid()
        ...
        If fobject.name = FWorkOrderIssue.Name Then
            ...
            add_column(gv_master, "Qty", "pbd_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        End If
    ...
    Private Sub fill_data()
        ...
        ElseIf fobject.name = "FInventoryIssues" Or fobject.name = FInventoryIssuesHadiah.Name Then
            ...
            For i = 0 To ds_bantu.Tables(0).Rows.Count - 1
                ...
                _dtrow("riud_loc_id") = ds_bantu.Tables(0).Rows(i).Item("loc_id")
