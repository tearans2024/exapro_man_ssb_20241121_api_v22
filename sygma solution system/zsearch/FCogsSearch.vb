...
Public Class FCogsSearch
    ...
    Public Overrides Sub format_grid()
        ...
        add_column(gv_master, "Material", "cogsc_mtl_total", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_master, "Service", "cogsc_srv_total", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_master, "Total", "cogscr_total", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
    End Sub
