...
Public Class FSalesOrderSearch
    ...
    Private Sub fill_data()
        ...
        ElseIf fobject.name = FWorkOrderbyMO.Name Then
            _obj.text = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pjc_code")
            _obj.tag = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pjc_oid")
