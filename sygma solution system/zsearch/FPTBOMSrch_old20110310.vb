...
Public Class FPTBOMSrch
    ...
    Public Overrides Sub format_grid()
        ...
        add_column(gv_master, "PT/BOM Code", "codeptbom", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        ...
        Else
            ...
            get_sequel = "SELECT en_mstr.en_desc, pt_oid as oidptbom, pt_en_id as enptbom, pt_id as idptbom,  " _
                        ...
                        & "FROM " _
                        & "  public.pt_mstr  " _
                        & "  INNER JOIN en_mstr on pt_en_id=en_id where pt_type='I' and pt_en_id in (" & _en_id & ")" _
                        & "UNION " _
                        & "SELECT en_mstr.en_desc, bom_oid, bom_en_id, bom_id, " _
                        & " bom_code, bom_desc, CASE WHEN bom_desc = '.,.,' " _
                        & "THEN 'Y' " _
                        ...
                        & "END AS bomsign " _
                        & "FROM " _
                        & "  public.bom_mstr INNER JOIN en_mstr on bom_en_id=en_id where bom_en_id in (" & _en_id & ")"
        End If
    ...
    Private Sub fill_data()
        ...
        If fobject.name = "FProductStructure" Then
            ...
            Else
                ...
                fobject.gv_edit.SetRowCellValue(_row, "ptbomdesc", ds.Tables(0).Rows(_row_gv).Item("descptbom"))
                ...
                fobject.gv_edit.SetRowCellValue(_row, "psd_comp", ds.Tables(0).Rows(_row_gv).Item("codeptbom"))
