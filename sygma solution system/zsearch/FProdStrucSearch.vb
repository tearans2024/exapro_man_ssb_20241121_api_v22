...
Public Class FProdStrucSearch
    ...
    Public Overrides Sub format_grid()
        ...
        If fobject.name = FWorkOrder.Name Or fobject.name = FCogsSimulation.Name Or fobject.name = FCogsCalculation.Name Or fobject.name = FWorkOrderMO.Name Then
    ...
    Public Overrides Function get_sequel() As String
            ...
            Else
                ...
                Else
                    get_sequel = "SELECT  " _
                        ...
                        & "  coalesce(0,0) as sct_price,sod_qty " _
                        & "FROM  " _
                        & "  public.pt_mstr" _
        ...
        ElseIf fobject.name = FProdStrucTree.Name Or fobject.name = FCogsSimulation.Name Or fobject.name = FCogsCalculation.Name Then
            get_sequel = "SELECT   " _
                    & "   en_desc,  " _
                    & "   ps_oid,  " _
                    & "   ps_dom_id,  " _
        ...
        ElseIf fobject.name = FWorkOrderMO.Name Then
            get_sequel = "SELECT  " _
                        & "  en_id, " _
                        & "  en_desc, " _
                        & "  pt_id, " _
                        ...
                        & "  um_mstr.code_name as um_name, " _
                        & "  coalesce(0,0) as sct_total, " _
                        & "  coalesce(0,0) as sct_price,prjd_qty " _
                        & "FROM  " _
                        & "  public.pt_mstr" _
                        & " inner join en_mstr on en_id = pt_en_id " _
                        & " left outer join loc_mstr on loc_id = pt_loc_id " _
        ...
        If fobject.name <> FWorkOrderMO.Name Or fobject.name <> FWorkOrderMO.Name Then
    ...
    Private Sub fill_data()
        ...
        ElseIf fobject.name = FWOBillMaintenance.Name Then
            ...
            '    fobject.copy_ps.editvalue = SetString(ds.Tables(0).Rows(_row_gv).Item("pt_code")) & " " & SetString(ds.Tables(0).Rows(_row_gv).Item("pt_desc1"))
            '    Dim sSQL As String
            '    sSQL = "SELECT  " _
            '          & "  psd_det.psd_oid, " _
            ...
            '        fobject.gv_edit.SetRowCellValue(i, "psd_yield_pct", dr("psd_yield_pct"))
            ...
            'ElseIf fobject.name = FCogsSimulation.Name Or fobject.name = FCogsCalculation.Name Then
            '    Dim sSQL As String
            '    sSQL = "SELECT  " _
            '          & "  psd_det.psd_oid, " _
            '          & "  psd_det.psd_ps_oid, " _
            ...
            '        fobject.gc_edit.EmbeddedNavigator.Buttons.DoClick(fobject.gc_edit.EmbeddedNavigator.Buttons.Append)
            '        fobject.gc_edit.EmbeddedNavigator.Buttons.DoClick(fobject.gc_edit.EmbeddedNavigator.Buttons.EndEdit)
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "psd_pt_bom_id", dr("psd_pt_bom_id"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "pt_code", dr("pt_code"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "pt_desc", dr("pt_desc"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "um_desc", dr("um_desc"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "psd_indirect", dr("psd_indirect"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "psd_desc", dr("psd_desc"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "psd_start_date", dr("psd_start_date"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "psd_end_date", dr("psd_end_date"))

            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "psd_qty", dr("psd_qty"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "psd_yield_pct", dr("psd_yield_pct"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "psd_op", dr("psd_op"))
            '        fobject.gv_edit_dir_mat.SetRowCellValue(i, "op_name", dr("op_name"))

            '        fobject.gc_edit.EmbeddedNavigator.Buttons.DoClick(fobject.gc_edit.EmbeddedNavigator.Buttons.EndEdit)
            '        i += 1
            '    Next
            '    fobject.gv_edit_dir_mat.BestFitColumns()
