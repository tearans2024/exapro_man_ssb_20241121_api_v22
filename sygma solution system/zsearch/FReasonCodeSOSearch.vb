...
Public Class FReasonCodeSOSearch
    Public _row, _en_id As Integer

    Private Sub FReasonCodeSOSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        Me.Width = 371
        Me.Height = 360
        te_search.Focus()
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "select code_oid, code_dom_id, code_en_id, en_desc, code_add_by, code_add_date, " + _
                     ...
                     " and code_field ~~* 'soshipd_rea_code_id'"
        Return get_sequel
    End Function
    ...
    Private Sub fill_data()
        ...
        If fobject.name = "FSalesOrderReturn" Then
