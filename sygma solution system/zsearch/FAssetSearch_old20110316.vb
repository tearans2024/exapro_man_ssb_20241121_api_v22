...
Public Class FAssetSearch
    ...
    Private Sub fill_data()
        ...
        ElseIf fobject.name = "FAssetTransfer" Then
            ...
            'ant 5 maret 2011
        ElseIf fobject.name = "FReqTransferIssue" Then
            fobject.gv_edit_serial.SetRowCellValue(_row, "reqsdd_ass_id", ds.Tables(0).Rows(_row_gv).Item("ass_id"))
            fobject.gv_edit_serial.SetRowCellValue(_row, "ass_code", ds.Tables(0).Rows(_row_gv).Item("ass_code"))
            fobject.gv_edit_serial.SetRowCellValue(_row, "ass_model", ds.Tables(0).Rows(_row_gv).Item("ass_model"))
