...
Public Class FShow
    ...
    Public Overrides Sub format_grid()
        ...
        ElseIf fobject.name = FRosView.Name Then
            ...
            add_column(gv_master, "Amount", "rsthistory_amount", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
