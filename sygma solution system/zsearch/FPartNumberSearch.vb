...
Public Class FPartNumberSearch
    ...
    Public Overrides Sub format_grid()
        ...
        ElseIf fobject.name = "FInventoryReturns" Then
            ...
            add_column(gv_master, "Qty Shipment", "sod_qty_invoice", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
            'add_column(gv_master, "Qty Shipment", "invc_qty_available", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
            add_column_copy(gv_master, "Approval Status (Initial, Tax, Accounting)", "pt_approval_status", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "Taxable", "pt_taxable", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "Tax Class", "tax_class_name", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "PPN Type", "pt_ppn_type", DevExpress.Utils.HorzAlignment.Default)
            add_column(gv_master, "Cost", "invct_cost", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
            add_column(gv_master, "Price", "sod_price", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
            add_column(gv_master, "Discount", "sod_disc", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
            add_column(gv_master, "Invoice Price", "after_disc", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Public Overrides Function get_sequel() As String
        ...
        If fobject.name = "FSalesOrder" Then
            If _tran_oid.ToString <> "" Then
                get_sequel = "SELECT  " _
                    ...
                    & "  pod_qty - coalesce(pod_qty_so,0) qty_open,pt_syslog_code " _
                    & "FROM  " _
                    & "  public.pod_det " _
            ...
            Else
                If grid_call = "header" Then
                    ...
                    & "  tax_class_mstr.code_name as tax_class_name, " _
                    & "  pt_ppn_type, " _
                    & "  um_mstr.code_name as um_name,pt_syslog_code " _
                    & "FROM  " _
                    & "  public.pt_mstr" _
                    & " inner join en_mstr on en_id = pt_en_id " _
                    & " inner join loc_mstr on loc_id = pt_loc_id " _
                    ...
                    & " where (pt_code ~~* '%" + Trim(te_search.Text) + "%' or pt_syslog_code ~~* '%" + Trim(te_search.Text) + "%' or pt_desc1 ~~* '%" + Trim(te_search.Text) + "%' or pt_desc2 ~~* '%" + Trim(te_search.Text) + "%')" _
                    & " and en_active ~~* 'Y'" _
        ...
        ElseIf fobject.name = "FInventoryReceipts" Then
            If _tran_oid.ToString <> "" Then
                get_sequel = "SELECT  " _
                    ...
                    & "  sod_qty - coalesce(sod_qty_ir,0) qty_open,pt_syslog_code " _
                    & "FROM  " _
                    & "  public.sod_det " _
        ...
        ElseIf fobject.name = "FInventoryReturns" Then
            ...
            get_sequel = "SELECT  " _
                    ...
                    & "sod_disc, " _
                    & "sod_price, " _
                    & "(sod_price - (sod_price * sod_disc)) as after_disc, " _
                    & "pt_pl_id, " _
                    & "tax_class_mstr.code_name as tax_class_name, " _
                    & "pt_ppn_type, " _
                    & "um_mstr.code_name as um_name, " _
                    ...
                    & "inner join public.ar_mstr ON ar_oid = arso_ar_oid " _
                    & "left outer join code_mstr tax_class_mstr on tax_class_mstr.code_id = pt_tax_class " _
                    & "inner join si_mstr on si_id = sod_si_id " _
                    & "where en_active ~~* 'Y'" _
                    & "and sod_qty_invoice > '0'" _
                    & " and ar_oid = '" + _trans_oid + "'"
            'End If
        ...
        ElseIf fobject.name = "FInventoryIssues" Then
            If _tran_oid.ToString <> "" Then
                get_sequel = "SELECT  " _
                    ...
                    & "  pbd_qty - coalesce(pbd_qty_riud,0) qty_open,pt_syslog_code " _
                    & "FROM  " _
                    & "  public.pbd_det " _
        ...
        ElseIf fobject.name = "FItemLeadTime" Then
            get_sequel = "SELECT  distinct " _
                    & "  en_id, " _
                    & "  en_desc, " _
                    & "  pt_id, " _
        ...
        ElseIf fobject.name = "FProductStructure" Or fobject.name = "FPartNumberSubtitute" _
            ...
            Or fobject.name = "FProject" Or fobject.name = "FInventoryHistory" Or fobject.name = "FPartNumberSKUGenerator" Or fobject.name = "FPartNumberSKUGenerator" Then
        ...
        ElseIf fobject.name = "FProjectMaintenance" Then
            get_sequel = "SELECT  distinct " _
                    ...
                    & "  tax_class_mstr.code_name as tax_class_name, " _
                    & "  pt_ppn_type, " _
                    & "  um_mstr.code_name as um_name,pt_syslog_code,sct_total " _
                    & "FROM  " _
                    & "  public.pt_mstr" _
                    & " inner join en_mstr on en_id = pt_en_id " _
                    & " inner join loc_mstr on loc_id = pt_loc_id " _
                    ...
                    & " inner join invct_table on invct_pt_id = pt_id " _
                    & " inner join si_mstr on si_id = invct_si_id " _
                    & " inner join sct_mstr on sct_pt_id = pt_id " _
                    & " where (pt_code ~~* '%" + Trim(te_search.Text) + "%' or pt_syslog_code ~~* '%" + Trim(te_search.Text) + "%'  or pt_desc1 ~~* '%" + Trim(te_search.Text) + "%' or pt_desc2 ~~* '%" + Trim(te_search.Text) + "%')" _
                    & " and en_active ~~* 'Y'" _
                    & " and pt_en_id in (" + _en_id_coll + ")"

            'ElseIf fobject.name = FRequisition.Name Or fobject.name = FFGPackaging.Name Then
            '    get_sequel = "SELECT  distinct " _
            '            & "  en_id, " _
            '            & "  en_desc, " _
            '            & "  coalesce(si_desc,'') as si_desc, " _
    ...
    Public Overrides Sub fill_data()
        Try
            ...
            ElseIf fobject.name = "FPriceList" Then
                ...
                fobject.gv_edit_item.SetRowCellValue(_row, "pid_pt_taxable", ds.Tables(0).Rows(_row_gv).Item("pt_taxable"))
                fobject.gv_edit_item.SetRowCellValue(_row, "pid_pt_tax_class", ds.Tables(0).Rows(_row_gv).Item("pt_tax_class"))
                fobject.gv_edit_item.SetRowCellValue(_row, "pid_pt_ppn_type", ds.Tables(0).Rows(_row_gv).Item("pt_ppn_type"))
            ...
            ElseIf fobject.name = "FInventoryReceipts" Then
                ...
                fobject.gv_edit.SetRowCellValue(_row, "riud_um_name", ds.Tables(0).Rows(_row_gv).Item("um_name"))
                fobject.gv_edit.SetRowCellValue(_row, "pt_syslog_code", ds.Tables(0).Rows(_row_gv).Item("pt_syslog_code"))
            ...
            ElseIf fobject.name = "FInventoryReturns" Then
                ...
                fobject.gv_edit.SetRowCellValue(_row, "pt_ls", ds.Tables(0).Rows(_row_gv).Item("pt_ls"))
                fobject.gv_edit.SetRowCellValue(_row, "riud_loc_id", ds.Tables(0).Rows(_row_gv).Item("pt_loc_id"))
                fobject.gv_edit.SetRowCellValue(_row, "riud_qty", ds.Tables(0).Rows(_row_gv).Item("sod_qty_invoice"))
                fobject.gv_edit.SetRowCellValue(_row, "loc_desc", ds.Tables(0).Rows(_row_gv).Item("loc_desc"))
                fobject.gv_edit.SetRowCellValue(_row, "riud_um", ds.Tables(0).Rows(_row_gv).Item("pt_um"))
                fobject.gv_edit.SetRowCellValue(_row, "riud_um_name", ds.Tables(0).Rows(_row_gv).Item("um_name"))
                fobject.gv_edit.SetRowCellValue(_row, "riud_um_name", ds.Tables(0).Rows(_row_gv).Item("um_name"))
                ...
                If _tran_oid.ToString <> "" Then
                    ...
                    fobject.gv_edit.SetRowCellValue(_row, "riud_sod_oid", ds.Tables(0).Rows(_row_gv).Item("sod_oid"))
                End If
            ...
            ElseIf fobject.name = "FSalesOrderAlocated" Then
                ...
                Else
                    ...
                    If _tran_oid.ToString <> "" Then
                        ...
                        fobject.gv_edit.SetRowCellValue(_row, "sod_pod_oid", ds.Tables(0).Rows(_row_gv).Item("pod_oid"))
                    End If
            ...
            ElseIf fobject.name = FPartnumberWebsite.Name Then
                _obj.editvalue = ds.Tables(0).Rows(_row_gv).Item("pt_code")
                fobject.pt_desc1.text = ds.Tables(0).Rows(_row_gv).Item("pt_desc1")
            Else
                _obj.editvalue = ds.Tables(0).Rows(_row_gv).Item("pt_desc1")
