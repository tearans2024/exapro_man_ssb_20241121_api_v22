...
Public Class FMarketingOrderSearch
    ...
    Private Sub FMarketingOrderSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Public Overrides Sub format_grid()
        ...
        ElseIf fobject.name = FSalesOrderShipment.Name Then
            ...
            'add_column(gv_master, "Part Number Name", "pt_desc1", DevExpress.Utils.HorzAlignment.Default)
            'add_column(gv_master, "Code Syslog", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
            'add_column(gv_master, "Qty", "sod_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
            'add_column(gv_master, "Price", "sod_price", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Private Sub fill_data()
        ...
        ElseIf fobject.name = FWorkOrderbyMO.Name Then
            _obj.text = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("prj_code")
            _obj.tag = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("prj_oid")
