...
Public Class FPartNumberPagination
    ...
    Public _ptcat_id As Integer
    Public _en_id As String
    Public _pt_id As Integer

    Private Sub FPartNumberPagination_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub load_cb_en()
        ...
        'If pt_cat_id.EditValue Is Nothing Then
        '    Exit Sub
        'End If
        ...
        'dt_bantu = New DataTable
        'dt_bantu = (func_data.load_data("ptcat_mstr", pt_en_id.EditValue))
        'With pt_cat_id
        '    .Properties.DataSource = dt_bantu
        '    .Properties.DisplayMember = dt_bantu.Columns("ptcat_desc").ToString
        '    .Properties.ValueMember = dt_bantu.Columns("ptcat_id").ToString
        '    .ItemIndex = 0
        'End With

        'dt_bantu = New DataTable
        'dt_bantu = (func_data.load_data("ptscat_cat", pt_cat_id.EditValue))
        'With pt_scat_id
        '    .Properties.DataSource = dt_bantu
        '    .Properties.DisplayMember = dt_bantu.Columns("ptscat_desc").ToString
        '    .Properties.ValueMember = dt_bantu.Columns("ptscat_id").ToString
        '    .ItemIndex = 0
        'End With
    ...
    'Private Sub pt_cat_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pt_cat.EditValueChanged
    '    dt_bantu = New DataTable
    '    dt_bantu = func_data.ptscat_mstr(pt_cat.EditValue, "A")
    '    pt_cat.Properties.DataSource = dt_bantu
    '    pt_cat.Properties.DisplayMember = dt_bantu.Columns("pt_code").ToString
    '    pt_cat.Properties.ValueMember = dt_bantu.Columns("pt_id").ToString
    '    ass_pt_id.ItemIndex = 0
    'End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "SKU Name", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Partnumber Name", "pt_desc1", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_master, "Category", "ptcat_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Sub Category", "ptscat_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Size", "size_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Color", "pt_color_tag", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "SKU Code", "ptsp_isbn", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  distinct " _
                    ...
                    & " left outer join ptcat_mstr on pt_cat_id = ptcat_id " _
                    & " left outer join ptscat_cat on pt_scat_id = ptscat_id " _
                    ...
                    & " where  pt_en_id in (0," + _en_id_coll + ") or pt_en_id in (select user_en_id from tconfuserentity " _
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(pt_cat_id.Tag) & ",  " _
                                            & SetInteger(pt_scat_id.Tag) & ",  " _
                                            & SetInteger(pt_size_code_id.EditValue) & ",  " _
                                            & SetSetring(pt_color_tag.Text) & ",  " _
    ...
    Public Overrides Function edit_data() As Boolean
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                pt_cat_id.Tag = .Item("pt_cat_id")
                pt_cat_id.EditValue = .Item("ptcat_desc")
                pt_scat_id.Tag = .Item("pt_scat_id")
                pt_scat_id.EditValue = .Item("ptscat_desc")
                pt_size_code_id.EditValue = .Item("pt_size_code_id")
                pt_color_tag.EditValue = .Item("pt_color_tag")
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  pt_cat_id = " & SetInteger(pt_cat_id.Tag) & ",  " _
                                            & "  pt_scat_id = " & SetInteger(pt_scat_id.Tag) & ",  " _
                                            & "  pt_color_tag = " & SetSetring(pt_color_tag.Text) & ",  " _
    ...
    'Private Sub be_emp_kota_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles emp_kota_code.ButtonClick
    '    Try
    '        Dim frm As New frmBrowseKota
    '        With frm
    '            .set_win(Me)
    '            .status_filter = Me.Name
    '            ._obj = emp_kota_code
    '            .filter_tambahan = " and lower(hris.mstr_kota.kota_active) = 'y' "
    '            ._prop_code = emp_propinsi_code.Tag
    '            .ShowDialog()
    '        End With
