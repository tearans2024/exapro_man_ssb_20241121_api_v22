...
Public Class FLocation
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "ID", "loc_id", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_master, "Is Transaction", "loc_default", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Is GIT", "loc_git", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Is Booked", "loc_booked", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  is_desc, " _
                    & "  loc_active, " _
                    & "  loc_dt,loc_ptnr_id,ptnr_name, " _
                    & "  coalesce(loc_git,'N') as loc_git, " _
                    & "  coalesce(loc_default,'N') as loc_default, " _
                    & "  coalesce(loc_booked,'N') as loc_booked " _
                    & "FROM  " _
                    & "  public.loc_mstr" _
    ...
    Public Overrides Sub insert_data_awal()
        ...
        loc_booked.EditValue = False
        loc_default.EditValue = False
    End Sub
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & "  loc_cat, " _
                                            & "  loc_is_id, " _
                                            & "  loc_active,loc_git,loc_default,loc_booked,loc_ptnr_id, " _
                                            & "  loc_dt " _
                                            & ")  " _
                                            & "VALUES ( " _
                                            ...
                                            & SetBitYN(loc_default.EditValue) & ",  " _
                                            & SetBitYN(loc_booked.EditValue) & ",  " _
    ...
    Public Overrides Function edit_data() As Boolean
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                loc_default.EditValue = SetBitYNB(.Item("loc_default"))
                loc_booked.EditValue = SetBitYNB(.Item("loc_booked"))
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  loc_git = " & SetBitYN(loc_git.EditValue) & ",  " _
                                             & "  loc_default = " & SetBitYN(loc_default.EditValue) & ",  " _
                                              & "  loc_booked = " & SetBitYN(loc_booked.EditValue) & ",  " _
