...
Public Class FPartnerAll
    ...
    Public Overrides Sub load_cb()
        ...
        ptnr_start_periode.Properties.DisplayMember = dt_bantu.Columns("periode_code").ToString
        ptnr_start_periode.Properties.ValueMember = dt_bantu.Columns("periode_code").ToString
