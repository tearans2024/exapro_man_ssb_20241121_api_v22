...
Public Class FPartnerAll
    ...
    Public Overrides Sub load_cb_en()
        ...
        dt_bantu = New DataTable
        dt_bantu = (func_data.load_sq_area_mstr(sc_le_ptnr_en_id.EditValue))
        ptnr_area_id.Properties.DataSource = dt_bantu
        ptnr_area_id.Properties.DisplayMember = dt_bantu.Columns("area_name").ToString
        ptnr_area_id.Properties.ValueMember = dt_bantu.Columns("area_id").ToString
        ptnr_area_id.ItemIndex = 0
    End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Sales Area", "area_name", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail_address, "Address", "ptnra_line_1", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_address, "Province", "ptnra_line_2", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_address, "County town", "ptnra_line_3", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_address, "Subdistrict", "ptnra_line_4", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_address, "Ward/Village", "ptnra_line_5", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_address, "Postal code", "ptnra_zip", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_edit(gv_edit_address, "Address", "ptnra_line_1", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_address, "Province", "ptnra_line_2", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_address, "County town", "ptnra_line_3", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_address, "Subdistrict", "ptnra_line_4", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_address, "Ward/Village", "ptnra_line_5", DevExpress.Utils.HorzAlignment.Default)
        add_column_edit(gv_edit_address, "Postal code", "ptnra_zip", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function export_data() As Boolean
        ...
        Try
            ssql = "SELECT  " _
                ...
                & "  LEFT OUTER JOIN public.area_mstr ON (public.ptne_mstr.ptnr_area_id = public.area_mstr.area_id) " _
                & " where 1+1=2 "
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                ...
                & "  left outer join public.code_mstr bp ON bp.code_id = a.ptnr_bp_type " _
                & "  left outer join public.pslvl_mstr ON lvl_id = ptnr_lvl_id " _
                & "  left outer join public.area_mstr ON area_id = a.ptnr_area_id " _
                & " where 1+1=2 "
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(ptnr_area_id.EditValue) & ",  " _
                        ...
                        For i = 0 To ds_edit_address.Tables(0).Rows.Count - 1
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                                ...
                                                & SetSetringDB(ds_edit_address.Tables(0).Rows(i).Item("ptnra_line_4")) & ",  " _
                                                & SetSetringDB(ds_edit_address.Tables(0).Rows(i).Item("ptnra_line_5")) & ",  " _
    ...
    Public Overrides Function edit_data() As Boolean
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                ptnr_area_id.EditValue = .Item("ptnr_area_id")
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                                ...
                                                & "  ptnr_area_id = " & ptnr_area_id.EditValue & ",  " _
...
.Command.Open()
    ...
    Private Sub gv_edit_address_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles gv_edit_address.DoubleClick
        ...
        i = 0
        j = 0
        Dim _prop_codec As String = ""
        Dim _kec_codec As String = ""
        Dim _kel_codec As String = ""
        For i = 0 To ds_edit_address.Tables(0).Rows.Count - 1
            _prop_codec = ds_edit_address.Tables(0).Rows(i).Item("ptnra_line_2").ToString
            _kec_codec = ds_edit_address.Tables(0).Rows(i).Item("ptnra_line_3").ToString
            _kel_codec = ds_edit_address.Tables(0).Rows(i).Item("ptnra_line_4").ToString
            ...
            If _col = "ptnra_line_2" Then
                Dim frm As New FRegProvSearch
                frm.set_win(Me)
                frm._row = _row
                'frm._en_id = sc_le_ptnr_en_id.EditValue
                frm.type_form = True
            ...
            If _col = "ptnra_line_3" Then
                Dim frm As New FRegCitySearch
                frm.set_win(Me)
                frm._row = _row
                frm._prop_code = _prop_codec
                frm.type_form = True
                frm.ShowDialog()
            End If

            If _col = "ptnra_line_4" Then
                Dim frm As New FRegKecSearch
                frm.set_win(Me)
                frm._row = _row
                frm._kec_code = _kec_codec
                frm.type_form = True
                frm.ShowDialog()
            End If

            If _col = "ptnra_line_5" Then
                Dim frm As New FRegKelSearch
                frm.set_win(Me)
                frm._row = _row
                frm._kel_code = _kel_codec
                frm.type_form = True
                frm.ShowDialog()
            End If
        Next
    ...
    Public Overrides Function before_save() As Boolean
        ...
        If SetString(ptnr_area_id.Text) = "" Then
            MessageBox.Show("Sales Area can't blank", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        End If
