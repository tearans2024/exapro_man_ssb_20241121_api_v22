Public Class FCreditTerms

    Private Sub FCreditTerms_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        _code_field = "creditterms_mstr"
    End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Interval", "code_usr_1", DevExpress.Utils.HorzAlignment.Default)
