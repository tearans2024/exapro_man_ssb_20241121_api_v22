...
Partial Class FCogsCalculation
    ...
    Public WithEvents lcg_data As DevExpress.XtraLayout.LayoutControlGroup
    ...
    Public WithEvents LayoutControlGroup13 As DevExpress.XtraLayout.LayoutControlGroup
