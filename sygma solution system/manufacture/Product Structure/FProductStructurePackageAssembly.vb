...
Public Class FProductStructurePackageAssembly
    ...
    Private Sub FProductStructurePackageAssembly_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Public Overrides Sub load_data_grid_detail()
        ...
        sql = "SELECT  " _
           ...
           & "  INNER JOIN en_mstr ON en_id = psd_en_id " _
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                                    ...
                                                    & SetSetring(_ps_oid.ToString) & ",  " _
                                                    & SetSetring(master_new.ClsVar.sNama) & ",  " _
                                                    & SetInteger(ds_edit.Tables(0).Rows(i).Item("psd_en_id")) & ",  " _
                                                    & "current_timestamp" & ",  " _
                                                    & SetSetring("N") & ",  " _
