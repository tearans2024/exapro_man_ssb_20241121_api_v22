...
Public Class FProductStructure
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Cost", "ps_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_detail, "psd_pt_um", False)
        ...
        add_column_copy(gv_detail, "Yield (%)", "psd_insheet_pct", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "p")
        ...
        add_column_copy(gv_detail, "Cost", "psd_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail, "Real Cost", "psd_real_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        ...
        add_column(gv_edit, "psd_pt_um", False)
        add_column(gv_edit, "Unit Measure", "um_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit, "Indirect", "psd_indirect", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit, "Description", "psd_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column_edit(gv_edit, "Qty", "psd_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_edit(gv_edit, "Yield (%)", "psd_insheet_pct", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "p")
        add_column(gv_edit, "UM Conversion", "psd_um_conv", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "Qty Real", "psd_qty_real", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "Cost", "psd_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "Real Cost", "psd_real_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
    ...
    Public Overrides Sub load_data_grid_detail()
        ...
        sql = "SELECT  " _
           ...
           & "  code_mstr.code_name as um_desc, " _
           & "  psd_um_conv, " _
           & "  psd_qty_real, " _
           & "  psd_cost, " _
           & "  psd_real_cost " _
           ...
           & "  LEFT OUTER JOIN invct_table on psd_pt_bom_id=invct_pt_id " _
           & " WHERE ps_en_id in (select user_en_id from tconfuserentity " _
    ...
    Private Sub gv_edit_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles gv_edit.CellValueChanged
        ...
        'Dim _psd_cost, _psd_qty, _psd_insheet_pct, _psd_qty_real, _psd_real_cost, _psd_um_conv, _reqd_qty_cost, _reqd_cost, _reqd_disc, _reqd_qty_processed As Double

        If e.Column.Name = "pt_code" Then
            Dim _insheet_pct, _qty, _qty_real, _um_conv, _cost, _real_cost As Double

            _qty = SetNumber(gv_edit.GetRowCellValue(_row, "psd_qty"))
            _insheet_pct = SetNumber(gv_edit.GetRowCellValue(e.RowHandle, "psd_insheet_pct"))
            _cost = SetNumber(gv_edit.GetRowCellValue(_row, "psd_cost"))
            _um_conv = SetNumber(gv_edit.GetRowCellValue(_row, "psd_um_conv"))
            _qty_real = _qty * _um_conv
            gv_edit.SetRowCellValue(_row, "psd_qty_real", _qty_real)
            _real_cost = _qty_real * _insheet_pct * _cost
            gv_edit.SetRowCellValue(_row, "psd_real_cost", _real_cost)

        End If

        'If e.Column.Name = "um_desc" Then
        '    Dim _insheet_pct, _qty, _qty_real, _um_conv, _cost, _real_cost As Double

        '    _qty = SetNumber(gv_edit.GetRowCellValue(_row, "psd_qty"))
        '    _insheet_pct = SetNumber(gv_edit.GetRowCellValue(e.RowHandle, "psd_insheet_pct"))
        '    _cost = SetNumber(gv_edit.GetRowCellValue(_row, "psd_cost"))
        '    _um_conv = SetNumber(e.Value)
        '    _qty_real = _qty * _um_conv
        '    gv_edit.SetRowCellValue(_row, "psd_qty_real", _qty_real)
        '    _real_cost = _qty_real * _insheet_pct * _cost
        '    gv_edit.SetRowCellValue(_row, "psd_real_cost", _real_cost)
        ...
        If e.Column.Name = "psd_insheet_pct" Then
            Dim _insheet_pct, _qty, _qty_real, _um_conv, _cost, _real_cost As Double

            _qty = SetNumber(gv_edit.GetRowCellValue(_row, "psd_qty"))
            _insheet_pct = SetNumber(e.Value)
            _cost = SetNumber(gv_edit.GetRowCellValue(_row, "psd_cost"))
            _um_conv = SetNumber(gv_edit.GetRowCellValue(_row, "psd_um_conv"))
            _qty_real = _qty * _um_conv
            gv_edit.SetRowCellValue(_row, "psd_qty_real", _qty_real)
        ...
        If e.Column.Name = "psd_cost" Then
            Dim _insheet_pct, _qty, _qty_real, _um_conv, _cost, _real_cost As Double
    ...
    Private Sub browse_data()
        ...
        ElseIf _col = "op_name" Or _col = "psd_op" Then
            ...
            '    frm._pt_cost = gv_edit.GetRowCellValue(_row, "invct_cost")
            '    frm._psd_um_conv = gv_edit.GetRowCellValue(_row, "psd_um_conv")
            '    frm.type_form = True
            '    frm.ShowDialog()
        ElseIf _col = "um_desc" Then
            Dim frm As New FUMConvSearch
            frm.set_win(Me)
            frm._row = _row
            frm._en_id = _psd_en_id
            frm._pt_id = gv_edit.GetRowCellValue(_row, "psd_pt_bom_id")
            frm._pt_cost = gv_edit.GetRowCellValue(_row, "invct_cost")
            frm._pt_um = gv_edit.GetRowCellValue(_row, "psd_pt_um")
            frm._psd_um_conv = gv_edit.GetRowCellValue(_row, "psd_um_conv")
            frm.type_form = True
            frm.ShowDialog()
        ElseIf _col = "psd_cost" Then
            Dim frm As New FItemCostSearch
            frm.set_win(Me)
            frm._row = _row
            'frm._col = _col
            frm._en_id = _psd_en_id
    ...
    Private Sub gv_edit_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles gv_edit.InitNewRow
        ...
        With gv_edit
            ...
            .SetRowCellValue(e.RowHandle, "psd_qty", 1.0)
            ...
            .SetRowCellValue(e.RowHandle, "psd_insheet_pct", 1.0)
            .SetRowCellValue(e.RowHandle, "psd_cost", 0.0)
            .SetRowCellValue(e.RowHandle, "psd_real_cost", 0.0)
            ...
            Using objcb As New master_new.CustomCommand
                With objcb
                    .SQL = "SELECT psd_det.psd_oid, " _
                        ...
                        & "  psd_det.psd_end_date, " _
                        & "  psd_det.psd_qty, " _
                        & "  psd_det.psd_qty_plan, " _
                        & "  psd_det.psd_qty_variance, " _
                        & "  psd_det.psd_str_type, " _
                        & "  psd_det.psd_insheet_pct, " _
                        & "  psd_det.psd_lt_off, " _
                        & "  psd_det.psd_op, " _
                        ...
                        & "  pt_um, " _
                        & "  psd_pt_um, " _
                        & "  psd_det.psd_um_conv, " _
                        & "  psd_det.psd_qty_real, " _
                        & "  psd_det.psd_cost, " _
                        & "  psd_det.psd_real_cost " _
                        & "FROM psd_det " _
                        & "  LEFT OUTER JOIN code_mstr code_mstr_group ON (psd_det.psd_group = code_mstr_group.code_id) " _
                        & "  LEFT OUTER JOIN code_mstr code_mstr_proc ON (psd_det.psd_process = code_mstr_proc.code_id) " _
                        & "  LEFT OUTER JOIN public.pt_mstr ON (public.psd_det.psd_pt_bom_id = public.pt_mstr.pt_id) " _
                        & "  INNER JOIN code_mstr ON code_mstr.code_id = pt_mstr.pt_um " _
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                                    ...
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("psd_cost")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("psd_real_cost")) & ",  " _
                                                    & SetInteger(ds_edit.Tables(0).Rows(i).Item("psd_pt_um")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("psd_um_conv")) & ",  " _
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("psd_qty_real")) & ",  " _
                                                    & "current_timestamp" _
                                                    & ")"
                            ssqls.Add(.Command.CommandText)
                            .Command.ExecuteNonQuery()
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                ps_cost.EditValue = .Item("ps_cost")
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                                ...
                                                & "  ps_cost = " & SetDec(ps_cost.EditValue) & "  " _
                                                & "  " _
                                                & "WHERE  " _
...
.Command.Open()
    ...
    Private Sub btupdcost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btupdcost.Click
        Dim _ps_cost As Double = 1
        Dim i, x, sama, _ps_rev As Integer
        Dim ssqls As New ArrayList
            ...
            Using objcek As New master_new.CustomCommand
                With objcek
                    ...
                    .Command.CommandText = "SELECT  " _
                        ...
                        & "  sum(public.psd_det.psd_real_cost) AS ps_cost " _
                        & "FROM " _
                        & "  public.psd_det " _
                        & "  INNER JOIN public.ps_mstr ON (public.psd_det.psd_ps_oid = public.ps_mstr.ps_oid) " _
                        & "  INNER JOIN public.pt_mstr ON (public.ps_mstr.ps_pt_bom_id = public.pt_mstr.pt_id) " _
                        & "WHERE " _
                        & "  ps_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("ps_oid") + "'" _
                        & "GROUP BY " _
                        & "  public.ps_mstr.ps_id"

                    .InitializeCommand()
                    .DataReader = .ExecuteReader
                    While .DataReader.Read
                        _ps_cost = .DataReader("ps_cost")
                    End While
                End With
            End Using
            ps_cost.EditValue = _ps_cost
