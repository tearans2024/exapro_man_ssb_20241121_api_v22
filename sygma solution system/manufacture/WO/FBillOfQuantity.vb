...
Public Class FBillOfQuantity
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_browse(gv_stand_edit, "Pt Code", "pt_code", DevExpress.Utils.HorzAlignment.Default)
                ...
                With dt_edit.Rows(i)
                    ...
                    If .Item("pt_pm_code").ToString.ToUpper <> "P" Then
                        ...
                        ssql = "select psd_pt_bom_id as boqs_pt_id, pt_code, pt_desc1, pt_desc2,code_name as code_code," _
                            & " pt_um,psd_indirect,cast('N' as CHAR) as boqs_is_manual, sum(psd_qty) as boqs_qty_plan, " _
