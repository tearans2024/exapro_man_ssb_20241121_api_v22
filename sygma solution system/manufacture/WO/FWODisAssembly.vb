...
Public Class FWODisAssembly
    ...
    Private Sub FWODisAssembly_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail, "Component Desc", "pt_desc1", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column(gv_edit, "Component Desc", "pt_desc1", DevExpress.Utils.HorzAlignment.Default)
    ...
    Private Sub generate_detail()
        ...
        'If wo_be_asmb_ps.Text = "" Or wo_asmb_qty.Text = 0 Then
        '    wo_be_asmb_ps.EditValue = ""
        'End If
    ...
    Public Overrides Sub insert_data_awal()
        ...
        wo_be_asmb_ps.Properties.ReadOnly = True
    ...
    Public Overrides Function insert() As Boolean
        ...
        'di koment untuk sementara untuk simulasi 17/07/2024 by rans
...
.Command.Open()
                    ...
                    Try
                        ...
                        If func_coll.update_invc_mstr_minus(ssqls, objinsert, _en_id, _si_id, _loc_id, _pt_id, wo_be_asmb_ps.Text, _serial, _qty) = False Then
                            'sqlTran.Rollback()
                            insert = False
                            Exit Function
                        End If
                        ...
                        For i = 0 To ds_detail.Tables(0).Rows.Count - 1
                            ...
                            If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, 0, _en_id, Trim(_asmb_code), _
                                _asmb_oid.ToString, "WO DisAssembly", "", _si_id, _loc_id_det, _pt_id_det, _qty, 0, _
                        ...
                        '.Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Insert WO DisAssembly " & _asmb_code)
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        '.Command.Parameters.Clear()
    ...
    'Private Sub be_asmb_ps_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles wo_be_asmb_ps.ButtonClick
    ...
    Private Sub wo_asmb_code_EditValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles wo_asmb_code.ButtonClick
    ...
    Private Sub wo_be_asmb_ps_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles wo_be_asmb_ps.ButtonClick

        Dim frm As New FPTBOMSrch
        frm.set_win(Me)
        'frm._obj = be_wo_asmb_ps
        frm._en_id = wo_asmb_en_id.EditValue
        frm._prj_code = wo_asmb_code.Text
        'frm._ps_code = wo_be_asmb_ps.Text
        frm._pil = 1
        frm.type_form = True
        frm.ShowDialog()
        wo_sb_generate.PerformClick()
