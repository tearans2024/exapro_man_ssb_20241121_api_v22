...
Public Class FWOMobileReceipt
    ...
    Private Sub FWOMobileReceipt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Function get_sequel() As String
        ...
        get_sequel = "SELECT  " _
                ...
                & "  wo_pjc_id, " _
                & "  a.wor_close, a.wor_is_mobile, a.wor_rcv_status, pjc_code,wor_cost,wo_cost,wo_pt_id,en_code " _
                & "FROM " _
                & "  public.wor_mstr a " _
