...
Public Class FWorkOrderMO
    ...
    Private Sub FWorkOrderMO_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
...
.Command.Open()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Qty Outstanding", "qty_outstanding", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Public Overrides Sub preview()
        ...
        ssql = "SELECT  " _
                ...
                & "  a.wo_qty_ord, " _
                & "  a.wo_qty_comp, " _
                & "  (a.wo_qty_ord - a.wo_qty_comp) as qty_outstanding, " _
                & "  a.wo_qty_rjc, " _
                & "  a.wo_ord_date, " _
                & "  a.wo_rel_date, " _
                & "  a.wo_due_date, " _
                    ...
                    Try
                        ...
                        If SetString(wo_pjc_id.Tag) <> "" Then
                            ...
                            sql = "SELECT  " _
                                ...
                                & "FROM " _
                                & "  public.prj_mstr a " _
                                & "  INNER JOIN public.prjd_det b ON (a.prj_oid = b.prjd_prj_oid) " _
                                & "WHERE " _
                                & "  a.prj_oid = '" & wo_pjc_id.Tag & "'"
                            ...
                            For Each dr_so As DataRow In dt_so.Rows
                                If SetString(dr_so(0)) = SetString(wo_pt_id.Tag) Then
                                    ...
                                    '.Command.CommandType = CommandType.Text
                                    .Command.CommandText = "update prjd_det set prjd_wo_status = 'Y' " _
                                                           & " where prjd_oid = " + SetSetring(dr_so("prjd_oid")) & "  "
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                wo_pjc_id.Text = SetString(.Item("so_code"))
                wo_pjc_id.Tag = .Item("wo_so_oid")
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  wo_so_oid = " & SetSetring(wo_pjc_id.Tag) & ",  " _
...
#End Region
    ...
    Private Sub wo_pjc_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles wo_pjc_id.ButtonClick
        Dim frm As New FProjectAccountSearch 'FSalesOrderSearch
        frm.set_win(Me)
        frm._obj = wo_pjc_id
        frm._en_id = wo_en_id.EditValue
        frm.type_form = True
...
.Command.Open()
    ...
    Private Sub xtp_data_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles xtp_data.Paint
