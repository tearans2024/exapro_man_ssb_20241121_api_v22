    ...
    Private Sub BtShowDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtShowDetail.Click
        Try
            ...
            With frm
                ...
                add_column_copy(.gv_export, "Qty IN", "wodr_qty_in", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
                add_column_copy(.gv_export, "Qty Complete", "wodr_qty_complete", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
                add_column_copy(.gv_export, "Qty Reject", "wodr_qty_reject", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
                add_column_copy(.gv_export, "Qty WIP Quran", "nvalue_wip", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
                add_column_copy(.gv_export, "Qty WIP Book", "nvalue_wip_book", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
