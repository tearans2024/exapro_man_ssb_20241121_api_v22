...
Public Class FHargaPlate
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Cut", "cut", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_master, "Biaya Cetak", "v_biaya_cetak", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_edit(gv_edit, "Cut", "cut", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_edit(gv_edit, "Biaya Cetak", "v_biaya_cetak", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
