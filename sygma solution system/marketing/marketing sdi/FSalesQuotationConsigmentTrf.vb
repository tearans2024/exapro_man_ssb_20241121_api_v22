...
Public Class FSalesQuotationConsigmentTrf
    ...
    Public Overrides Sub load_cb_en()
        ...
        'setting gudang Aseli nya
        'init_le(sq_ptsfr_loc_id, "loc_mstr", sq_en_id.EditValue)
        'Dim ssql As String
        'ssql = "select loc_id from loc_mstr where loc_en_id=" & SetInteger(sq_en_id.EditValue) & " and loc_default='Y'"
        ...
        'Next
        'If _loc_id <> 0 Then
        '    sq_ptsfr_loc_id.EditValue = _loc_id
        'End If
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  inner join loc_mstr loc_mstr_from on loc_mstr_from.loc_id = sq_ptsfr_loc_id " _
    ...
    '        'sq_book_start_date_class.Enabled = False
    '        'sq_book_start_date_class.ItemIndex = 0
    '        'sq_book_end_date_class.Enabled = False
    '        'sq_book_end_date_class.ItemIndex = 0
    '        sq_alocated.Enabled = True
    '        sq_alocated.Checked = False
    '    Else
    '        'sq_book_start_date_class.Enabled = True
    '        'sq_book_end_date_class.Enabled = True
    '        sq_alocated.Enabled = True
    '        sq_alocated.Checked = True
    '    End If
    'End Sub
    ...
    Private Sub sq_booking_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sq_booking.CheckedChanged
        ...
        Else
            ...
            sq_alocated.Checked = True
            sq_book_start_date.Enabled = False
            sq_book_start_date.EditValue = Nothing
            sq_book_end_date.Enabled = False
            sq_book_end_date.EditValue = Nothing
...
.Command.Open()
    ...
    Public Overrides Function insert() As Boolean
        ...
        '    _sq_trn_status = "C" 'Lansung Default Ke Draft
