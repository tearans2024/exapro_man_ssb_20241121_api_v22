...
Public Class AtOriginalFSalesQuotationConsigmentAlocated
    ...
    Private Sub AtOriginalFSalesQuotationConsigmentAlocated_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
