...
Public Class FSalesQuotationConsigmentAlocated
    ...
    Public _sq_ds_ptnr_id As Integer
    ...
    Private Sub FSalesQuotationConsigmentAlocated_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Package Name", "ps_desc", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_master, "Dropship", "sq_dropshipper", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Shipto", "dbg_name", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  left outer join dbg_group on dbg_id = sq_dbg_ptnr_id " _
                    & "  left outer join ps_mstr on ps_id = sq_ps_id " _
    ...
    Public Overrides Sub insert_data_awal()
        ...
        'sq_dbg_ptnr_id.Tag = ""
        'sq_dbg_ptnr_id.Text = ""
        'sq_dbg_ptnr_id.Enabled = True

        sq_ds_ptnr_ids.Tag = ""
        sq_ds_ptnr_ids.Text = ""
        sq_ds_ptnr_ids.Enabled = False
        sq_ship_to.EditValue = ""
        sq_ship_to.Enabled = False
        ...
        ce_sq_dropshipper.EditValue = False

        ce_ds_group.Enabled = False
        ce_ds_group.EditValue = False
        ...
        ce_sq_is_package.EditValue = False
        sq_ps_id.Tag = ""
        sq_ps_id.EditValue = ""
        sq_ps_id.Enabled = False
    ...
    Private Sub sq_dropshipper_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ce_sq_dropshipper.CheckedChanged

        If ce_sq_dropshipper.EditValue = True Then
            sq_ds_ptnr_ids.Enabled = True
            sq_ship_to.Enabled = True
            ce_ds_group.Enabled = True
            ce_ds_group.EditValue = True
    ...
    Private Sub sq_is_package_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ce_sq_is_package.CheckedChanged

        If ce_sq_is_package.EditValue = True Then
            sq_ps_id.Enabled = True
            'sq_ship_to.Enabled = True
        Else
            sq_ps_id.Enabled = False
            'sq_ship_to.Enabled = False
    ...
    Public Overrides Function before_save() As Boolean
        ...
        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
            ...
            Else
                ...
                'If sq_booking.EditValue = False Then
...
.Command.Open()
                    ...
                    Try
                        ...
                        If sq_booking.Checked = True Then
                            If ce_ds_group.Checked = True Then
                                '.Command.CommandType = CommandType.Text
                                .Command.CommandText = "INSERT INTO  " _
                                                    ...
                                                    & SetBitYN(ce_sq_is_package.EditValue) & ",  " _
                                                    & SetInteger(sq_ps_id.Tag) & ",  " _
                                                    & SetDec(sq_price.EditValue) & ",  " _
                                                    & SetSetring(_sq_terbilang) & ",  " _
                                                    & SetInteger(sq_ds_ptnr_ids.Tag) & ",  " _
                                                    & SetBitYN(ce_sq_dropshipper.EditValue) & ",  " _
                                                    & SetBitYN(ce_ds_group.EditValue) & ",  " _
                                ...
                                '.Command.Parameters.Clear()
                            Else
                                'jika pemilihan tidak berdasar group db yang diu insert sq_ds_ptnr_id
                                '.Command.CommandType = CommandType.Text
                                .Command.CommandText = "INSERT INTO  " _
                                                    & "  public.sq_mstr " _
                                                    & "( " _
                        ...
                        'If SetString(ds_edit.Tables(0).Rows(i).Item("sq_ps_id").ToString) <> "" Then
                        '    '.Command.CommandType = CommandType.Text
                        '    .Command.CommandText = "update ps_mstr set ps_active = 'N' " _
                        '                         & " where ps_id  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("sq_ps_id"))
                        '    ssqls.Add(.Command.CommandText)
                        '    .Command.ExecuteNonQuery()
                        '    '.Command.Parameters.Clear()
                        'End If
    ...
    Private Function insert_return(ByVal par_obj As Object, ByVal par_sq_oid As String, ByVal par_sq_code As String) As Boolean
        ...
        With ds.Tables(0).Rows(row)
            ...
            ce_sq_is_package.EditValue = SetBitYNB(.Item("sq_is_package"))

            sq_ps_id.Tag = SetString(.Item("sq_pt_id"))
            sq_ps_id.EditValue = .Item("pt_code")
            pt_desc1.EditValue = .Item("pt_desc1")
            'pt_desc2.EditValue = .Item("pt_desc2")
            sq_price.EditValue = .Item("sq_price")

            ce_sq_dropshipper.EditValue = SetBitYNB(.Item("sq_dropshipper"))
            ce_ds_group.EditValue = SetBitYNB(.Item("sq_dg_group"))
            sq_ds_ptnr_ids.EditValue = .Item("sq_dbg_ptnr_id")
        End With
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                sq_ps_id.Tag = SetInteger(.Item("sq_ps_id"))
                sq_ps_id.Text = SetString(.Item("ps_desc"))

                sq_ds_ptnr_ids.Tag = SetInteger(.Item("sq_pt_id"))
                sq_ds_ptnr_ids.Text = SetString(.Item("dbg_name"))
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  sq_is_package = " & SetBitYN(ce_sq_is_package.EditValue) & ",  " _
                                            & "  sq_pt_id = " & SetInteger(sq_ps_id.Tag) & ",  " _
...
.Command.Open()
    ...
    Private Sub sq_ds_ptnr_ids_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles sq_ds_ptnr_ids.ButtonClick
        If ce_ds_group.EditValue = True Then
            Dim frm As New FPartnerDBGroupSearch
            frm.set_win(Me)
            frm._en_id = sq_en_id.EditValue
    ...
    'Private Sub sq_dbg_ptnr_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
    '    Dim frm As New FPartnerDBGroupSearch
    '    frm.set_win(Me)
    '    frm._en_id = sq_en_id.EditValue
    '    frm._par_ptnr_id = sq_ptnr_id_sold.Tag
    ...
    Private Sub sq_pt_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles sq_ps_id.ButtonClick
        Try
            If ce_sq_is_package.EditValue = False Then
                Box("Please check is package")
                Exit Sub
            End If

            Dim frm As New FPSAssemblySearch
            frm.set_win(Me)
            'frm._pt_id = so_pt_id.Tag
            frm._en_id = sq_en_id.EditValue
            frm._obj = sq_ps_id
            frm._sq_pi_id = sq_pi_id.EditValue
            frm._sq_pidd_area_id = sq_pidd_area_id.EditValue
            frm._si_id = sq_si_id.EditValue
            'frm._si_id = sq_si_id.EditValue
            'frm._sq_type = sq_type.EditValue
            'frm._pi_id = sq_pi_id.EditValue
    ...
    Private Sub sq_is_package_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ce_sq_is_package.EditValueChanged
        Try
            If ce_sq_is_package.EditValue = True Then
                'di blok sementara untuk program satset
                'gc_edit.EmbeddedNavigator.Buttons.Remove.Enabled = False
                'gc_edit.EmbeddedNavigator.Buttons.Append.Enabled = False
                'gv_edit.BestFitColumns()
            Else
