...
Public Class FSalesQuotationConsigment
    ...
    Public Overrides Sub load_cb_en()
        ...
        dt_bantu = New DataTable
        dt_bantu = (func_data.load_loc_mstr_booked(sq_en_id.EditValue))
    ...
    '    dt_bantu = New DataTable
    '    If func_coll.get_conf_file("so_price_list_limit_ptnrg_id") = "1" Then
    '        dt_bantu = (func_data.load_pi_sq_mstr(sq_en_id.EditValue, sq_type.EditValue, sq_cu_id.EditValue, sq_date.DateTime, ptnrg_id.EditValue))
    '    Else
    '        dt_bantu = (func_data.load_pi_sq_mstr(sq_en_id.EditValue, sq_type.EditValue, sq_cu_id.EditValue, sq_date.DateTime))
    '    End If
    ...
    '    'sq_bk_id.Properties.DataSource = dt_bantu
    '    'sq_bk_id.Properties.DisplayMember = dt_bantu.Columns("bk_code").ToString
    '    'sq_bk_id.Properties.ValueMember = dt_bantu.Columns("bk_id").ToString
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Re Booking", "sq_rebooking", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "Qty Outstanding", "sqd_qty - sqd_qty_so", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Private Sub sq_booking_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sq_booking.CheckedChanged
        ...
        Else
            ...
            sq_book_start_date.EditValue = "null"
            sq_book_end_date.Enabled = False
            sq_book_end_date.EditValue = "null"
            sq_ptsfr_loc_id.Enabled = True
...
#Region "GridView"
    Private Sub gv_edit_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles gv_edit.CellValueChanged
        Dim _sqd_qty, _sqd_qty_real, _sqd_um_conv, _sqd_qty_cost, _sqd_cost, _sqd_disc, _sqd_qty_shipment, _sqd_qty_booking, _sqd_qty_transfer, _sqd_payment, _sqd_dp As Double
...
#End Region
    ...
    Public Overrides Sub cancel_approve(ByVal par_colom As String, ByVal par_table As String, ByVal par_criteria As String, ByVal par_oid As String, ByVal par_code As String, _
        ...
        'If _trans_id <> "D" Then
        '    MessageBox.Show("its canceled data..", "Conf", MessageBoxButtons.OK)
        '    Exit Sub
        'End If
...
.Command.Open()
                    ...
                    Try
                        ...
                        If sq_booking.Checked = True Then
                            ...
                            If insert_transfer(objinsert, _sq_oid.ToString, _sq_code) = False Then
                                'sqlTran.Rollback()
                                insert = False
                                Exit Function
                            End If
    ...
    Private Function edit_return(ByVal par_obj As Object, ByVal par_sq_oid As String, ByVal par_sq_code As String) As Boolean
        edit_return = True
        ...
        _ptsfr_code = func_coll.get_transaction_number("TR", sq_en_id.GetColumnValue("en_code"), "ptsfr_mstr", "ptsfr_code")
        ...
        With par_obj
            ...
            .Command.CommandText = "INSERT INTO  " _
                                ...
                                & SetDate(sq_date.DateTime) & ",  " _
                                & SetInteger(sq_si_id.EditValue) & ",  " _
                                & SetSetring(ds_edit.Tables(0).Rows(i).Item("sqd_loc_id")) & ",  " _
                                & SetInteger(sq_ptsfr_loc_git.EditValue) & ",  " _
                                & SetInteger(sq_ptsfr_loc_id.EditValue) & ",  " _
                                & SetSetring(sq_trans_rmks.Text) & ",  " _
            ...
            For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                If ds_edit.Tables(0).Rows(i).Item("sqd_qty") > 0 Then
                    ...
                    '.Command.CommandType = CommandType.Text
                    .Command.CommandText = "update sqd_det set sqd_loc_id = " & SetInteger(sq_ptsfr_loc_id.EditValue) & " " + _
                                      " where sqd_oid = '" + ds_edit.Tables(0).Rows(i).Item("sqd_oid").ToString + "'"
                    ssqls.Add(.Command.CommandText)
                    .Command.ExecuteNonQuery()
                    '.Command.Parameters.Clear()
            ...
            For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                If ds_edit.Tables(0).Rows(i).Item("sqd_qty") > 0 Then
                    If ds_edit.Tables(0).Rows(i).Item("pt_ls").ToString.ToUpper = "N" Then
                        ...
                        _loc_id = SetInteger(sq_ptsfr_loc_to_id.EditValue)
            ...
            For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                If ds_edit.Tables(0).Rows(i).Item("sqd_qty") > 0 Then
                    If ds_edit.Tables(0).Rows(i).Item("pt_ls").ToString.ToUpper = "N" Then
                        ...
                        _si_id = sq_si_id.EditValue
                        If sq_booking.Checked = True Then
                            _loc_id = sq_ptsfr_loc_id.EditValue
                        Else
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        'If sq_booking.Checked = True Then
        '    'cancel_line()
        '    MessageBox.Show("Edit this Data", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '    Return False
        'End If

        If sq_booking.Checked = True Then
            If MessageBox.Show("Edit This Data..", "Question", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Cancel Then
                Exit Function
            End If
        End If
        ...
        For i = 0 To ds.Tables("detail").Rows.Count - 1
            If Not IsDBNull(ds.Tables("detail").Rows(i).Item("sqd_qty_so")) = True Then
                If ds.Tables("detail").Rows(i).Item("sqd_qty_so") > 0 Then
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  sq_booking = " & SetBitYN(sq_cons.EditValue) & ",  " _
...
.Command.Open()
    ...
    '        Dim frm As New FSearchPartNumber
    '        frm.set_win(Me)
    '        'frm._pt_id = so_pt_id.Tag
    '        frm._en_id = sq_en_id.EditValue
    '        frm._si_id = sq_si_id.EditValue
    ...
    Private Sub ptnrg_id_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ptnrg_id.EditValueChanged
