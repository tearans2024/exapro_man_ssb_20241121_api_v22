...
Public Class FSalesQuotation
    ...
    Private Sub FSalesQuotation_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        _sq_ptnr_id_sold_mstr = -1 'set diawal agar tau kalau -1 artinya datanya belum ada...
...
#End Region
    ...
    Public Overrides Function insert() As Boolean
        ...
        _sq_terbilang = func_bill.nominal(_sq_total + _sq_total_ppn - _sq_total_pph)
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                _sq_ptnr_id_sold_mstr = .Item("sq_ptnr_id_sold")
                sq_ptnr_id_sold.Text = .Item("ptnr_name_sold")
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        .SQL = "SELECT  " _
                            ...
                            & "  ac_mstr_disc.ac_name as ac_name_disc, " _
                            & "  tax_class.code_name as sqd_tax_class_name, " _
                            & "  loc_desc, sqd_pod_oid,coalesce((select count(*) as jml from soshipd_det where soshipd_sqd_oid=sqd_oid),0) as status_shipment " _
                            & "FROM  " _
                            & "  public.sqd_det " _
                            & "  inner join sq_mstr on sq_oid = sqd_sq_oid " _
                            & "  inner join en_mstr on en_id = sqd_en_id " _
