...
Public Class FSalesQuotationConsigment
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Alocated", "sq_alocated", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Start Date", "sq_book_start_date", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        add_column_copy(gv_master, "End Date", "sq_book_end_date", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        add_column_copy(gv_master, "Booking Status", "sq_book_status", DevExpress.Utils.HorzAlignment.Center)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  inner join code_mstr quo_type on pay_type.code_id = sq_quo_type " _
    ...
    Private Sub sq_booking_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'If sq_booking.EditValue = False Then
        '    sq_book_start_date.Enabled = False
        '    'sq_book_start_date.ItemIndex = 0
        '    'sq_book_start_date.Enabled = False
        '    'so_tax_inc.Checked = False
        '    sq_book_end_date.Enabled = False
        '    'sq_book_end_date.ItemIndex = 0
        'Else
...
#Region "GridView"
    ...
    Private Sub browse_data()
        ...
        ElseIf _col = "pt_code" Then
            ...
            'frm._sq_booking = sq_booking.EditValue
            ''frm._tran_oid = _sq_ref_po_oid
            'If sq_booking.EditValue = True Then
            '    frm._sq_booking = True
            'Else
            '    frm._sq_booking = False
            'End If
