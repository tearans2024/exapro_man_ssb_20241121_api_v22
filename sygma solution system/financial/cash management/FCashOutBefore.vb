...
Public Class FCashOutBefore
    ...
    Public _casho_cc_ids, _casho_reques_ptnr_ids, _casho_enduser_ptnr_ids As String
    ...
    Private Sub FCashOutBefore_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub insert_data_awal()
        ...
        _casho_enduser_ptnr_ids = ""
        casho_enduser_ptnr_id.Text = ""
    ...
    Public Overrides Function insert() As Boolean
        ...
        Try
            ...
            If casho_type.EditValue = "REAL" Then
                ...
                'ssql = "update req_mstr " _
                '& " update req_mstr set req_trans_id = 'C', req_cashoreal_oid = " & SetSetring(_mstr_oid) & " " + _
                '& " where req_mstr =" & SetSetring(_casho_req_oids)
            End If
            ...
            '       & "  where investd_oid=" & SetSetring(casho_req_oid.Tag)
            ...
            If _casho_req_oids <> "" Then
                ...
                ' ssql = "update reqd_mstr " _
                '& " update sq_mstr set sq_trans_id = 'W'" _
                '& " where sq_oid=" & SetSetring(casho_req_oid.Tag)

                ' ssqls.Add(ssql)

                'If SetString(ds_edit.Tables(0).Rows(i).Item("reqd_req_oid").ToString) <> "" Then
                '    ssql = "update reqd_det set reqd_casho_oid = " & SetSetring(_mstr_oid.ToString) & ", " _
                '                         & " where reqd_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("reqd_oid"))
                '    ssqls.Add(ssql)
            End If
            ...
            'For Each Str As String In MyPGDll.ClassSync.FinsertSQL2Array(ssqls)
            '    _data += Str & vbNewLine
            'Next
    ...
    Private Sub casho_req_oid_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles casho_req_oid.EditValueChanged
