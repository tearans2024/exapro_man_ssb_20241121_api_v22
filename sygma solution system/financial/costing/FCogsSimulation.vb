...
Public Class FCogsSimulation
    ...
    'Public ds_edit_item, ds_edit_raw, ds_edit_route, ds_edit_acc As DataSet
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        i = 0
                        'For Each dr As DataRow In ds_edit_item.Tables(0).Rows
                        '    .Command.CommandType = CommandType.Text
                        ...
                        '        & SetSetring(_oid_mstr) & ",  " _
                        '        & SetInteger(i) & ",  " _
                        '        & SetInteger(dr("cogsci_pt_id")) & ",  " _
                        '        & SetDec(dr("cogsci_qty")) & "  " _
                        '        & ")"
        ...
        Try
            ...
            For Each dr As DataRow In dt_raw.Rows
                ...
                If dt_cost.Rows.Count > 0 Then
                    dr("cost") = dt_cost.Rows(0).Item("sct_total")
                End If
