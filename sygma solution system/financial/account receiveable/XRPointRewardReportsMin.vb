...
Public Class XRPointRewardReportsMin
    ...
    Private Sub XRPointRewardReportsMin_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
