...
Public Class FDPackingSheetPrintOut
    ...
    Private Sub FDPackingSheetPrintOut_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
...
.Command.Open()
    ...
    Public Overrides Sub preview()
        ...
        If ce_pcs_doc.Checked = True Then
