...
Public Class XRPackingNewSheet
    ...
    Public _pcs_en_id As Integer

    Private Sub XRPackingNewSheet_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
    End Sub
            ...
            Using objcb As New master_new.CustomCommand
                With objcb
                    .SQL = "SELECT  " _
                            ...
                            & " and paper_en_id = " & _pcs_en_id.ToString _
