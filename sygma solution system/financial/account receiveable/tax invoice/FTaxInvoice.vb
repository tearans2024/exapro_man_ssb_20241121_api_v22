...
Public Class FTaxInvoice
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Date Create", "ti_add_date", DevExpress.Utils.HorzAlignment.Center)
        add_column_copy(gv_master, "User Update", "ti_upd_by", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Date Update", "ti_upd_date", DevExpress.Utils.HorzAlignment.Center)
        ...
        add_column(gv_edit_pt, "Price", "tip_price", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        add_column(gv_edit_pt, "Discount", "tip_disc", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        add_column(gv_edit_pt, "Tax Rate", "tip_tax_rate", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "p")
        add_column(gv_edit_pt, "Tax", "tip_ppn", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        add_column(gv_edit_pt, "Total", "tip_total", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
    ...
    Private Sub retrieve_from_ar()
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT " _
                        ...
                        & "  ((ars_invoice_price - ars_so_disc_value) * (taxr_rate) / 100) as after_tax, " _
                        & "  ((ars_invoice_price - ars_so_disc_value) * (taxr_rate) / 100) * ars_invoice as total, " _
                        & "  ars_tax_class_id " _
                        & "FROM  " _
                        & "  public.ar_mstr " _
                        & "  inner join ars_ship on ars_ar_oid = ar_oid " _
        ...
        For i = 0 To ds_bantu.Tables(0).Rows.Count - 1
            ...
            _dtrow("tip_price") = ds_bantu.Tables(0).Rows(i).Item("ars_invoice_price")
            ...
            Else
                ...
                _dtrow("tip_ppn") = (ds_bantu.Tables(0).Rows(i).Item("ars_invoice_price") - ds_bantu.Tables(0).Rows(i).Item("ars_so_disc_value")) * _tax_free_rate
                _after_tax = (ds_bantu.Tables(0).Rows(i).Item("ars_invoice_price") - ds_bantu.Tables(0).Rows(i).Item("ars_so_disc_value")) * _tax_free_rate
            End If

            _total = (ds_bantu.Tables(0).Rows(i).Item("ars_invoice_price") - ds_bantu.Tables(0).Rows(i).Item("ars_so_disc_value") + _after_tax) * ds_bantu.Tables(0).Rows(i).Item("ars_invoice")
    ...
    Private Function set_sql_detail_single() As String
        set_sql_detail_single = "SELECT  " _
            ...
            & "  inner join tip_pt on tip_ti_oid = ti_mstr.ti_oid " _
            & "  inner join pt_mstr on pt_id = tip_pt_id" _
            & "  inner join tia_ar on tia_ti_oid = ti_mstr.ti_oid " _
            & "  inner join ar_mstr on ar_oid = tia_ar_oid " _
