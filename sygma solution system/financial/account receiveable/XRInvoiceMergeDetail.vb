...
Public Class XRInvoiceMergeDetail
    ...
    Private Sub XRInvoiceMergeDetail_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
        'XrLabel2.Text = "test aja"
        ' XrLabel2.Text = MaskDec(_ar_sum)
    End Sub

    Private Sub XRInvoiceMergeDetail_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
