...
Public Class FARMerge
    ...
    Public Overrides Sub load_cb_en()
        ...
        dt_bantu = (func_data.load_creditterms_mstr(arp_en_id.EditValue))
    ...
    Public Overrides Sub insert_data_awal()
        ...
        arp_due_date.EditValue = CekTanggal()

        arp_ship_receipt.Enabled = False
        'arp_ship_receipt.EditValue = CekTanggal()
        arp_duedate_pay.Enabled = False
    ...
    Public Overrides Function insert() As Boolean
        ...
        Try
            ...
            ssql = "INSERT INTO  " _
                ...
                & SetDate(arp_due_date.DateTime) & ",  " _
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                arp_ship_receipt.EditValue = CekTanggal()
                arp_ship_receipt.Enabled = True

                arp_duedate_pay.EditValue = _paythen
                arp_duedate_pay.Enabled = True
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                        ...
                                        & "  arp_ship_receipt = " & SetDate(arp_ship_receipt.DateTime) & ",  " _
                                        & "  arp_duedate_pay = " & SetDate(arp_duedate_pay.DateTime) & ",  " _
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                ...
                                & SetDate(arp_duedate_pay.DateTime) & "  " _
                                & ")"
                            ...
                            .Command.CommandText = "UPDATE  " _
                                        & "  public.ar_mstr   " _
                                        & "SET  " _
                                        & "  ar_eff_date = " & SetDate(arp_ship_receipt.DateTime) & ",  " _
                                        & "  ar_expt_date = " & SetDate(arp_due_date.DateTime) & ",  " _
                                        & "  ar_due_date = " & SetDate(arp_duedate_pay.DateTime) & "  " _
                                        & "WHERE  " _
                            ...
                            .Command.CommandText = "UPDATE  " _
                                        & "  public.glt_det   " _
                                        & "SET  " _
                                        & "  glt_add_date = " & SetDate(arp_ship_receipt.DateTime) & "  " _
                                        & "WHERE  " _
