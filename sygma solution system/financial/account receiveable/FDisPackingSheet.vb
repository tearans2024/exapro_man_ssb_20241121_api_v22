...
Public Class FDisPackingSheet
    ...
    Private Sub FDisPackingSheet_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Packing Number", "ar_code", DevExpress.Utils.HorzAlignment.Default)
...
.Command.Open()
    ...
    'Private Sub gv_edit_dist_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs)
    ...
    'Private Sub gv_edit_dist_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs)
    ...
    'Private Sub ar_credit_term_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    ar_due_date.DateTime = ar_eff_date.DateTime.AddDays(ar_credit_term.GetColumnValue("code_usr_1"))
    '    ar_expt_date.DateTime = ar_eff_date.DateTime.AddDays(ar_credit_term.GetColumnValue("code_usr_1"))
    'End Sub
...
.Command.Open()
    ...
    Private Sub gc_edit_so_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles gc_edit_so.Click
