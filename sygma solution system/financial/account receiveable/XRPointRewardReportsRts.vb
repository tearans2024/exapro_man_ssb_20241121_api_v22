...
Public Class XRPointRewardReportsRts
    ...
    Private Sub XRPointRewardReportsRts_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
