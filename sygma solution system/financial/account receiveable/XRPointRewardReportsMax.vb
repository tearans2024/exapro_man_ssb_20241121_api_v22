...
Public Class XRPointRewardReportsMax
    ...
    Dim _ar_mutif As Double = 0
    Dim _ar_code As String
    Dim _ar_bruto As Double = 0
    Dim _ar_disc As Double = 0


    Private Sub XRPointRewardReportsMax_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
        'XrLabel2.Text = "test aja"
        ' XrLabel2.Text = MaskDec(_ar_sum)
    End Sub

    Private Sub XRPointRewardReports_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
