...
Public Class FBarcodePrint
    Dim dt_bantu As DataTable
    Dim func_data As New function_data
    Dim func_coll As New function_collection
    Dim sSQL As String

    Private Sub FBarcodePrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Private Sub pt_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles pt_code.ButtonClick
        Try
            Dim frm As New FPartNumberSearchbyPI()
            frm.set_win(Me)
    ...
    Private Sub BtExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtExport.Click
        ...
        Try
            ...
            With objSaveFileDialog
                .DefaultExt = "xml"
                .FileName = ("Export_TI_" & Now().ToString("yyyyMMdd-HHmmss") & "_" & pt_code.Text & "_" & pt_code.Tag).ToString.Replace(":", "_")
