...
Public Class FDPackingSheetPrint
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail_shipment, "Collie Number", "ars_invoice", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_edit_shipment, "Collie Number", "ars_invoice", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            ssql = "INSERT INTO  " _
                                ...
                                & SetSetring(Guid.NewGuid.ToString) & ",  " _
                                & SetSetring(_mstr_oid) & ",  " _
                                & SetSetring(ds_edit.Tables(0).Rows(i).Item("dopd_so_oid")) & ",  " _
