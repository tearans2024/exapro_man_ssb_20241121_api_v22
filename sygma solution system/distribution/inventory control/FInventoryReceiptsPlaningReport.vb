...
Public Class FInventoryReceiptsPlaningReport
    Public func_coll As New function_collection
    Dim _now As DateTime

    Private Sub FInventoryReceiptsPlaningReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail_receipt, "Article Name", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail_receipt, "Plan Incoming", "riupland_qty", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_receipt, "Plan Incoming date", "riupland_date", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail_receipt, "Last Receipt Date", "riud_qty", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_receipt, "Qty Outstanding", "riud_qty", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_receipt, "Qty Shipment", "riud_qty", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_receipt, "Qty On Hand", "riud_qty", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_receipt, "Qty Booking", "riud_qty", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_receipt, "Qty Real", "riud_qty", DevExpress.Utils.HorzAlignment.Default)
        ...
        If arg <> False Then
            ...
            Try
                ...
                Using objload As New master_new.CustomCommand
                    ...
                    & "  public.pt_mstr.pt_desc2,public.pt_mstr.pt_desc1, public.pt_mstr.pt_code, " _
