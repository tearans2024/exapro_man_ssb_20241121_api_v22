...
Public Class FInventoryReceiptsByWOCI
    Dim dt_bantu As DataTable
    Dim func_data As New function_data
    Dim func_coll As New function_collection
    Public ds_edit, ds_serial As DataSet
    Public _riu_ref_woci_oid, _riu_ref_rium_oid, _riud_invc_oid As String
    Dim _now As DateTime
    Dim _ref_so_inventory_request_par, _ref_invrec_mobile_par As String

    Private Sub FInventoryReceiptsByWOCI_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub load_cb_en()
        If riu_en_id.EditValue Is Nothing Then
            Exit Sub
        End If

        'dt_bantu = New DataTable
        'dt_bantu = (func_data.load_data("riu_type_mstr", riu_en_id.EditValue))
        'With riu_type_code_id
        ...
        dt_bantu = New DataTable
        dt_bantu = (func_data.load_woci_reason_code(riu_en_id.EditValue))
        riu_reason_id.Properties.DataSource = dt_bantu
        riu_reason_id.Properties.DisplayMember = dt_bantu.Columns("code_name").ToString
        riu_reason_id.Properties.ValueMember = dt_bantu.Columns("code_id").ToString
        riu_reason_id.ItemIndex = 0
    End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Delivery Note", "riu_pack_vend", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Receive Type", "code_name", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "Qty Receipt", "riud_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_detail, "Remarks", "riud_remarks", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_edit(gv_edit, "Qty Receipts", "riud_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_edit(gv_edit, "Remarks", "riud_remarks", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Sub insert_data_awal()
        ...
        riu_ref_woci_code.Enabled = True
        riu_ref_woci_code.Text = ""
        _riu_ref_woci_oid = ""
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetSetring("R") & ",  " _
                                            & SetSetring(riu_ref_woci_code.Text) & ",  " _
                                            & SetSetring(_riu_ref_woci_oid.ToString) & ",  " _
                                            & SetSetring(riu_remarks.Text) & ",  " _
                                            & SetInteger(riu_reason_id.EditValue) & ",  " _
                                            & SetSetring(riu_req_by.Text) & ",  " _
                                            & SetSetring(riu_end_user.Text) & ",  " _
                                            & "" & SetDateNTime(master_new.PGSqlConn.CekTanggal) & "" & "  " _
                                            & ")"
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            If ds_edit.Tables(0).Rows(i).Item("riud_qty") > 0 Then
                                ...
                                .Command.CommandText = "INSERT INTO  " _
                                                    ...
                                                    & SetSetringDB(ds_edit.Tables(0).Rows(i).Item("riud_remarks")) & ",  " _
                            ...
                            If ds_edit.Tables(0).Rows(i).Item("riud_qty_real") > 0 Then
                                If ds_edit.Tables(0).Rows(i).Item("pt_ls").ToString.ToUpper = "N" Then
                                    ...
                                    If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, i_2, _en_id, Trim(_riu_type2), _
                                        _riu_oid.ToString, "WOCI Inventory Return", "", _si_id, _loc_id, _pt_id, _qty, _cost, _
                        ...
                        For i = 0 To ds_serial.Tables(0).Rows.Count - 1
                            If ds_serial.Tables(0).Rows(i).Item("riuds_qty") > 0 Then
                                ...
                                _cost_avg = func_coll.get_cost_average("+", _en_id, _si_id, _pt_id, _qty, _cost)
                                If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, i_2, _en_id, Trim(_riu_type2), _riu_oid.ToString, "WOCI Inventory Return", "", _si_id, _loc_id, _pt_id, _qty, _cost, _cost_avg, "", riu_date.DateTime) = False Then
                                    'sqlTran.Rollback()
                                    insert = False
                                    Exit Function
                                End If
                        ...
                        '.Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("WOCI Inventory Return" & _riu_type2)
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        '.Command.Parameters.Clear()
                ...
                Try
                    If par_ds.Tables(0).Rows(i).Item("riud_qty") > 0 Then
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetSetring("WOCI Inventory Return") & ",  " _
                                            & SetDblDB(_cost) & ",  " _
                                            & SetDblDB(0) & ",  " _
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetSetringDB("WOCI Inventory Return") & ",  " _
                                            & SetDblDB(0) & ",  " _
                                            & SetDblDB(_cost) & ",  " _
                                            & SetSetring(par_oid) & ",  " _
                                            & SetSetring(par_trans_code) & ",  " _
...
#End Region
    ...
    Private Sub riu_ref_woci_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles riu_ref_woci_code.ButtonClick
        Dim frm As New FWOCISearchbyMO() 'FSalesOrderSearch()
        frm.set_win(Me)
        frm._obj = riu_ref_woci_code
        frm._en_id = riu_en_id.EditValue
        frm.type_form = True
        frm.ShowDialog()
    End Sub

    'Private Sub riu_ref_rium_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
