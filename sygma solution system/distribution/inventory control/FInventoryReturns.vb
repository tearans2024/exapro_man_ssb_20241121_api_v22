...
Public Class FInventoryReturns
    Dim dt_bantu As DataTable
    Dim func_data As New function_data
    Dim func_coll As New function_collection
    Public ds_edit, ds_serial As DataSet
    Public _riu_ref_ar_oid, _riud_invc_oid As String
    Public _par_ptnr_id As String
    Dim _now As DateTime
    Dim _ref_ar_inventory_request_par As String

    Private Sub FInventoryReturns_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        _now = func_coll.get_now
        pr_txttglawal.DateTime = _now
        pr_txttglakhir.DateTime = _now

        '_ref_ar_inventory_request_par = func_coll.get_conf_file("ref_ar_inventory_request")
        'If _ref_ar_inventory_request_par = "0" Then
        '    ref_ar_inventory_request.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
        '    gv_master.Columns("riu_ref_so_code").Visible = False
        'Else
        '    ref_ar_inventory_request.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "AR Number", "riu_ref_ar_code", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "Qty Shipment", "riud_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail, "Qty Return", "riud_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_edit(gv_edit, "Qty Invoiced", "riud_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_edit(gv_edit, "Qty Returns", "riud_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Public Overrides Sub insert_data_awal()
        ...
        riu_ref_ar_code.Enabled = True
        riu_ref_ar_code.Text = ""
        _riu_ref_ar_oid = ""

        riu_ptnr_id.Enabled = True
        riu_ptnr_id.Text = ""
    ...
    Private Sub browse_data()
        ...
        If _col = "pt_code" Then
            ...
            frm._trans_oid = _riu_ref_ar_oid
            frm.type_form = True
            frm.ShowDialog()
...
#Region "DML"
    Public Overrides Function insert() As Boolean
        ...
        _riu_type2 = func_coll.get_transaction_number("RT", riu_en_id.GetColumnValue("en_code"), "riu_mstr", "riu_type2")
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(_par_ptnr_id) & ",  " _
                                            & SetSetring(_riu_type2) & ",  " _
                                            & SetDate(riu_date.DateTime) & ",  " _
                                            & SetSetring("R") & ",  " _
                                            & SetSetring(riu_ref_ar_code.Text) & ",  " _
                                            & SetSetring(_riu_ref_ar_oid.ToString) & ",  " _
    ...
    End Function
#End Region
    Private Sub riu_ptnr_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles riu_ptnr_id.ButtonClick
        Dim frm As New FPartnerSearch
        frm.set_win(Me)
        frm._obj = riu_ptnr_id
        frm._en_id = riu_en_id.EditValue
        'frm._par_ptnr_id = riu_ptnr_id
        frm.type_form = True
        frm.ShowDialog()
    End Sub

    Private Sub riu_ref_ar_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles riu_ref_ar_code.ButtonClick
        Dim frm As New FDRCRMemoSearch()
        frm.set_win(Me)
        frm._obj = riu_ref_ar_code
        frm._en_id = riu_en_id.EditValue
        frm._ptnr_id = _par_ptnr_id
        frm.type_form = True
        frm.ShowDialog()
    End Sub
