...
Public Class FInventoryReceiptByWOCIFirst
    ...
    Private Sub FInventoryReceiptByWOCIFirst_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Public Overrides Sub load_cb()
        ...
        'dt_bantu = New DataTable
        'dt_bantu = (func_data.load_wor_reason_code())
        ...
        'dt_bantu = New DataTable
        'dt_bantu = (func_data.load_wor_reason_code(riu_en_id.EditValue))
        'riu_reason_id.Properties.DataSource = dt_bantu
        'riu_reason_id.Properties.DisplayMember = dt_bantu.Columns("code_name").ToString
        'riu_reason_id.Properties.ValueMember = dt_bantu.Columns("code_id").ToString
        'riu_reason_id.ItemIndex = 0
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "WO Receipt Number", "riu_ref_wor_code", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_master, "Reason Code", "code_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Requesr By", "riu_req_by", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "End User", "riu_end_user", DevExpress.Utils.HorzAlignment.Default)
        ...
        'add_column_copy(gv_detail, "Reason Code", "code_name", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column(gv_detail, "code_id", False)
        add_column_copy(gv_detail, "Reason Code", "code_name", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  riu_type, " _
                    & "  riu_ref_wor_code, " _
                    & "  riu_ref_wor_oid,coalesce(riu_cost_total,0) as riu_cost_total, " _
                    & "  riu_remarks, " _
                    & "  riu_reason_id, " _
                    & "  code_name, " _
                    & "  riu_req_by, " _
                    ...
                    & " inner join code_mstr on code_id = riu_reason_id" _
                    ...
                    & " and riu_ref_wor_oid IS NOT NULL "
        Return get_sequel
    End Function
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            If ds_edit.Tables(0).Rows(i).Item("riud_qty") > 0 Then
                                ...
                                'If ds_edit.Tables(0).Rows(i).Item("riud_wor_oid").ToString <> "" Then
                                '    'update karena ada hubungan dengan pb_mstr (inventory request)
                                '    '.Command.CommandType = CommandType.Text
                                '    .Command.CommandText = "update wor_mstr set wor_qty_issued = coalesce(wor_qty_issued,0) +" + SetDbl(ds_edit.Tables(0).Rows(i).Item("riud_qty")) + ", " _
                                '                         & " pbd_qty_completed = coalesce(pbd_qty_completed,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("riud_qty")) _
                                '                         & " where wor_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("riud_wor_oid"))
                                '    ssqls.Add(.Command.CommandText)
                                '    .Command.ExecuteNonQuery()
                                '    '.Command.Parameters.Clear()
                                'End If
                                ...
                                If ds_edit.Tables(0).Rows(i).Item("riud_wor_oid").ToString <> "" Then
                                    ...
                                    '.Command.CommandType = CommandType.Text
                                    .Command.CommandText = "update wor_mstr set wor_qty_issued = coalesce(wor_qty_issued,0) +" + SetDbl(ds_edit.Tables(0).Rows(i).Item("riud_qty")) + ", " _
                                                        & " wor_qty_comp = coalesce(wor_qty_comp,0) - " + SetDbl(ds_edit.Tables(0).Rows(i).Item("riud_qty")) + " " _
                                                        & " where wor_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("riud_wor_oid"))
                                    ssqls.Add(.Command.CommandText)
                                    .Command.ExecuteNonQuery()
                                    '.Command.Parameters.Clear()
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            If ds_edit.Tables(0).Rows(i).Item("riud_qty") > 0 Then
                                If ds_edit.Tables(0).Rows(i).Item("pt_ls").ToString.ToUpper = "N" Then
                                    ...
                                    If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, i_2, _en_id, Trim(_riu_type2), _riu_oid.ToString, "WO Recieve Inventory Issue", "", _si_id, _loc_id, _pt_id, _qty, _cost, _cost_avg, "", riu_date.DateTime) = False Then
                                        'sqlTran.Rollback()
                                        insert = False
                                        Exit Function
                                    End If
                        ...
                        For i = 0 To ds_serial.Tables(0).Rows.Count - 1
                            If ds_serial.Tables(0).Rows(i).Item("riuds_qty") > 0 Then
                                ...
                                _qty = _qty * -1.0
                                _cost_avg = func_coll.get_cost_average("-", _en_id, _si_id, _pt_id, _qty, _cost)
                                If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, i_2, _en_id, Trim(_riu_type2), _riu_oid.ToString, "WOR Inventory Issue", "", _si_id, _loc_id, _pt_id, _qty, _cost, _cost_avg, "", riu_date.DateTime) = False Then
                                    'sqlTran.Rollback()
                                    insert = False
                                    Exit Function
                                End If
                        ...
                        '.Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Insert WOR Inv Issue " & _riu_type2)
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        '.Command.Parameters.Clear()
                ...
                Try
                    If par_ds.Tables(0).Rows(i).Item("riud_qty") > 0 Then
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetSetring("WOR Inventory Issue") & ",  " _
                                            & SetDblDB(0) & ",  " _
                                            & SetDblDB(_cost) & ",  " _
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetSetringDB("WOR Inventory Issue") & ",  " _
                                            & SetDblDB(_cost) & ",  " _
                                            & SetDblDB(0) & ",  " _
                                            & SetSetring(par_oid) & ",  " _
                                            & SetSetring(par_trans_code) & ",  " _
...
#End Region
    ...
    'Private Sub riu_ref_wor_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
    '    Dim frm As New FWOSearchbyMO
    '    frm.set_win(Me)
