...
#Region "SQL"
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  false as pilih," _
                    ...
                    & "  public.pb_mstr.pb_dt,pb_pbt_code,pbt_desc " _
                    & "FROM " _
                    & "  public.pb_mstr " _
...
.Command.Open()
    ...
    Private Sub BEIRCopy_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles BEIRCopy.ButtonClick
        Try
