...
Public Class FInventoryReceiptsPlanning
    Dim dt_bantu As DataTable
    Dim func_data As New function_data
    Dim func_coll As New function_collection
    Public ds_edit, ds_serial As DataSet
    Public _riu_ref_so_oid, _riu_ref_rium_oid, _riud_invc_oid As String
    Dim _now As DateTime
    Dim _ref_so_inventory_request_par, _ref_invrec_mobile_par As String

    Private Sub FInventoryReceiptsPlanning_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        ...
        '_ref_invrec_mobile_par = func_coll.get_conf_file("ref_invrec_mobile")
        'If _ref_invrec_mobile_par = "0" Then
        '    ref_rium_ireq_code.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
        '    gv_master.Columns("riu_ref_rium_code").Visible = False
        'Else
        '    ref_rium_ireq_code.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
        '    gv_master.Columns("riu_ref_rium_code").Visible = True
        'End If
    End Sub
    ...
    Public Overrides Sub load_cb()
        ...
        riuplan_en_id.Properties.DataSource = dt_bantu
        riuplan_en_id.Properties.DisplayMember = dt_bantu.Columns("en_desc").ToString
        riuplan_en_id.Properties.ValueMember = dt_bantu.Columns("en_id").ToString
        riuplan_en_id.ItemIndex = 0
    End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Article Name", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Vendor", "riuplan_ptnr_id", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Work Order", "riuplan_ref_spk_code", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "WO Date", "riuplan_spk_date", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "WO Due Date", "riuplan_spk_duedate", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column(gv_detail, "riupland_riuplan_oid", False)
        add_column_copy(gv_detail, "Part Number", "pt_code", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Article Name", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Patnumber Code", "pt_code", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Patnumber Name", "pt_desc1", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "Qty Planning", "riupland_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_master, "Plan Receive Date", "riupland_date", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        add_column_copy(gv_detail, "Qty Receive", "riupland_qty_real", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail, "Qty Outstanding", "riupland_qty_outstanding", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_detail_serial, "riupland_riuplan_oid", False)
        ...
        add_column(gv_edit, "riupland_oid", False)
        add_column(gv_edit, "riud_invc_oid", False)
        add_column(gv_edit, "pt_id", False)
        add_column(gv_edit, "riupland_si_id", False)
        ...
        add_column(gv_edit, "Article Name", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit, "Patnumber Code", "pt_code", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit, "Patnumber Name", "pt_desc1", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_edit(gv_edit, "Qty Production", "riupland_qty_prod", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_edit(gv_edit, "Qty Planning", "riupland_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "riupland_um", False)
        add_column(gv_edit, "UM", "riupland_um_name", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit, "Plan Receive Date", "riupland_date", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")

        'add_column_edit(gv_edit, "UM Conversion", "riupland_um_conv", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        'add_column(gv_edit, "Qty Real", "riupland_qty_real", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_edit(gv_edit, "Lot Number", "riupland_lot_serial", DevExpress.Utils.HorzAlignment.Default)
        add_column_edit(gv_edit, "Cost", "riupland_cost", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column(gv_edit, "riupland_cc_id", False)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  riuplan_type, " _
                    & "  riuplan_pack_vend, " _
                    & "  riuplan_ref_so_code, " _
                    & "  riuplan_ref_so_oid, " _
                    & "  riuplan_remarks, " _
                    & "  riuplan_dt " _
                    & "FROM  " _
                    & "  public.riuplan_mstr " _
                    & " inner join en_mstr on en_id = riuplan_en_id" _
                    & " where riuplan_date >= " + SetDate(pr_txttglawal.DateTime.Date) _
                    & " and riuplan_date <= " + SetDate(pr_txttglakhir.DateTime.Date) _
                    & " and riuplan_type ~~* 'R'" _
                    & " and riuplan_type2 NOT LIKE 'RT%'" _
                    & " and riuplan_en_id in (select user_en_id from tconfuserentity " _
    ...
    Public Overrides Sub insert_data_awal()
        ...
        riu_ref_rium_code.Enabled = True
        riu_ref_rium_code.Text = ""
        _riu_ref_rium_oid = ""
    ...
    Public Overrides Function before_save() As Boolean
        ...
        Dim _date As Date = riuplan_date.DateTime
        Dim _gcald_det_status As String = func_data.get_gcald_det_status(riuplan_en_id.EditValue, "gcald_ic", _date)
        ...
        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
            ...
            ssql = "SELECT loc_id " _
                      ...
                      & "  a.loc_en_id=" & riuplan_en_id.EditValue
    ...
    Private Sub browse_data()
        ...
        If _col = "pt_code" Then
            ...
            frm.set_win(Me)
            frm._row = _row
            frm._en_id = riuplan_en_id.EditValue
        ...
        ElseIf _col = "ac_code" Then
            ...
            _filter = " and ac_id in (SELECT  " _
              ...
              & "FROM  " _
              & "  public.enacc_mstr  " _
              & "Where enacc_en_id=" & SetInteger(riuplan_en_id.EditValue) & " and enacc_code='inv_receipt_account') "

            If limit_account(riuplan_en_id.EditValue) = True Then
                frm._obj = _filter
            Else
                frm._obj = ""
            End If
...
#Region "DML"
    Public Overrides Function insert() As Boolean
        ...
        _riu_type2 = func_coll.get_transaction_number("RU", riuplan_en_id.GetColumnValue("en_code"), "riu_mstr", "riu_type2")
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(riuplan_en_id.EditValue) & ",  " _
                                            & SetSetring(master_new.ClsVar.sNama) & ",  " _
                                            & "" & SetDateNTime(master_new.PGSqlConn.CekTanggal) & "" & ",  " _
                                            & SetSetring(_riu_type2) & ",  " _
                                            & SetDate(riuplan_date.DateTime) & ",  " _
                                            & SetSetring("R") & ",  " _
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            If ds_edit.Tables(0).Rows(i).Item("riud_qty_real") > 0 Then
                                If ds_edit.Tables(0).Rows(i).Item("pt_ls").ToString.ToUpper = "N" Then
                                    ...
                                    _en_id = riuplan_en_id.EditValue
                                    ...
                                    If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, i_2, _en_id, Trim(_riu_type2), _
                                        ...
                                        _cost_avg, "", riuplan_date.DateTime) = False Then
                                        'sqlTran.Rollback()
                                        insert = False
                                        Exit Function
                                    End If
                        ...
                        For i = 0 To ds_serial.Tables(0).Rows.Count - 1
                            If ds_serial.Tables(0).Rows(i).Item("riuds_qty") > 0 Then
                                ...
                                _cost_avg = func_coll.get_cost_average("+", _en_id, _si_id, _pt_id, _qty, _cost)
                                If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, i_2, _en_id, Trim(_riu_type2), _riu_oid.ToString, "Inventory Receipt", "", _si_id, _loc_id, _pt_id, _qty, _cost, _cost_avg, "", riuplan_date.DateTime) = False Then
                                    'sqlTran.Rollback()
                                    insert = False
                                    Exit Function
                                End If
                        ...
                        If _create_jurnal = True Then
                            If insert_glt_det_inv_rct(ssqls, objinsert, ds_edit, _
                                                 riuplan_en_id.EditValue, riuplan_en_id.GetColumnValue("en_code"), _
                                                 _riu_oid.ToString, _riu_type2, _
                                                 riuplan_date.DateTime, _
...
#End Region
    ...
    Private Sub riu_ref_rium_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles riu_ref_rium_code.ButtonClick
        Dim frm As New FInventoryRequestMobSearch()
        frm.set_win(Me)
        frm._obj = riu_ref_rium_code
        frm._en_id = riuplan_en_id.EditValue
        frm.type_form = True
        frm.ShowDialog()
    End Sub
