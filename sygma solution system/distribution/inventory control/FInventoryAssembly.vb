...
Public Class FInventoryAssembly
            ...
            Using objcb As New master_new.CustomCommand
                With objcb
                    .SQL = "SELECT  " _
                        ...
                        & "  psd_det.psd_group, " _
                        & "  psd_det.psd_process,coalesce((SELECT   x.invct_cost FROM  public.invct_table x WHERE  x.invct_pt_id=psd_det.psd_pt_bom_id  limit 1) * (psd_det.psd_qty),0) as cost, " _
    ...
    Private Sub asmb_loc_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles wo_asmb_loc_desc.ButtonClick
        Dim frm As New FLocationSearch
        frm.set_win(Me)
        frm._en_id = asmb_en_id.EditValue
        frm._pil = 1
    ...
    Private Sub asmb_loc_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles wo_asmb_loc_desc.EditValueChanged
