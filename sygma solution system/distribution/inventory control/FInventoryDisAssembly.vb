...
Public Class FInventoryDisAssembly
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Qty DisAssembly", "asmb_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Public Overrides Function insert() As Boolean
        ...
        Dim _cost_avg, _qty, _psd_qty As Double
