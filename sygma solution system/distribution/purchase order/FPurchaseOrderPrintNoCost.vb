Public Class FPurchaseOrderPrintNoCost
    ...
    Public Overrides Sub preview()
        ...
        '    & "  pod_pt_desc1, " _
        '    & "  pod_pt_desc2, " _
        '    & "  um_master.code_name, " _
        '    & "  creditterm_mstr.code_name, tranaprvd_name_1, tranaprvd_name_2, tranaprvd_name_3, tranaprvd_name_4 , " _
        '    & "  tranaprvd_pos_1, tranaprvd_pos_2, tranaprvd_pos_3, tranaprvd_pos_4 " _
        '    & "  order by po_code "
