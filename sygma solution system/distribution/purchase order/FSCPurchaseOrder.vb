...
#Region "Seting Awal"
    Private Sub FSCPurchaseOrder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        _now = func_coll.get_now
        pr_txttglawal.DateTime = _now
        pr_txttglakhir.DateTime = _now
        _conf_value = func_coll.get_conf_file("wf_sales_contract")
    ...
    Public Overrides Sub load_cb()
        ...
        sc_en_id.Properties.DataSource = dt_bantu
        sc_en_id.Properties.DisplayMember = dt_bantu.Columns("en_desc").ToString
        sc_en_id.Properties.ValueMember = dt_bantu.Columns("en_id").ToString
        sc_en_id.ItemIndex = 0

        If func_coll.get_conf_file("wf_sales_contract") = 0 Then
            dt_bantu = New DataTable
            dt_bantu = (func_data.load_tran_mstr())
            sc_tran_id.Properties.DataSource = dt_bantu
            sc_tran_id.Properties.DisplayMember = dt_bantu.Columns("tran_name").ToString
            sc_tran_id.Properties.ValueMember = dt_bantu.Columns("tran_id").ToString
            sc_tran_id.ItemIndex = 0
        Else
            dt_bantu = New DataTable
            dt_bantu = (func_data.load_transaction())
            sc_tran_id.Properties.DataSource = dt_bantu
            sc_tran_id.Properties.DisplayMember = dt_bantu.Columns("tran_name").ToString
            sc_tran_id.Properties.ValueMember = dt_bantu.Columns("tranu_tran_id").ToString
            sc_tran_id.ItemIndex = 0
        End If
        ...
        sc_cu_id.Properties.DataSource = dt_bantu
        sc_cu_id.Properties.DisplayMember = dt_bantu.Columns("cu_name").ToString
        sc_cu_id.Properties.ValueMember = dt_bantu.Columns("cu_id").ToString
        sc_cu_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_po_status_cash())
        sc_status_cash.Properties.DataSource = dt_bantu
        sc_status_cash.Properties.DisplayMember = dt_bantu.Columns("display").ToString
        sc_status_cash.Properties.ValueMember = dt_bantu.Columns("value").ToString
        sc_status_cash.ItemIndex = 0
    End Sub

    Public Overrides Sub load_cb_en()
        dt_bantu = New DataTable
        dt_bantu = (func_data.load_data("ptnr_mstr_vend", sc_en_id.EditValue))
        sc_ptnr_id.Properties.DataSource = dt_bantu
        sc_ptnr_id.Properties.DisplayMember = dt_bantu.Columns("ptnr_name").ToString
        sc_ptnr_id.Properties.ValueMember = dt_bantu.Columns("ptnr_id").ToString
        sc_ptnr_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_data("cmaddr_mstr", sc_en_id.EditValue))
        sc_cmaddr_id.Properties.DataSource = dt_bantu
        sc_cmaddr_id.Properties.DisplayMember = dt_bantu.Columns("cmaddr_name").ToString
        sc_cmaddr_id.Properties.ValueMember = dt_bantu.Columns("cmaddr_id").ToString
        sc_cmaddr_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_data("sb_mstr", sc_en_id.EditValue))
        sc_sb_id.Properties.DataSource = dt_bantu
        sc_sb_id.Properties.DisplayMember = dt_bantu.Columns("sb_desc").ToString
        sc_sb_id.Properties.ValueMember = dt_bantu.Columns("sb_id").ToString
        sc_sb_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_data("cc_mstr", sc_en_id.EditValue))
        sc_cc_id.Properties.DataSource = dt_bantu
        sc_cc_id.Properties.DisplayMember = dt_bantu.Columns("cc_desc").ToString
        sc_cc_id.Properties.ValueMember = dt_bantu.Columns("cc_id").ToString
        sc_cc_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_data("si_mstr", sc_en_id.EditValue))
        sc_si_id.Properties.DataSource = dt_bantu
        sc_si_id.Properties.DisplayMember = dt_bantu.Columns("si_desc").ToString
        sc_si_id.Properties.ValueMember = dt_bantu.Columns("si_id").ToString
        sc_si_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_data("pjc_mstr", sc_en_id.EditValue))
        sc_pjc_id.Properties.DataSource = dt_bantu
        sc_pjc_id.Properties.DisplayMember = dt_bantu.Columns("pjc_desc").ToString
        sc_pjc_id.Properties.ValueMember = dt_bantu.Columns("pjc_id").ToString
        sc_pjc_id.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_creditterms_mstr(sc_en_id.EditValue))
        sc_credit_term.Properties.DataSource = dt_bantu
        sc_credit_term.Properties.DisplayMember = dt_bantu.Columns("code_name").ToString
        sc_credit_term.Properties.ValueMember = dt_bantu.Columns("code_id").ToString
        sc_credit_term.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_taxclass_mstr(sc_en_id.EditValue))
        sc_tax_class.Properties.DataSource = dt_bantu
        sc_tax_class.Properties.DisplayMember = dt_bantu.Columns("code_name").ToString
        sc_tax_class.Properties.ValueMember = dt_bantu.Columns("code_id").ToString
        sc_tax_class.ItemIndex = 0

        dt_bantu = New DataTable
        dt_bantu = (func_data.load_bk_mstr(sc_en_id.EditValue, sc_cu_id.EditValue))
        sc_bk_id.Properties.DataSource = dt_bantu
        sc_bk_id.Properties.DisplayMember = dt_bantu.Columns("bk_name").ToString
        sc_bk_id.Properties.ValueMember = dt_bantu.Columns("bk_id").ToString
        sc_bk_id.ItemIndex = 0
    End Sub

    Private Sub po_en_id_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sc_en_id.EditValueChanged
        load_cb_en()
    End Sub

    Private Sub po_cu_id_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles sc_cu_id.EditValueChanged
        Dim _po_exc_rate As Double
        If sc_cu_id.EditValue <> master_new.ClsVar.ibase_cur_id Then
            _po_exc_rate = func_data.get_exchange_rate(sc_cu_id.EditValue, sc_date.DateTime)
            If _po_exc_rate = 1 Then
                sc_exc_rate.EditValue = 0
            Else
                sc_exc_rate.EditValue = _po_exc_rate
            End If
        Else
            sc_exc_rate.EditValue = 1
        End If
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Auto Receipt", "po_auto_receipt", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_master, "Exchange Rate", "po_exc_rate", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_master, "Total", "po_total", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_master, "PPN", "po_total_ppn", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_master, "PPH", "po_total_pph", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_master, "After Tax", "po_total_after_tax", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_master, "Ext. Total", "po_total_ext", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_master, "Ext. PPN", "po_total_ppn_ext", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_master, "Ext. PPH", "po_total_pph_ext", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_master, "Ext. After Tax", "po_total_after_tax_ext", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        ...
        add_column_copy(gv_detail, "Qty", "pod_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_detail, "Qty Receive", "pod_qty_receive", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_detail, "Qty Outstanding", "pod_qty_outstanding", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_detail, "Qty Invoice  ", "pod_qty_invoice", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        add_column_copy(gv_detail, "UM", "code_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Cost", "pod_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n4}")
        ...
        add_column(gv_edit, "Qty Open", "pod_qty_open", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_edit(gv_edit, "Qty", "pod_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")

        add_column(gv_edit, "pod_um", False)
        add_column(gv_edit, "UM", "code_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_edit(gv_edit, "Cost", "pod_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_edit, "UM Conversion", "pod_um_conv", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "Qty Real", "pod_qty_real", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "Qty * Cost", "pod_qty_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column(gv_edit, "pt_type", False)
        ...
        add_column_edit(gv_receive, "Qty", "podtr_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_edit(gv_payment, "Amount", "podtp_amount", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_detail_receive, "Qty", "podtr_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_detail_payment, "Amount", "podtp_amount", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    & "  public.en_mstr.en_desc,po_auto_receipt, " _
...
#Region "valuechanged"
    Private Sub po_taxable_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sc_taxable.CheckedChanged
        If sc_taxable.EditValue = False Then
            sc_tax_class.Enabled = False
            sc_tax_class.ItemIndex = 0
            sc_tax_inc.Enabled = False
            sc_tax_inc.Checked = False
        Else
            sc_tax_class.Enabled = True
            sc_tax_inc.Enabled = True
            sc_tax_inc.Checked = False
        End If
    End Sub
...
#Region "DML"
    Public Overrides Sub insert_data_awal()
        ...
        sc_pjc_id.ItemIndex = 0
        sc_ptnr_id.ItemIndex = 0
        sc_date.DateTime = _now
        sc_due_date.DateTime = _now
        sc_need_date.DateTime = _now
        sc_rmks.Text = ""
        sc_tran_id.ItemIndex = 0
        sc_cu_id.ItemIndex = 0
        sc_cu_id.Enabled = True
        sc_tax_class.ItemIndex = 0
        sc_exc_rate.Text = 1
        sc_tax_inc.EditValue = False
        sc_taxable.EditValue = False
        sc_tax_inc.Enabled = False
        sc_tax_class.Enabled = True
        sc_ptnr_id.Enabled = True
        sc_tax_class.Enabled = True
        sc_status_cash.Enabled = True
        'po_status_cash.EditValue = "-"
        sc_status_cash.ItemIndex = 0
        'po_bk_id.ItemIndex = 0
        'sc_auto_receipt.Checked = False
    ...
    Public Overrides Function before_save() As Boolean
        ...
        If sc_status_cash.EditValue = "C" Then
            Dim _date As Date = sc_date.DateTime
            Dim _gcald_det_status As String = func_data.get_gcald_det_status(sc_en_id.EditValue, "gcald_ic", _date)
        ...
        _taxable = SetBitYN(sc_taxable.EditValue)
        _tax_include = SetBitYN(sc_tax_inc.EditValue)
        _tax_class = sc_tax_class.EditValue
        ...
        If Trim(sc_exc_rate.EditValue) = 0 Then
        ...
        If sc_status_cash.EditValue = "-" Then
        ...
        '---------------------------------
        'Dim ssql As String = ""
        'ssql = "select count(*) as jml from po_mstr "
    ...
    Public Overrides Function insert() As Boolean
        ...
        If _conf_value = "1" Then
            _po_trans_id = "D"
            ds_bantu = func_data.load_aprv_mstr(sc_tran_id.EditValue)
        Else
            _po_trans_id = "I"
        End If
        ...
        If _conf_value = "1" And sc_status_cash.EditValue = "C" Then
            Box("Transaction cash for approval mode is not allowed")
            Exit Function
        End If

        _po_code = func_coll.get_transaction_number("PO", sc_en_id.GetColumnValue("en_code"), "po_mstr", "po_code")
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & "  po_total_ppn, " _
                                            & "  po_total_pph, " _
                                            & "  po_status_cash,po_auto_receipt, " _
                                            & "  po_bk_id, " _
                                            & "  po_dt " _
                                            & ")  " _
                                            & "VALUES ( " _
                                            ...
                                            & sc_en_id.EditValue & ",  " _
                                            & SetSetring(master_new.ClsVar.sNama) & ", " _
                                            & " " & SetDateNTime(master_new.PGSqlConn.CekTanggal) & " " & ", " _
                                            & SetSetring(_po_code) & ",  " _
                                            & sc_ptnr_id.EditValue & ",  " _
                                            & sc_cmaddr_id.EditValue & ",  " _
                                            & "" & SetDateNTime(sc_date.DateTime) & "" & ",  " _
                                            & SetDate(sc_need_date.DateTime) & ",  " _
                                            & SetDate(sc_due_date.DateTime) & ",  " _
                                            & SetSetring(sc_rmks.Text) & ",  " _
                                            & sc_sb_id.EditValue & ",  " _
                                            & sc_cc_id.EditValue & ",  " _
                                            & sc_si_id.EditValue & ",  " _
                                            & sc_pjc_id.EditValue & ",  " _
                                            & SetDbl(_po_total) & ",  " _
                                            & sc_tran_id.EditValue & ",  " _
                                            & SetSetring(_po_trans_id) & "," _
                                            & sc_credit_term.EditValue & ",  " _
                                            & SetBitYN(sc_taxable.EditValue) & ",  " _
                                            & SetBitYN(sc_tax_inc.EditValue) & ",  " _
                                            & sc_tax_class.EditValue & ",  " _
                                            & sc_cu_id.EditValue & ",  " _
                                            & SetDbl(sc_exc_rate.EditValue) & ",  " _
                                            & SetDbl(_po_total_ppn) & ",  " _
                                            & SetDbl(_po_total_pph) & ",  " _
                                            & SetSetring(sc_status_cash.EditValue) & ",  " _
                                            & SetInteger(sc_bk_id.EditValue) & ",  " _
                                            & "" & SetDateNTime(master_new.PGSqlConn.CekTanggal) & "" & "  " _
                                            & ")"
                                ...
                                If ds_edit.Tables("insert_edit").Rows(i).Item("pod_oid") = ds_edit.Tables("detail_comment").Rows(j).Item("cmt_ref_oid").ToString Then
                                    If IsDBNull(ds_edit.Tables("detail_comment").Rows(j).Item("cmt_comment")) = False Then
                                        ...
                                        .Command.CommandText = "INSERT INTO  " _
                                                            ...
                                                            & "'Purchase Order',  " _
                                                            & SetSetring(func_coll.get_transaction_number("CM", sc_en_id.GetColumnValue("en_code"), "cmt_mstr", "cmt_code")) & ",  " _
                                                            & k & ",  " _
                        ...
                        '    If update_rec(objinsert, ssqls, sc_en_id.EditValue, sc_bk_id.EditValue, sc_cu_id.EditValue, _
                        '                 sc_exc_rate.EditValue, (_po_total + _po_total_pph + _po_total_ppn) * -1.0, sc_date.DateTime, _po_code, _
                        '                 sc_ptnr_id.Text, "PO CASH") = False Then
                        '        'sqlTran.Rollback()
                        '        Return False
                        '        Exit Function
                        '    End If
                        'ElseIf sc_auto_receipt.Checked = True Then
                        '    If insert_receipt(ssqls, objinsert, _po_oid.ToString, _po_code) = False Then
                        '        'sqlTran.Rollback()
                        '        insert = False
                        '        Exit Function
                        ...
                        If _conf_budget = "1" Then
                            If func_coll.update_budget(ssqls, objinsert, ds_edit, sc_en_id.EditValue, sc_date.EditValue) = False Then
                                'sqlTran.Rollback()
                                insert = False
                                Exit Function
                            End If
                        ...
                        If _conf_value = "1" Then
                            For i = 0 To ds_bantu.Tables(0).Rows.Count - 1
                                ...
                                .Command.CommandText = "INSERT INTO  " _
                                                        ...
                                                        & SetInteger(sc_en_id.EditValue) & ",  " _
                                                        & SetSetring(sc_tran_id.EditValue) & ",  " _
                                                        & SetSetring(_po_oid.ToString) & ",  " _
                                                        & SetSetring(_po_code) & ",  " _
    ...
    Private Function insert_receipt(ByVal par_ssqls As ArrayList, ByVal par_obj As Object, ByVal par_po_oid As String, ByVal par_po_code As String) As Boolean
        ...
        _rcv_code = func_coll.get_transaction_number("RC", sc_en_id.GetColumnValue("en_code"), "rcv_mstr", "rcv_code")
        ...
        With par_obj
            ...
            .Command.CommandText = "INSERT INTO  " _
                                ...
                                & SetDate(sc_date.DateTime) & ",  " _
                                & SetDate(sc_date.DateTime) & ",  " _
                                & SetSetring(par_po_oid.ToString) & ",  " _
                                & SetSetring("") & ",  " _
                                & SetInteger(sc_cu_id.EditValue) & ",  " _
                                & SetDbl(sc_exc_rate.EditValue) & ",  " _
                                & SetSetring("Y") & ",  " _
                                & "" & SetDateNTime(master_new.PGSqlConn.CekTanggal) & "" & "  " _
                                & ");"
            ...
            For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                If ds_edit.Tables(0).Rows(i).Item("pod_qty") > 0 Then
                    ...
                    'If sc_auto_receipt.Checked = True Then
                    '    If sc_status_cash.EditValue = "C" Then
                    '        'Update pod_det
                    '        '.Command.CommandType = CommandType.Text
            ...
            '.Command.CommandType = CommandType.Text
            .Command.CommandText = "update po_mstr set po_close_date = " & SetDateNTime00(sc_date.DateTime) & "" + _
                ...
                If ds_edit.Tables(0).Rows(i).Item("pt_type").ToString.ToUpper = "I" Then
                    If ds_edit.Tables(0).Rows(i).Item("pod_qty_real") > 0 Then
                        If ds_edit.Tables(0).Rows(i).Item("pt_ls").ToString.ToUpper = "N" Then
                            ...
                            _cost = _cost * sc_exc_rate.EditValue
                            _cost_avg = func_coll.get_cost_average("+", _en_id, _si_id, _pt_id, _qty, _cost)
                            If func_coll.update_invh_mstr(par_ssqls, par_obj, _tran_id, i_2, _en_id, _rcv_code, _rcv_oid.ToString, "PO Receipt (PO Cash)", "", _si_id, _loc_id, _pt_id, _qty, _cost, _cost_avg, "", sc_date.DateTime) = False Then
                                Return False
                            End If
                        Else
        ...
        '            If glt_det_purchase_receipt_auto(par_ssqls, par_obj, ds_edit, _rcv_oid.ToString, _rcv_code, "IC-RPO") = False Then
        '                Return False
        '            End If
        '        End If
        '    End If
    ...
    Private Function glt_det_purchase_receipt_auto(ByVal par_ssqls As ArrayList, ByVal par_obj As Object, ByVal par_ds As DataSet, ByVal par_rcv_oid As String, ByVal par_rcv_code As String, ByVal par_daybook As String) As Boolean
        glt_det_purchase_receipt_auto = True
        ...
        _glt_desc = ""
        _glt_code = func_coll.get_transaction_number("IC", sc_en_id.GetColumnValue("en_code"), "glt_det", "glt_code")
        Dim _bk_ac_id As Integer = get_bk_ac_id(sc_bk_id.EditValue) ' ini unttuk account creditnya...karena po yang bersifat cash / tunai
            ...
            With par_obj
                Try
                    If par_ds.Tables(0).Rows(i).Item("pod_qty") > 0 Then
                        ...
                        If func_coll.update_unposted_glbal_balance_tran(par_ssqls, par_obj, sc_date.DateTime, _
                                                         dt_bantu.Rows(0).Item("pla_ac_id"), _
                                                         dt_bantu.Rows(0).Item("pla_sb_id"), _
                                                         dt_bantu.Rows(0).Item("pla_cc_id"), _
                                                         sc_en_id.EditValue, sc_cu_id.EditValue, _
                                                         sc_exc_rate.EditValue, _cost, "D") = False Then

                            Return False
                        End If
                        '********************** finish untuk yang debet

                        'If SetNumber(_ppn) <> 0 Then
                        '    _seq = _seq + 1
                        '    If par_ds.Tables(0).Rows(i).Item("pod_taxable").ToString.ToUpper = "Y" Then
                        '        '********* mulai untuk ppn ***********
                        '        dt_bantu = New DataTable
                        ...
                        If func_coll.update_unposted_glbal_balance_tran(par_ssqls, par_obj, sc_date.DateTime, _
                                                         ...
                                                         dt_bantu.Rows(0).Item("pla_cc_id"), _
                                                         sc_en_id.EditValue, sc_cu_id.EditValue, _
                                                         sc_exc_rate.EditValue, _cost, "C") = False Then
                        ...
                        If SetNumber(_ppn) <> 0 Then
                            ...
                            If par_ds.Tables(0).Rows(i).Item("pod_taxable").ToString.ToUpper = "Y" Then
                                ...
                                If func_coll.update_unposted_glbal_balance_tran(par_ssqls, par_obj, sc_date.DateTime, _
                                                                 ...
                                                                 dt_bantu.Rows(0).Item("taxr_cc_ap_id"), _
                                                                 sc_en_id.EditValue, sc_cu_id.EditValue, _
                                                                 sc_exc_rate.EditValue, _ppn * par_ds.Tables(0).Rows(i).Item("pod_qty"), "D") = False Then
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                sc_en_id.EditValue = .Item("po_en_id")
                sc_ptnr_id.EditValue = .Item("po_ptnr_id")
                sc_cmaddr_id.EditValue = .Item("po_cmaddr_id")
                sc_date.DateTime = .Item("po_date")
                sc_need_date.DateTime = .Item("po_need_date")
                sc_due_date.DateTime = .Item("po_due_date")
                sc_rmks.Text = SetString(.Item("po_rmks"))
                sc_sb_id.EditValue = .Item("po_sb_id")
                sc_cc_id.EditValue = .Item("po_cc_id")
                sc_si_id.EditValue = .Item("po_si_id")
                sc_pjc_id.EditValue = .Item("po_pjc_id")
                sc_tran_id.EditValue = .Item("po_tran_id")
                sc_credit_term.EditValue = .Item("po_credit_term")
                sc_taxable.EditValue = SetBitYNB(.Item("po_taxable"))
                sc_tax_inc.EditValue = SetBitYNB(.Item("po_tax_inc"))
                sc_tax_class.EditValue = .Item("po_tax_class")
                sc_cu_id.EditValue = .Item("po_cu_id")
                sc_exc_rate.EditValue = .Item("po_exc_rate")
                sc_status_cash.EditValue = .Item("po_status_cash")
                sc_bk_id.EditValue = .Item("po_bk_id")
            ...
            End With
            sc_en_id.Focus()
            sc_cu_id.Enabled = False
            sc_ptnr_id.Enabled = True
            sc_status_cash.Enabled = False
            Try
                tcg_header.SelectedTabPageIndex = 0
                tcg_detail.SelectedTabPageIndex = 0
            Catch ex As Exception
    ...
    Public Overrides Function edit()
        ...
        dt_bantu.Clear()
        dt_bantu = (func_data.load_list_aprvd_dok(sc_en_id.EditValue, 1, sc_date.DateTime))
...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  po_en_id = " & sc_en_id.EditValue & ",  " _
                                            & "  po_upd_by = " & SetSetring(master_new.ClsVar.sNama) & ",  " _
                                            & "  po_upd_date = " & SetDateNTime(master_new.PGSqlConn.CekTanggal) & ",  " _
                                            & "  po_ptnr_id = " & sc_ptnr_id.EditValue & ",  " _
                                            & "  po_cmaddr_id = " & sc_cmaddr_id.EditValue & ",  " _
                                            & "  po_date = " & SetDate(sc_date.DateTime) & ",  " _
                                            & "  po_need_date = " & SetDate(sc_need_date.DateTime) & ",  " _
                                            & "  po_due_date = " & SetDate(sc_due_date.DateTime) & ",  " _
                                            & "  po_rmks = " & SetSetring(sc_rmks.Text) & ",  " _
                                            & "  po_sb_id = " & SetInteger(sc_sb_id.EditValue) & ",  " _
                                            & "  po_cc_id = " & SetInteger(sc_cc_id.EditValue) & ",  " _
                                            & "  po_si_id = " & SetInteger(sc_si_id.EditValue) & ",  " _
                                            & "  po_pjc_id = " & SetInteger(sc_pjc_id.EditValue) & ",  " _
                                            & "  po_total = " & SetDbl(_po_total.ToString) & ",  " _
                                            & "  po_tran_id = " & sc_tran_id.EditValue & ",  " _
                                            & "  po_credit_term = " & sc_credit_term.EditValue & ",  " _
                                            & "  po_taxable = " & SetBitYN(sc_taxable.EditValue) & ",  " _
                                            & "  po_tax_inc = " & SetBitYN(sc_tax_inc.EditValue) & ",  " _
                                            & "  po_tax_class = " & sc_tax_class.EditValue & ",  " _
                                            & "  po_cu_id = " & SetInteger(sc_cu_id.EditValue) & ",  " _
                                            & "  po_exc_rate = " & SetDbl(sc_exc_rate.EditValue) & ",  " _
                                            & "  po_total_ppn = " & SetDbl(_po_total_ppn) & ",  " _
                                            & "  po_total_pph = " & SetDbl(_po_total_pph) & ",  " _
                                            & "  po_status_cash = " & SetSetring(sc_status_cash.EditValue) & ",  " _
                                            & "  po_bk_id = " & SetInteger(sc_bk_id.EditValue) & ",  " _
...
#Region "gv_edit"
    Private Sub gv_edit_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles gv_edit.CellValueChanged
        ...
        ElseIf e.Column.Name = "pod_memo" Then
            If SetString(gv_edit.GetRowCellValue(e.RowHandle, "pt_type").ToString.ToUpper) <> "I" And e.Value <> "M" Then
    ...
    Private Sub gv_edit_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles gv_edit.InitNewRow
        With gv_edit
            ...
            .SetRowCellValue(e.RowHandle, "pod_en_id", sc_en_id.EditValue)
            .SetRowCellValue(e.RowHandle, "en_desc", sc_en_id.GetColumnValue("en_desc"))
            .SetRowCellValue(e.RowHandle, "pod_si_id", sc_si_id.EditValue)
            .SetRowCellValue(e.RowHandle, "si_desc", sc_si_id.GetColumnValue("si_desc"))
            .SetRowCellValue(e.RowHandle, "pod_qty", 0)
            .SetRowCellValue(e.RowHandle, "pod_cost", 0)
            .SetRowCellValue(e.RowHandle, "pod_disc", 0)
            .SetRowCellValue(e.RowHandle, "pod_sb_id", sc_sb_id.EditValue)
            .SetRowCellValue(e.RowHandle, "sb_desc", sc_sb_id.GetColumnValue("sb_desc"))
            .SetRowCellValue(e.RowHandle, "pod_cc_id", sc_cc_id.EditValue)
            .SetRowCellValue(e.RowHandle, "cc_desc", sc_cc_id.GetColumnValue("cc_desc"))
            .SetRowCellValue(e.RowHandle, "pod_pjc_id", sc_pjc_id.EditValue)
            .SetRowCellValue(e.RowHandle, "pjc_desc", sc_pjc_id.GetColumnValue("pjc_desc"))
            .SetRowCellValue(e.RowHandle, "pod_taxable", IIf(sc_taxable.EditValue = True, "Y", "N"))
            .SetRowCellValue(e.RowHandle, "pod_tax_inc", IIf(sc_tax_inc.EditValue = True, "Y", "N"))
            .SetRowCellValue(e.RowHandle, "pod_tax_class", sc_tax_class.EditValue)
            .SetRowCellValue(e.RowHandle, "pod_tax_class_name", sc_tax_class.GetColumnValue("code_name"))
            .SetRowCellValue(e.RowHandle, "pod_need_date", sc_need_date.DateTime)
            .SetRowCellValue(e.RowHandle, "pod_due_date", sc_due_date.DateTime)
...
.Command.Open()
        ...
        Try
            ...
            If _col = "loc_desc" Then
                For i As Integer = 0 To ds_edit.Tables(0).Rows.Count - 1
                    ...
                    ds_edit.Tables(0).Rows(i).Item("pod_loc_id") = gv_edit.GetRowCellValue(_row, "pod_loc_id")
                Next
            End If
    ...
    Private Sub gc_detail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles gc_detail.Click
