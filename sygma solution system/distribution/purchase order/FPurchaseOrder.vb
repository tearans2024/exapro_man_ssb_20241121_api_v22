...
.Command.Open()
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetBitYN(po_auto_receipt.Checked) & ",  " _
                        ...
                        If po_status_cash.EditValue = "C" Then
                            ...
                            If update_rec(objinsert, ssqls, po_en_id.EditValue, po_bk_id.EditValue, po_cu_id.EditValue, _
                                         po_exc_rate.EditValue, (_po_total + _po_total_pph + _po_total_ppn) * -1.0, po_date.DateTime, _po_code, _
                                         po_ptnr_id.Text, "PO CASH") = False Then
                                'sqlTran.Rollback()
                                Return False
                                Exit Function
                            End If
                        ElseIf po_auto_receipt.Checked = True Then
                            If insert_receipt(ssqls, objinsert, _po_oid.ToString, _po_code) = False Then
                                'sqlTran.Rollback()
                                insert = False
                                Exit Function
        ...
        With par_obj
            ...
            For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                If ds_edit.Tables(0).Rows(i).Item("pod_qty") > 0 Then
                    ...
                    If po_auto_receipt.Checked = True Then
                        If po_status_cash.EditValue = "C" Then
                            'Update pod_det
                            '.Command.CommandType = CommandType.Text
...
#Region "gv_edit"
    Private Sub gv_edit_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles gv_edit.CellValueChanged
        ...
        If e.Column.Name = "pod_qty" Then
            ...
            _pod_qty_real = e.Value * _pod_um_conv
            _pod_qty_cost = (_pod_qty_real * _pod_cost) - (_pod_qty_real * _pod_cost * _pod_disc)
    ...
    Private Sub browse_data()
        ...
        ElseIf _col = "code_name" Then
            ...
            frm._pt_cost = gv_edit.GetRowCellValue(_row, "pod_cost")
            frm._pod_um_conv = gv_edit.GetRowCellValue(_row, "pod_um_conv")
            frm.type_form = True
            frm.ShowDialog()
...
#End Region
    ...
    Private Sub footer()
        ...
        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
            ...
            _dpp = _dpp + (ds_edit.Tables(0).Rows(i).Item("pod_qty_real") * _pod_cost)
            _dpp_line = (ds_edit.Tables(0).Rows(i).Item("pod_qty_real") * _pod_cost)
            _discount = _discount + (ds_edit.Tables(0).Rows(i).Item("pod_qty_real") * _pod_cost * ds_edit.Tables(0).Rows(i).Item("pod_disc"))
            _discount_line = (ds_edit.Tables(0).Rows(i).Item("pod_qty_real") * _pod_cost * ds_edit.Tables(0).Rows(i).Item("pod_disc"))
