...
#Region "Seting Awal"
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Total", "po_total", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_master, "PPN", "po_total_ppn", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_master, "PPH", "po_total_pph", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_master, "After Tax", "po_total_after_tax", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_detail, "Height", "pod_height", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail, "Width", "pod_width", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_detail, "Qty", "pod_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_copy(gv_detail, "Cost Film", "pod_cost_film", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_edit(gv_edit, "Height", "pod_height", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_edit(gv_edit, "Width", "pod_width", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")

        add_column(gv_edit, "pod_um", False)
        add_column(gv_edit, "UM", "code_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_edit(gv_edit, "Cost Film", "pod_cost_film", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        add_column_copy(gv_edit, "Cost", "pod_cost", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
        ...
        add_column_edit(gv_edit, "UM Conversion", "pod_um_conv", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n4")
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            For j = 0 To ds_comment.Tables(0).Rows.Count - 1
                                If ds_edit.Tables(0).Rows(i).Item("pod_oid") = ds_comment.Tables(0).Rows(j).Item("cmt_ref_oid") Then
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            For j = 0 To ds_edit.Tables("detail_comment").Rows.Count - 1
                                If ds_edit.Tables(0).Rows(i).Item("pod_oid") = ds_edit.Tables("detail_comment").Rows(j).Item("cmt_ref_oid") Then
...
#End Region
    ...
    Private Sub RepairPOToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RepairPOToolStripMenuItem.Click
        Try
            ...
            For Each dr As DataRow In dt.Rows
                sSql = "update pod_det set pod_cost_film=" & SetDec(dr("pod_cost")) & ",pod_cost=" & SetDec(dr("pod_cost") * dr("pod_height") * dr("pod_width")) & " where pod_oid='" & dr("pod_oid") & "'"
                sSQLs.Add(sSql)
            Next
