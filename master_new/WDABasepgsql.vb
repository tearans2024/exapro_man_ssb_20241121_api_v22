...
Public Class WDABasepgsql
    ...
    Public Sub New(ByVal Company As String, ByVal Application As String)
        ...
        'Connection = New PgSqlConnection("Server=localhost;Port=5432;User Id=postgres;Password=syspronuri;Database=sygma")
        'Connection = New PgSqlConnection("Server=192.168.1.150;Port=5432;User Id=admin;Password=bangkar;Database=sygma_091014")

        Connection = New PgSqlConnection(DbConString())
    End Sub
...
#End Region
    ...
    Public Sub InitializeDataAdapter()
        ...
        Catch OleDbExceptionErr As PgSqlException
            Throw New System.Exception(OleDbExceptionErr.Message, _
            OleDbExceptionErr.InnerException)
        End Try
    End Sub
