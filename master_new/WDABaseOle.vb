...
Public Class WDABaseOle
    ...
    Public Sub New(ByVal Company As String, ByVal Application As String)
        ...
        '        "Password = syspronuririwit" & ";" & _
        '        "Connection Timeout = 0" & ";")
        Connection = New OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\data sysghaisan\syspro\db stna\SecureTA.mdb;Persist Security Info=True;Jet OLEDB:Database Password=sECUREta")
